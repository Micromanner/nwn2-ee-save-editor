...
/// Key type for icon lookups (interned string key)
pub type IconKey = Spur;

/// String interner for efficient icon name storage
pub type StringInterner = ThreadedRodeo;
