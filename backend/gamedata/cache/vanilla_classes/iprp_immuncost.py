...
class Iprp_immuncostData:
    """
    Auto-generated data class for iprp_immuncost.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Iprp_immuncostData {pk_column}={pk_value!r}>>"
        else:
            return f"<Iprp_immuncostData>"
