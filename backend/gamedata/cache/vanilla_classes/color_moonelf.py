...
class Color_moonelfData:
    """
    Auto-generated data class for color_moonelf.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Color_moonelfData {pk_column}={pk_value!r}>>"
        else:
            return f"<Color_moonelfData>"
