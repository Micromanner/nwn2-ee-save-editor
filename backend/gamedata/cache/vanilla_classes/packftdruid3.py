...
class Packftdruid3Data:
    """
    Auto-generated data class for packftdruid3.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Packftdruid3Data {pk_column}={pk_value!r}>>"
        else:
            return f"<Packftdruid3Data>"
