...
class Packftcler6Data:
    """
    Auto-generated data class for packftcler6.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Packftcler6Data {pk_column}={pk_value!r}>>"
        else:
            return f"<Packftcler6Data>"
