...
class Iprp_poisonData:
    """
    Auto-generated data class for iprp_poison.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Iprp_poisonData {pk_column}={pk_value!r}>>"
        else:
            return f"<Iprp_poisonData>"
