...
class Race_feat_hagspawnData:
    """
    Auto-generated data class for race_feat_hagspawn.2da
    ...
    _table_name = 'race_feat_hagspawn'
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Race_feat_hagspawnData {pk_column}={pk_value!r}>>"
        else:
            return f"<Race_feat_hagspawnData>"
