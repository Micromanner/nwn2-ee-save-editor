...
class Tcn01_edgeData:
    """
    Auto-generated data class for tcn01_edge.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Tcn01_edgeData {pk_column}={pk_value!r}>>"
        else:
            return f"<Tcn01_edgeData>"
