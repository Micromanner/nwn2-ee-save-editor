...
class PackskstormlordData:
    """
    Auto-generated data class for packskstormlord.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<PackskstormlordData {pk_column}={pk_value!r}>>"
        else:
            return f"<PackskstormlordData>"
