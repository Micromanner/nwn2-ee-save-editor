...
class Des_feat2itemData:
    """
    Auto-generated data class for des_feat2item.2da
    
    This class provides efficient attribute access to 2DA row data
    with automatic column name mapping for mod compatibility.
    """
    __slots__ = ('_resource_manager', '_FeatLabel', '_TreasureCol')
    _column_mapping = {'FeatLabel': 'FeatLabel', 'TreasureCol': 'TreasureCol'}
    _table_name = 'des_feat2item'
    _safe_columns = ['FeatLabel', 'TreasureCol']
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Des_feat2itemData {pk_column}={pk_value!r}>>"
        else:
            return f"<Des_feat2itemData>"
