...
class Packeqfavsoul1Data:
    """
    Auto-generated data class for packeqfavsoul1.2da
    
    This class provides efficient attribute access to 2DA row data
    with automatic column name mapping for mod compatibility.
    """
    __slots__ = ('_resource_manager', '_Label')
    _column_mapping = {'Label': 'Label'}
    _table_name = 'packeqfavsoul1'
    _safe_columns = ['Label']
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Packeqfavsoul1Data {pk_column}={pk_value!r}>>"
        else:
            return f"<Packeqfavsoul1Data>"
