...
class XptableData:
    """
    Auto-generated data class for xptable.2da
    
    This class provides efficient attribute access to 2DA row data
    with automatic column name mapping for mod compatibility.
    """
    __slots__ = ('_resource_manager', '_Level', '_C0', '_C1', '_C2', '_C3', '_C4', '_C5', '_C6', '_C7', '_C8', '_C9', '_C10', '_C11', '_C12', '_C13', '_C14', '_C15', '_C16', '_C17', '_C18', '_C19', '_C20', '_C21', '_C22', '_C23', '_C24', '_C25', '_C26', '_C27', '_C28', '_C29', '_C30', '_C31', '_C32', '_C33', '_C34', '_C35', '_C36', '_C37', '_C38', '_C39', '_C40')
    _column_mapping = {'Level': 'Level', 'C0': 'C0', 'C1': 'C1', 'C2': 'C2', 'C3': 'C3', 'C4': 'C4', 'C5': 'C5', 'C6': 'C6', 'C7': 'C7', 'C8': 'C8', 'C9': 'C9', 'C10': 'C10', 'C11': 'C11', 'C12': 'C12', 'C13': 'C13', 'C14': 'C14', 'C15': 'C15', 'C16': 'C16', 'C17': 'C17', 'C18': 'C18', 'C19': 'C19', 'C20': 'C20', 'C21': 'C21', 'C22': 'C22', 'C23': 'C23', 'C24': 'C24', 'C25': 'C25', 'C26': 'C26', 'C27': 'C27', 'C28': 'C28', 'C29': 'C29', 'C30': 'C30', 'C31': 'C31', 'C32': 'C32', 'C33': 'C33', 'C34': 'C34', 'C35': 'C35', 'C36': 'C36', 'C37': 'C37', 'C38': 'C38', 'C39': 'C39', 'C40': 'C40'}
    _table_name = 'xptable'
    _safe_columns = ['Level', 'C0', 'C1', 'C2', 'C3', 'C4', 'C5', 'C6', 'C7', 'C8', 'C9', 'C10', 'C11', 'C12', 'C13', 'C14', 'C15', 'C16', 'C17', 'C18', 'C19', 'C20', 'C21', 'C22', 'C23', 'C24', 'C25', 'C26', 'C27', 'C28', 'C29', 'C30', 'C31', 'C32', 'C33', 'C34', 'C35', 'C36', 'C37', 'C38', 'C39', 'C40']
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<XptableData {pk_column}={pk_value!r}>>"
        else:
            return f"<XptableData>"
