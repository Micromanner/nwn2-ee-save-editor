...
class Cls_featmap_palemaData:
    """
    Auto-generated data class for cls_featmap_palema.2da
    ...
    _table_name = 'cls_featmap_palema'
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Cls_featmap_palemaData {pk_column}={pk_value!r}>>"
        else:
            return f"<Cls_featmap_palemaData>"
