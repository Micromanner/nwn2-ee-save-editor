...
class Packskrang1Data:
    """
    Auto-generated data class for packskrang1.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Packskrang1Data {pk_column}={pk_value!r}>>"
        else:
            return f"<Packskrang1Data>"
