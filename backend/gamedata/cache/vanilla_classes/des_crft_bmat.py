...
class Des_crft_bmatData:
    """
    Auto-generated data class for des_crft_bmat.2da
    
    This class provides efficient attribute access to 2DA row data
    with automatic column name mapping for mod compatibility.
    """
    __slots__ = ('_resource_manager', '_Comment', '_x2_it_bmt_ltorso', '_x2_it_bmt_bshaft', '_x2_it_bmt_xbows', '_x2_it_bmt_wpole', '_x2_it_bmt_wshldb', '_x2_it_bmt_oakhlt', '_x2_it_bmt_stors2', '_x2_it_bmt_sshld', '_x2_it_bmt_cchst', '_x2_it_bmt_mhlt', '_x2_it_bmt_proj', '_x2_it_bmt_cloth', '_x2_it_bmt_helm')
    _column_mapping = {'Comment': 'Comment', 'x2_it_bmt_ltorso': 'x2_it_bmt_ltorso', 'x2_it_bmt_bshaft': 'x2_it_bmt_bshaft', 'x2_it_bmt_xbows': 'x2_it_bmt_xbows', 'x2_it_bmt_wpole': 'x2_it_bmt_wpole', 'x2_it_bmt_wshldb': 'x2_it_bmt_wshldb', 'x2_it_bmt_oakhlt': 'x2_it_bmt_oakhlt', 'x2_it_bmt_stors2': 'x2_it_bmt_stors2', 'x2_it_bmt_sshld': 'x2_it_bmt_sshld', 'x2_it_bmt_cchst': 'x2_it_bmt_cchst', 'x2_it_bmt_mhlt': 'x2_it_bmt_mhlt', 'x2_it_bmt_proj': 'x2_it_bmt_proj', 'x2_it_bmt_cloth': 'x2_it_bmt_cloth', 'x2_it_bmt_helm': 'x2_it_bmt_helm'}
    _table_name = 'des_crft_bmat'
    _safe_columns = ['Comment', 'x2_it_bmt_ltorso', 'x2_it_bmt_bshaft', 'x2_it_bmt_xbows', 'x2_it_bmt_wpole', 'x2_it_bmt_wshldb', 'x2_it_bmt_oakhlt', 'x2_it_bmt_stors2', 'x2_it_bmt_sshld', 'x2_it_bmt_cchst', 'x2_it_bmt_mhlt', 'x2_it_bmt_proj', 'x2_it_bmt_cloth', 'x2_it_bmt_helm']
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Des_crft_bmatData {pk_column}={pk_value!r}>>"
        else:
            return f"<Des_crft_bmatData>"
