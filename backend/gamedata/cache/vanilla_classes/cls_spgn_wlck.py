...
class Cls_spgn_wlckData:
    """
    Auto-generated data class for cls_spgn_wlck.2da
    
    This class provides efficient attribute access to 2DA row data
    with automatic column name mapping for mod compatibility.
    """
    __slots__ = ('_resource_manager', '_Level', '_NumSpellLevels', '_SpellLevel0', '_SpellLevel1', '_SpellLevel2', '_SpellLevel3', '_SpellLevel4')
    _column_mapping = {'Level': 'Level', 'NumSpellLevels': 'NumSpellLevels', 'SpellLevel0': 'SpellLevel0', 'SpellLevel1': 'SpellLevel1', 'SpellLevel2': 'SpellLevel2', 'SpellLevel3': 'SpellLevel3', 'SpellLevel4': 'SpellLevel4'}
    _table_name = 'cls_spgn_wlck'
    _safe_columns = ['Level', 'NumSpellLevels', 'SpellLevel0', 'SpellLevel1', 'SpellLevel2', 'SpellLevel3', 'SpellLevel4']
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Cls_spgn_wlckData {pk_column}={pk_value!r}>>"
        else:
            return f"<Cls_spgn_wlckData>"
