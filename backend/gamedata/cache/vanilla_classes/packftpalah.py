...
class PackftpalahData:
    """
    Auto-generated data class for packftpalah.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<PackftpalahData {pk_column}={pk_value!r}>>"
        else:
            return f"<PackftpalahData>"
