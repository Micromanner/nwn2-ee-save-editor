...
class Race_feat_elfData:
    """
    Auto-generated data class for race_feat_elf.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Race_feat_elfData {pk_column}={pk_value!r}>>"
        else:
            return f"<Race_feat_elfData>"
