...
class VisualeffectsData:
    """
    Auto-generated data class for visualeffects.2da
    
    This class provides efficient attribute access to 2DA row data
    with automatic column name mapping for mod compatibility.
    """
    __slots__ = ('_resource_manager', '_Label', '_Type_FD', '_OrientWithGround', '_DelayDurationFX', '_Imp_HeadCon_Node', '_Imp_Impact_Node', '_Imp_Root_S_Node', '_Imp_Root_M_Node', '_Imp_Root_L_Node', '_Imp_Root_H_Node', '_ProgFX_Impact', '_SoundImpact', '_Dur_HeadCon_Node', '_Dur_Impact_Node', '_Dur_Root_S_Node', '_Dur_Root_M_Node', '_Dur_Root_L_Node', '_Dur_Root_H_Node', '_ProgFX_Duration', '_SoundDuration', '_ProgFX_Cessation', '_SoundCessastion', '_Ces_HeadCon_Node', '_Ces_Impact_Node', '_Ces_Root_S_Node', '_Ces_Root_M_Node', '_Ces_Root_L_Node', '_Ces_Root_H_Node', '_ShakeType', '_ShakeDelay', '_ShakeDuration', '_LowViolence', '_LowQuality')
    _column_mapping = {'Label': 'Label', 'Type_FD': 'Type_FD', 'OrientWithGround': 'OrientWithGround', 'DelayDurationFX': 'DelayDurationFX', 'Imp_HeadCon_Node': 'Imp_HeadCon_Node', 'Imp_Impact_Node': 'Imp_Impact_Node', 'Imp_Root_S_Node': 'Imp_Root_S_Node', 'Imp_Root_M_Node': 'Imp_Root_M_Node', 'Imp_Root_L_Node': 'Imp_Root_L_Node', 'Imp_Root_H_Node': 'Imp_Root_H_Node', 'ProgFX_Impact': 'ProgFX_Impact', 'SoundImpact': 'SoundImpact', 'Dur_HeadCon_Node': 'Dur_HeadCon_Node', 'Dur_Impact_Node': 'Dur_Impact_Node', 'Dur_Root_S_Node': 'Dur_Root_S_Node', 'Dur_Root_M_Node': 'Dur_Root_M_Node', 'Dur_Root_L_Node': 'Dur_Root_L_Node', 'Dur_Root_H_Node': 'Dur_Root_H_Node', 'ProgFX_Duration': 'ProgFX_Duration', 'SoundDuration': 'SoundDuration', 'ProgFX_Cessation': 'ProgFX_Cessation', 'SoundCessastion': 'SoundCessastion', 'Ces_HeadCon_Node': 'Ces_HeadCon_Node', 'Ces_Impact_Node': 'Ces_Impact_Node', 'Ces_Root_S_Node': 'Ces_Root_S_Node', 'Ces_Root_M_Node': 'Ces_Root_M_Node', 'Ces_Root_L_Node': 'Ces_Root_L_Node', 'Ces_Root_H_Node': 'Ces_Root_H_Node', 'ShakeType': 'ShakeType', 'ShakeDelay': 'ShakeDelay', 'ShakeDuration': 'ShakeDuration', 'LowViolence': 'LowViolence', 'LowQuality': 'LowQuality'}
    _table_name = 'visualeffects'
    _safe_columns = ['Label', 'Type_FD', 'OrientWithGround', 'DelayDurationFX', 'Imp_HeadCon_Node', 'Imp_Impact_Node', 'Imp_Root_S_Node', 'Imp_Root_M_Node', 'Imp_Root_L_Node', 'Imp_Root_H_Node', 'ProgFX_Impact', 'SoundImpact', 'Dur_HeadCon_Node', 'Dur_Impact_Node', 'Dur_Root_S_Node', 'Dur_Root_M_Node', 'Dur_Root_L_Node', 'Dur_Root_H_Node', 'ProgFX_Duration', 'SoundDuration', 'ProgFX_Cessation', 'SoundCessastion', 'Ces_HeadCon_Node', 'Ces_Impact_Node', 'Ces_Root_S_Node', 'Ces_Root_M_Node', 'Ces_Root_L_Node', 'Ces_Root_H_Node', 'ShakeType', 'ShakeDelay', 'ShakeDuration', 'LowViolence', 'LowQuality']
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<VisualeffectsData {pk_column}={pk_value!r}>>"
        else:
            return f"<VisualeffectsData>"
