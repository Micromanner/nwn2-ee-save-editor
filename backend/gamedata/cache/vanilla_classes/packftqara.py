...
class PackftqaraData:
    """
    Auto-generated data class for packftqara.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<PackftqaraData {pk_column}={pk_value!r}>>"
        else:
            return f"<PackftqaraData>"
