...
class Packftfavsoul3Data:
    """
    Auto-generated data class for packftfavsoul3.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Packftfavsoul3Data {pk_column}={pk_value!r}>>"
        else:
            return f"<Packftfavsoul3Data>"
