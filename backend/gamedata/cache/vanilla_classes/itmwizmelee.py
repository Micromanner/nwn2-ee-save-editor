...
class ItmwizmeleeData:
    """
    Auto-generated data class for itmwizmelee.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<ItmwizmeleeData {pk_column}={pk_value!r}>>"
        else:
            return f"<ItmwizmeleeData>"
