...
class PackftbarbfData:
    """
    Auto-generated data class for packftbarbf.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<PackftbarbfData {pk_column}={pk_value!r}>>"
        else:
            return f"<PackftbarbfData>"
