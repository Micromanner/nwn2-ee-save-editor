...
class ItmwizarmorData:
    """
    Auto-generated data class for itmwizarmor.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<ItmwizarmorData {pk_column}={pk_value!r}>>"
        else:
            return f"<ItmwizarmorData>"
