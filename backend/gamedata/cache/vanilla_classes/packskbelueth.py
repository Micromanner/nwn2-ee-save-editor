...
class PackskbeluethData:
    """
    Auto-generated data class for packskbelueth.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<PackskbeluethData {pk_column}={pk_value!r}>>"
        else:
            return f"<PackskbeluethData>"
