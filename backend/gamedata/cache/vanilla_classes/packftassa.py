...
class PackftassaData:
    """
    Auto-generated data class for packftassa.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<PackftassaData {pk_column}={pk_value!r}>>"
        else:
            return f"<PackftassaData>"
