...
class PackftokkuData:
    """
    Auto-generated data class for packftokku.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<PackftokkuData {pk_column}={pk_value!r}>>"
        else:
            return f"<PackftokkuData>"
