...
class Color_watergenData:
    """
    Auto-generated data class for color_watergen.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Color_watergenData {pk_column}={pk_value!r}>>"
        else:
            return f"<Color_watergenData>"
