...
class Iprp_bonushpData:
    """
    Auto-generated data class for iprp_bonushp.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Iprp_bonushpData {pk_column}={pk_value!r}>>"
        else:
            return f"<Iprp_bonushpData>"
