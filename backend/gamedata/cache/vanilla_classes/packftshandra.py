...
class PackftshandraData:
    """
    Auto-generated data class for packftshandra.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<PackftshandraData {pk_column}={pk_value!r}>>"
        else:
            return f"<PackftshandraData>"
