...
class Parts_robeData:
    """
    Auto-generated data class for parts_robe.2da
    
    This class provides efficient attribute access to 2DA row data
    with automatic column name mapping for mod compatibility.
    """
    __slots__ = ('_resource_manager', '_COSTMODIFIER', '_ACBONUS', '_HIDEFOOTR', '_HIDEFOOTL', '_HIDESHINR', '_HIDESHINL', '_HIDELEGR', '_HIDELEGL', '_HIDEPELVIS', '_HIDECHEST', '_HIDEBELT', '_HIDENECK', '_HIDEFORER', '_HIDEFOREL', '_HIDEBICEPR', '_HIDEBICEPL', '_HIDESHOR', '_HIDESHOL', '_HIDEHANDR', '_HIDEHANDL', '_HIDEHEAD')
    _column_mapping = {'COSTMODIFIER': 'COSTMODIFIER', 'ACBONUS': 'ACBONUS', 'HIDEFOOTR': 'HIDEFOOTR', 'HIDEFOOTL': 'HIDEFOOTL', 'HIDESHINR': 'HIDESHINR', 'HIDESHINL': 'HIDESHINL', 'HIDELEGR': 'HIDELEGR', 'HIDELEGL': 'HIDELEGL', 'HIDEPELVIS': 'HIDEPELVIS', 'HIDECHEST': 'HIDECHEST', 'HIDEBELT': 'HIDEBELT', 'HIDENECK': 'HIDENECK', 'HIDEFORER': 'HIDEFORER', 'HIDEFOREL': 'HIDEFOREL', 'HIDEBICEPR': 'HIDEBICEPR', 'HIDEBICEPL': 'HIDEBICEPL', 'HIDESHOR': 'HIDESHOR', 'HIDESHOL': 'HIDESHOL', 'HIDEHANDR': 'HIDEHANDR', 'HIDEHANDL': 'HIDEHANDL', 'HIDEHEAD': 'HIDEHEAD'}
    _table_name = 'parts_robe'
    _safe_columns = ['COSTMODIFIER', 'ACBONUS', 'HIDEFOOTR', 'HIDEFOOTL', 'HIDESHINR', 'HIDESHINL', 'HIDELEGR', 'HIDELEGL', 'HIDEPELVIS', 'HIDECHEST', 'HIDEBELT', 'HIDENECK', 'HIDEFORER', 'HIDEFOREL', 'HIDEBICEPR', 'HIDEBICEPL', 'HIDESHOR', 'HIDESHOL', 'HIDEHANDR', 'HIDEHANDL', 'HIDEHEAD']
    ...
    def __repr__(self):
        ...
        pk_column = 'COSTMODIFIER'
        if pk_column and hasattr(self, '_' + pk_column):
            pk_value = getattr(self, '_' + pk_column)
            return f"<Parts_robeData {pk_column}={pk_value!r}>>"
        else:
            return f"<Parts_robeData>"
