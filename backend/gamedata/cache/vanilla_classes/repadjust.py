...
class RepadjustData:
    """
    Auto-generated data class for repadjust.2da
    
    This class provides efficient attribute access to 2DA row data
    with automatic column name mapping for mod compatibility.
    """
    __slots__ = ('_resource_manager', '_LABEL', '_PERSONALREP', '_FACTIONREP', '_WITFRIA', '_WITFRIB', '_WITFRIC', '_WITNEUA', '_WITNEUB', '_WITNEUC', '_WITENEA', '_WITENEB', '_WITENEC')
    _column_mapping = {'LABEL': 'LABEL', 'PERSONALREP': 'PERSONALREP', 'FACTIONREP': 'FACTIONREP', 'WITFRIA': 'WITFRIA', 'WITFRIB': 'WITFRIB', 'WITFRIC': 'WITFRIC', 'WITNEUA': 'WITNEUA', 'WITNEUB': 'WITNEUB', 'WITNEUC': 'WITNEUC', 'WITENEA': 'WITENEA', 'WITENEB': 'WITENEB', 'WITENEC': 'WITENEC'}
    _table_name = 'repadjust'
    _safe_columns = ['LABEL', 'PERSONALREP', 'FACTIONREP', 'WITFRIA', 'WITFRIB', 'WITFRIC', 'WITNEUA', 'WITNEUB', 'WITNEUC', 'WITENEA', 'WITENEB', 'WITENEC']
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<RepadjustData {pk_column}={pk_value!r}>>"
        else:
            return f"<RepadjustData>"
