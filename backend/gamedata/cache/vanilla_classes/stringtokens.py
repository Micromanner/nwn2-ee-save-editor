...
class StringtokensData:
    """
    Auto-generated data class for stringtokens.2da
    
    This class provides efficient attribute access to 2DA row data
    with automatic column name mapping for mod compatibility.
    """
    __slots__ = ('_resource_manager', '_Token', '_ActionCode', '_Default', '_StrRef1', '_StrRef2', '_StrRef3', '_StrRef4', '_Category')
    _column_mapping = {'Token': 'Token', 'ActionCode': 'ActionCode', 'Default': 'Default', 'StrRef1': 'StrRef1', 'StrRef2': 'StrRef2', 'StrRef3': 'StrRef3', 'StrRef4': 'StrRef4', 'Category': 'Category'}
    _table_name = 'stringtokens'
    _safe_columns = ['Token', 'ActionCode', 'Default', 'StrRef1', 'StrRef2', 'StrRef3', 'StrRef4', 'Category']
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<StringtokensData {pk_column}={pk_value!r}>>"
        else:
            return f"<StringtokensData>"
