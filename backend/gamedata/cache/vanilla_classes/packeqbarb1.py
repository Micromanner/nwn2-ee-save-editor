...
class Packeqbarb1Data:
    """
    Auto-generated data class for packeqbarb1.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Packeqbarb1Data {pk_column}={pk_value!r}>>"
        else:
            return f"<Packeqbarb1Data>"
