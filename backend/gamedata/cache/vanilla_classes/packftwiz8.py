...
class Packftwiz8Data:
    """
    Auto-generated data class for packftwiz8.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Packftwiz8Data {pk_column}={pk_value!r}>>"
        else:
            return f"<Packftwiz8Data>"
