...
class Color_graydwarfData:
    """
    Auto-generated data class for color_graydwarf.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Color_graydwarfData {pk_column}={pk_value!r}>>"
        else:
            return f"<Color_graydwarfData>"
