...
class Ttr01doorsData:
    """
    Auto-generated data class for ttr01doors.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Ttr01doorsData {pk_column}={pk_value!r}>>"
        else:
            return f"<Ttr01doorsData>"
