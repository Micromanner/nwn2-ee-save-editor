...
class Parts_bicepData:
    """
    Auto-generated data class for parts_bicep.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Parts_bicepData {pk_column}={pk_value!r}>>"
        else:
            return f"<Parts_bicepData>"
