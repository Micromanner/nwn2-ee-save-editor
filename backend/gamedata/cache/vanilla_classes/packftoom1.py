...
class Packftoom1Data:
    """
    Auto-generated data class for packftoom1.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Packftoom1Data {pk_column}={pk_value!r}>>"
        else:
            return f"<Packftoom1Data>"
