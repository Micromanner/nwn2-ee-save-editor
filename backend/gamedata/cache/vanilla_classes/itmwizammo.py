...
class ItmwizammoData:
    """
    Auto-generated data class for itmwizammo.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<ItmwizammoData {pk_column}={pk_value!r}>>"
        else:
            return f"<ItmwizammoData>"
