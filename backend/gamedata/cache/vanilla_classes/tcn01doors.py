...
class Tcn01doorsData:
    """
    Auto-generated data class for tcn01doors.2da
    
    This class provides efficient attribute access to 2DA row data
    with automatic column name mapping for mod compatibility.
    """
    __slots__ = ('_resource_manager', '_Type0', '_Type1', '_Type2')
    _column_mapping = {'Type0': 'Type0', 'Type1': 'Type1', 'Type2': 'Type2'}
    _table_name = 'tcn01doors'
    _safe_columns = ['Type0', 'Type1', 'Type2']
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Tcn01doorsData {pk_column}={pk_value!r}>>"
        else:
            return f"<Tcn01doorsData>"
