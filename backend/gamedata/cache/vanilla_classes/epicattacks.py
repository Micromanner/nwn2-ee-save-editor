...
class EpicattacksData:
    """
    Auto-generated data class for epicattacks.2da
    
    This class provides efficient attribute access to 2DA row data
    with automatic column name mapping for mod compatibility.
    """
    __slots__ = ('_resource_manager', '_BAB')
    _column_mapping = {'BAB': 'BAB'}
    _table_name = 'epicattacks'
    _safe_columns = ['BAB']
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<EpicattacksData {pk_column}={pk_value!r}>>"
        else:
            return f"<EpicattacksData>"
