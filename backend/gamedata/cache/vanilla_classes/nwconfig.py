...
class NwconfigData:
    """
    Auto-generated data class for nwconfig.2da
    
    This class provides efficient attribute access to 2DA row data
    with automatic column name mapping for mod compatibility.
    """
    __slots__ = ('_resource_manager', '_LABEL', '_TYPE_', '_TITLESTRREF', '_IMAGE', '_PASSVAL', '_PASSSTRREF', '_FAILVAL', '_FAILSTRREF', '_WARNVAL', '_WARNSTRREF', '_SHORTWARNSTRREF', '_SKIPSTRREF', '_ERRORSTRREF')
    _column_mapping = {'LABEL': 'LABEL', 'TYPE': 'TYPE_', 'TITLESTRREF': 'TITLESTRREF', 'IMAGE': 'IMAGE', 'PASSVAL': 'PASSVAL', 'PASSSTRREF': 'PASSSTRREF', 'FAILVAL': 'FAILVAL', 'FAILSTRREF': 'FAILSTRREF', 'WARNVAL': 'WARNVAL', 'WARNSTRREF': 'WARNSTRREF', 'SHORTWARNSTRREF': 'SHORTWARNSTRREF', 'SKIPSTRREF': 'SKIPSTRREF', 'ERRORSTRREF': 'ERRORSTRREF'}
    _table_name = 'nwconfig'
    _safe_columns = ['LABEL', 'TYPE_', 'TITLESTRREF', 'IMAGE', 'PASSVAL', 'PASSSTRREF', 'FAILVAL', 'FAILSTRREF', 'WARNVAL', 'WARNSTRREF', 'SHORTWARNSTRREF', 'SKIPSTRREF', 'ERRORSTRREF']
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<NwconfigData {pk_column}={pk_value!r}>>"
        else:
            return f"<NwconfigData>"
