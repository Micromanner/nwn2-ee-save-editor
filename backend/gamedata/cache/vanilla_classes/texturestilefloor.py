...
class TexturestilefloorData:
    """
    Auto-generated data class for texturestilefloor.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<TexturestilefloorData {pk_column}={pk_value!r}>>"
        else:
            return f"<TexturestilefloorData>"
