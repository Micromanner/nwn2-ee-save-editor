...
class Cls_spkn_sorcData:
    """
    Auto-generated data class for cls_spkn_sorc.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Cls_spkn_sorcData {pk_column}={pk_value!r}>>"
        else:
            return f"<Cls_spkn_sorcData>"
