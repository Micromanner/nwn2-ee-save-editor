...
class Cls_skill_shiftrData:
    """
    Auto-generated data class for cls_skill_shiftr.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Cls_skill_shiftrData {pk_column}={pk_value!r}>>"
        else:
            return f"<Cls_skill_shiftrData>"
