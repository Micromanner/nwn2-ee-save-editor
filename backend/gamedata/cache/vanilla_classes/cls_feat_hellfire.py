...
class Cls_feat_hellfireData:
    """
    Auto-generated data class for cls_feat_hellfire.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Cls_feat_hellfireData {pk_column}={pk_value!r}>>"
        else:
            return f"<Cls_feat_hellfireData>"
