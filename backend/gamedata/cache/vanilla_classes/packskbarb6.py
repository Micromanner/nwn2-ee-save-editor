...
class Packskbarb6Data:
    """
    Auto-generated data class for packskbarb6.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Packskbarb6Data {pk_column}={pk_value!r}>>"
        else:
            return f"<Packskbarb6Data>"
