...
class Packskswash3Data:
    """
    Auto-generated data class for packskswash3.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Packskswash3Data {pk_column}={pk_value!r}>>"
        else:
            return f"<Packskswash3Data>"
