...
class Packftoom3Data:
    """
    Auto-generated data class for packftoom3.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Packftoom3Data {pk_column}={pk_value!r}>>"
        else:
            return f"<Packftoom3Data>"
