...
class PackftarchData:
    """
    Auto-generated data class for packftarch.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<PackftarchData {pk_column}={pk_value!r}>>"
        else:
            return f"<PackftarchData>"
