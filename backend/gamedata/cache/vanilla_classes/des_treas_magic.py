...
class Des_treas_magicData:
    """
    Auto-generated data class for des_treas_magic.2da
    
    This class provides efficient attribute access to 2DA row data
    with automatic column name mapping for mod compatibility.
    """
    __slots__ = ('_resource_manager', '_Comment', '_TVHigh', '_LabelVHigh', '_THigh', '_LabelHigh', '_TMed', '_LabelMed', '_TLow', '_LabelLow')
    _column_mapping = {'Comment': 'Comment', 'TVHigh': 'TVHigh', 'LabelVHigh': 'LabelVHigh', 'THigh': 'THigh', 'LabelHigh': 'LabelHigh', 'TMed': 'TMed', 'LabelMed': 'LabelMed', 'TLow': 'TLow', 'LabelLow': 'LabelLow'}
    _table_name = 'des_treas_magic'
    _safe_columns = ['Comment', 'TVHigh', 'LabelVHigh', 'THigh', 'LabelHigh', 'TMed', 'LabelMed', 'TLow', 'LabelLow']
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Des_treas_magicData {pk_column}={pk_value!r}>>"
        else:
            return f"<Des_treas_magicData>"
