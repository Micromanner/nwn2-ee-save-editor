...
class Tdc01_edgeData:
    """
    Auto-generated data class for tdc01_edge.2da
    
    This class provides efficient attribute access to 2DA row data
    with automatic column name mapping for mod compatibility.
    """
    __slots__ = ('_resource_manager', '_Corner1', '_Edge', '_Corner2', '_Height', '_Model')
    _column_mapping = {'Corner1': 'Corner1', 'Edge': 'Edge', 'Corner2': 'Corner2', 'Height': 'Height', 'Model': 'Model'}
    _table_name = 'tdc01_edge'
    _safe_columns = ['Corner1', 'Edge', 'Corner2', 'Height', 'Model']
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Tdc01_edgeData {pk_column}={pk_value!r}>>"
        else:
            return f"<Tdc01_edgeData>"
