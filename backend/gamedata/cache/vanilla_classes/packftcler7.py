...
class Packftcler7Data:
    """
    Auto-generated data class for packftcler7.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Packftcler7Data {pk_column}={pk_value!r}>>"
        else:
            return f"<Packftcler7Data>"
