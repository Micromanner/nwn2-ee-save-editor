...
class Parts_legsData:
    """
    Auto-generated data class for parts_legs.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Parts_legsData {pk_column}={pk_value!r}>>"
        else:
            return f"<Parts_legsData>"
