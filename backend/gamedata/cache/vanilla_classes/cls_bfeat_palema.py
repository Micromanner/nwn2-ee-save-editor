...
class Cls_bfeat_palemaData:
    """
    Auto-generated data class for cls_bfeat_palema.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Cls_bfeat_palemaData {pk_column}={pk_value!r}>>"
        else:
            return f"<Cls_bfeat_palemaData>"
