...
class PackskblckData:
    """
    Auto-generated data class for packskblck.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<PackskblckData {pk_column}={pk_value!r}>>"
        else:
            return f"<PackskblckData>"
