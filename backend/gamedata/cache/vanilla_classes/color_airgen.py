...
class Color_airgenData:
    """
    Auto-generated data class for color_airgen.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Color_airgenData {pk_column}={pk_value!r}>>"
        else:
            return f"<Color_airgenData>"
