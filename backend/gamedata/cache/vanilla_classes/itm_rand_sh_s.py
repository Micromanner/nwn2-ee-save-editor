...
class Itm_rand_sh_sData:
    """
    Auto-generated data class for itm_rand_sh_s.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Itm_rand_sh_sData {pk_column}={pk_value!r}>>"
        else:
            return f"<Itm_rand_sh_sData>"
