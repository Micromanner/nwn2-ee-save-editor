...
class Vfx_persistentData:
    """
    Auto-generated data class for vfx_persistent.2da
    
    This class provides efficient attribute access to 2DA row data
    with automatic column name mapping for mod compatibility.
    """
    __slots__ = ('_resource_manager', '_LABEL', '_SHAPE', '_RADIUS', '_WIDTH', '_LENGTH', '_ONENTER', '_ONEXIT', '_HEARTBEAT', '_OrientWithGround', '_DropToGround', '_VisualFX', '_SoundImpact', '_SoundDuration', '_SoundCessation', '_FillSEF', '_SEFSize')
    _column_mapping = {'LABEL': 'LABEL', 'SHAPE': 'SHAPE', 'RADIUS': 'RADIUS', 'WIDTH': 'WIDTH', 'LENGTH': 'LENGTH', 'ONENTER': 'ONENTER', 'ONEXIT': 'ONEXIT', 'HEARTBEAT': 'HEARTBEAT', 'OrientWithGround': 'OrientWithGround', 'DropToGround': 'DropToGround', 'VisualFX': 'VisualFX', 'SoundImpact': 'SoundImpact', 'SoundDuration': 'SoundDuration', 'SoundCessation': 'SoundCessation', 'FillSEF': 'FillSEF', 'SEFSize': 'SEFSize'}
    _table_name = 'vfx_persistent'
    _safe_columns = ['LABEL', 'SHAPE', 'RADIUS', 'WIDTH', 'LENGTH', 'ONENTER', 'ONEXIT', 'HEARTBEAT', 'OrientWithGround', 'DropToGround', 'VisualFX', 'SoundImpact', 'SoundDuration', 'SoundCessation', 'FillSEF', 'SEFSize']
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Vfx_persistentData {pk_column}={pk_value!r}>>"
        else:
            return f"<Vfx_persistentData>"
