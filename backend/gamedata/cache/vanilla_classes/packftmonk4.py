...
class Packftmonk4Data:
    """
    Auto-generated data class for packftmonk4.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Packftmonk4Data {pk_column}={pk_value!r}>>"
        else:
            return f"<Packftmonk4Data>"
