...
class Des_crft_propsData:
    """
    Auto-generated data class for des_crft_props.2da
    
    This class provides efficient attribute access to 2DA row data
    with automatic column name mapping for mod compatibility.
    """
    __slots__ = ('_resource_manager', '_Comment', '_PropertyType', '_Duration', '_Param1', '_Param2', '_Param3', '_Param4', '_SuccessText')
    _column_mapping = {'Comment': 'Comment', 'PropertyType': 'PropertyType', 'Duration': 'Duration', 'Param1': 'Param1', 'Param2': 'Param2', 'Param3': 'Param3', 'Param4': 'Param4', 'SuccessText': 'SuccessText'}
    _table_name = 'des_crft_props'
    _safe_columns = ['Comment', 'PropertyType', 'Duration', 'Param1', 'Param2', 'Param3', 'Param4', 'SuccessText']
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Des_crft_propsData {pk_column}={pk_value!r}>>"
        else:
            return f"<Des_crft_propsData>"
