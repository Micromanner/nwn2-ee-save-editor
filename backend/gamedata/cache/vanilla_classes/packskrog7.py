...
class Packskrog7Data:
    """
    Auto-generated data class for packskrog7.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Packskrog7Data {pk_column}={pk_value!r}>>"
        else:
            return f"<Packskrog7Data>"
