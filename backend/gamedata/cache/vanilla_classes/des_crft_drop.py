...
class Des_crft_dropData:
    """
    Auto-generated data class for des_crft_drop.2da
    
    This class provides efficient attribute access to 2DA row data
    with automatic column name mapping for mod compatibility.
    """
    __slots__ = ('_resource_manager', '_Label1', '_Creature_Drop', '_Placeable_Drop', '_Creature_Num', '_Placeable_Label', '_Placeable_Num', '_Door_Drop', '_Label_3', '_Door_Num')
    _column_mapping = {'Label1': 'Label1', 'Creature_Drop': 'Creature_Drop', 'Placeable_Drop': 'Placeable_Drop', 'Creature_Num': 'Creature_Num', 'Placeable_Label': 'Placeable_Label', 'Placeable_Num': 'Placeable_Num', 'Door_Drop': 'Door_Drop', 'Label_3': 'Label_3', 'Door_Num': 'Door_Num'}
    _table_name = 'des_crft_drop'
    _safe_columns = ['Label1', 'Creature_Drop', 'Placeable_Drop', 'Creature_Num', 'Placeable_Label', 'Placeable_Num', 'Door_Drop', 'Label_3', 'Door_Num']
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Des_crft_dropData {pk_column}={pk_value!r}>>"
        else:
            return f"<Des_crft_dropData>"
