...
class PackftneeshkaData:
    """
    Auto-generated data class for packftneeshka.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<PackftneeshkaData {pk_column}={pk_value!r}>>"
        else:
            return f"<PackftneeshkaData>"
