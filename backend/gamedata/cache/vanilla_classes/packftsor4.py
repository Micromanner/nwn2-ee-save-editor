...
class Packftsor4Data:
    """
    Auto-generated data class for packftsor4.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Packftsor4Data {pk_column}={pk_value!r}>>"
        else:
            return f"<Packftsor4Data>"
