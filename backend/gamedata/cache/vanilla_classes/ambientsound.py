...
class AmbientsoundData:
    """
    Auto-generated data class for ambientsound.2da
    
    This class provides efficient attribute access to 2DA row data
    with automatic column name mapping for mod compatibility.
    """
    __slots__ = ('_resource_manager', '_Description', '_Resource', '_PresetInstance0', '_PresetInstance1', '_PresetInstance2', '_PresetInstance3', '_PresetInstance4', '_PresetInstance5', '_PresetInstance6', '_PresetInstance7', '_DisplayName')
    _column_mapping = {'Description': 'Description', 'Resource': 'Resource', 'PresetInstance0': 'PresetInstance0', 'PresetInstance1': 'PresetInstance1', 'PresetInstance2': 'PresetInstance2', 'PresetInstance3': 'PresetInstance3', 'PresetInstance4': 'PresetInstance4', 'PresetInstance5': 'PresetInstance5', 'PresetInstance6': 'PresetInstance6', 'PresetInstance7': 'PresetInstance7', 'DisplayName': 'DisplayName'}
    _table_name = 'ambientsound'
    _safe_columns = ['Description', 'Resource', 'PresetInstance0', 'PresetInstance1', 'PresetInstance2', 'PresetInstance3', 'PresetInstance4', 'PresetInstance5', 'PresetInstance6', 'PresetInstance7', 'DisplayName']
    ...
    def __repr__(self):
        ...
        pk_column = 'Description'
        if pk_column and hasattr(self, '_' + pk_column):
            pk_value = getattr(self, '_' + pk_column)
            return f"<AmbientsoundData {pk_column}={pk_value!r}>>"
        else:
            return f"<AmbientsoundData>"
