...
class Packskdruid3Data:
    """
    Auto-generated data class for packskdruid3.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Packskdruid3Data {pk_column}={pk_value!r}>>"
        else:
            return f"<Packskdruid3Data>"
