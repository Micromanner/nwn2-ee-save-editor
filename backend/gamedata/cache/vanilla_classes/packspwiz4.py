...
class Packspwiz4Data:
    """
    Auto-generated data class for packspwiz4.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Packspwiz4Data {pk_column}={pk_value!r}>>"
        else:
            return f"<Packspwiz4Data>"
