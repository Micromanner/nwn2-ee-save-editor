...
class PackftclereData:
    """
    Auto-generated data class for packftclere.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<PackftclereData {pk_column}={pk_value!r}>>"
        else:
            return f"<PackftclereData>"
