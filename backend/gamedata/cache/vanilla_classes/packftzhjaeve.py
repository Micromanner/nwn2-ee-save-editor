...
class PackftzhjaeveData:
    """
    Auto-generated data class for packftzhjaeve.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<PackftzhjaeveData {pk_column}={pk_value!r}>>"
        else:
            return f"<PackftzhjaeveData>"
