...
class Cls_pres_contmData:
    """
    Auto-generated data class for cls_pres_contm.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Cls_pres_contmData {pk_column}={pk_value!r}>>"
        else:
            return f"<Cls_pres_contmData>"
