...
class PackeqwizbData:
    """
    Auto-generated data class for packeqwizb.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<PackeqwizbData {pk_column}={pk_value!r}>>"
        else:
            return f"<PackeqwizbData>"
