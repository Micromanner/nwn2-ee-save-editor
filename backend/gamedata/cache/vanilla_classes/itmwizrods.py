...
class ItmwizrodsData:
    """
    Auto-generated data class for itmwizrods.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<ItmwizrodsData {pk_column}={pk_value!r}>>"
        else:
            return f"<ItmwizrodsData>"
