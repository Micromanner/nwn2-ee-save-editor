...
class Cls_skill_rogData:
    """
    Auto-generated data class for cls_skill_rog.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Cls_skill_rogData {pk_column}={pk_value!r}>>"
        else:
            return f"<Cls_skill_rogData>"
