...
class Cls_pres_sacredfistData:
    """
    Auto-generated data class for cls_pres_sacredfist.2da
    ...
    _table_name = 'cls_pres_sacredfist'
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Cls_pres_sacredfistData {pk_column}={pk_value!r}>>"
        else:
            return f"<Cls_pres_sacredfistData>"
