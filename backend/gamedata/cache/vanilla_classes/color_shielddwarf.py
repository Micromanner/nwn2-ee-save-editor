...
class Color_shielddwarfData:
    """
    Auto-generated data class for color_shielddwarf.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Color_shielddwarfData {pk_column}={pk_value!r}>>"
        else:
            return f"<Color_shielddwarfData>"
