...
class Packftfight1Data:
    """
    Auto-generated data class for packftfight1.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Packftfight1Data {pk_column}={pk_value!r}>>"
        else:
            return f"<Packftfight1Data>"
