...
class Nwn2_voicemenuData:
    """
    Auto-generated data class for nwn2_voicemenu.2da
    
    This class provides efficient attribute access to 2DA row data
    with automatic column name mapping for mod compatibility.
    """
    __slots__ = ('_resource_manager', '_Label', '_KeyCode', '_Name', '_Icon', '_Cell_0', '_Cell_1', '_Cell_2', '_Cell_3', '_Cell_4', '_Cell_5', '_Cell_6', '_Cell_7', '_Cell_8', '_Cell_9')
    _column_mapping = {'Label': 'Label', 'KeyCode': 'KeyCode', 'Name': 'Name', 'Icon': 'Icon', 'Cell_0': 'Cell_0', 'Cell_1': 'Cell_1', 'Cell_2': 'Cell_2', 'Cell_3': 'Cell_3', 'Cell_4': 'Cell_4', 'Cell_5': 'Cell_5', 'Cell_6': 'Cell_6', 'Cell_7': 'Cell_7', 'Cell_8': 'Cell_8', 'Cell_9': 'Cell_9'}
    _table_name = 'nwn2_voicemenu'
    _safe_columns = ['Label', 'KeyCode', 'Name', 'Icon', 'Cell_0', 'Cell_1', 'Cell_2', 'Cell_3', 'Cell_4', 'Cell_5', 'Cell_6', 'Cell_7', 'Cell_8', 'Cell_9']
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Nwn2_voicemenuData {pk_column}={pk_value!r}>>"
        else:
            return f"<Nwn2_voicemenuData>"
