...
class Cls_bfeat_fightData:
    """
    Auto-generated data class for cls_bfeat_fight.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Cls_bfeat_fightData {pk_column}={pk_value!r}>>"
        else:
            return f"<Cls_bfeat_fightData>"
