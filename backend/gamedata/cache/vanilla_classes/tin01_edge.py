...
class Tin01_edgeData:
    """
    Auto-generated data class for tin01_edge.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Tin01_edgeData {pk_column}={pk_value!r}>>"
        else:
            return f"<Tin01_edgeData>"
