...
class PackskdrdisData:
    """
    Auto-generated data class for packskdrdis.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<PackskdrdisData {pk_column}={pk_value!r}>>"
        else:
            return f"<PackskdrdisData>"
