...
class Nwn2_scriptsetsData:
    """
    Auto-generated data class for nwn2_scriptsets.2da
    
    This class provides efficient attribute access to 2DA row data
    with automatic column name mapping for mod compatibility.
    """
    __slots__ = ('_resource_manager', '_LABEL', '_ScriptHeartbeat', '_ScriptOnNotice', '_ScriptSpellAt', '_ScriptAttacked', '_ScriptDamaged', '_ScriptDisturbed', '_ScriptEndRound', '_ScriptDialogue', '_ScriptSpawn', '_ScriptRested', '_ScriptDeath', '_ScriptUserDefine', '_ScriptOnBlocked')
    _column_mapping = {'LABEL': 'LABEL', 'ScriptHeartbeat': 'ScriptHeartbeat', 'ScriptOnNotice': 'ScriptOnNotice', 'ScriptSpellAt': 'ScriptSpellAt', 'ScriptAttacked': 'ScriptAttacked', 'ScriptDamaged': 'ScriptDamaged', 'ScriptDisturbed': 'ScriptDisturbed', 'ScriptEndRound': 'ScriptEndRound', 'ScriptDialogue': 'ScriptDialogue', 'ScriptSpawn': 'ScriptSpawn', 'ScriptRested': 'ScriptRested', 'ScriptDeath': 'ScriptDeath', 'ScriptUserDefine': 'ScriptUserDefine', 'ScriptOnBlocked': 'ScriptOnBlocked'}
    _table_name = 'nwn2_scriptsets'
    _safe_columns = ['LABEL', 'ScriptHeartbeat', 'ScriptOnNotice', 'ScriptSpellAt', 'ScriptAttacked', 'ScriptDamaged', 'ScriptDisturbed', 'ScriptEndRound', 'ScriptDialogue', 'ScriptSpawn', 'ScriptRested', 'ScriptDeath', 'ScriptUserDefine', 'ScriptOnBlocked']
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Nwn2_scriptsetsData {pk_column}={pk_value!r}>>"
        else:
            return f"<Nwn2_scriptsetsData>"
