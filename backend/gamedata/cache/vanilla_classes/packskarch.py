...
class PackskarchData:
    """
    Auto-generated data class for packskarch.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<PackskarchData {pk_column}={pk_value!r}>>"
        else:
            return f"<PackskarchData>"
