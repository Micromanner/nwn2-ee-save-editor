...
class PackeqfightcData:
    """
    Auto-generated data class for packeqfightc.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<PackeqfightcData {pk_column}={pk_value!r}>>"
        else:
            return f"<PackeqfightcData>"
