...
class ItmwizthrowData:
    """
    Auto-generated data class for itmwizthrow.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<ItmwizthrowData {pk_column}={pk_value!r}>>"
        else:
            return f"<ItmwizthrowData>"
