...
class Race_feat_hfdrowData:
    """
    Auto-generated data class for race_feat_hfdrow.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Race_feat_hfdrowData {pk_column}={pk_value!r}>>"
        else:
            return f"<Race_feat_hfdrowData>"
