...
class Itm_rand_arm_aData:
    """
    Auto-generated data class for itm_rand_arm_a.2da
    
    This class provides efficient attribute access to 2DA row data
    with automatic column name mapping for mod compatibility.
    """
    __slots__ = ('_resource_manager', '_LTE_MINOR', '_LTE_MEDIUM', '_LTE_MAJOR', '_PROPERTY', '_col_empty_4', '_ItemPropID', '_ItemSubPropID_ItemPropValue', '_CostTableValue')
    _column_mapping = {'LTE_MINOR': 'LTE_MINOR', 'LTE_MEDIUM': 'LTE_MEDIUM', 'LTE_MAJOR': 'LTE_MAJOR', 'PROPERTY': 'PROPERTY', '': 'col_empty_4', 'ItemPropID': 'ItemPropID', 'ItemSubPropID ItemPropValue': 'ItemSubPropID_ItemPropValue', 'CostTableValue': 'CostTableValue'}
    _table_name = 'itm_rand_arm_a'
    _safe_columns = ['LTE_MINOR', 'LTE_MEDIUM', 'LTE_MAJOR', 'PROPERTY', 'col_empty_4', 'ItemPropID', 'ItemSubPropID_ItemPropValue', 'CostTableValue']
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Itm_rand_arm_aData {pk_column}={pk_value!r}>>"
        else:
            return f"<Itm_rand_arm_aData>"
