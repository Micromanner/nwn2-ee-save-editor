...
class Cls_skill_stormlordData:
    """
    Auto-generated data class for cls_skill_stormlord.2da
    ...
    _table_name = 'cls_skill_stormlord'
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Cls_skill_stormlordData {pk_column}={pk_value!r}>>"
        else:
            return f"<Cls_skill_stormlordData>"
