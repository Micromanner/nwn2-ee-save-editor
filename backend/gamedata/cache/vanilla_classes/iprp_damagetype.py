...
class Iprp_damagetypeData:
    """
    Auto-generated data class for iprp_damagetype.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Iprp_damagetypeData {pk_column}={pk_value!r}>>"
        else:
            return f"<Iprp_damagetypeData>"
