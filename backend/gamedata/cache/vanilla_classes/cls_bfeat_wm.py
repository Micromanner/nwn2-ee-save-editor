...
class Cls_bfeat_wmData:
    """
    Auto-generated data class for cls_bfeat_wm.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Cls_bfeat_wmData {pk_column}={pk_value!r}>>"
        else:
            return f"<Cls_bfeat_wmData>"
