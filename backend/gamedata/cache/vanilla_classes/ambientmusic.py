...
class AmbientmusicData:
    """
    Auto-generated data class for ambientmusic.2da
    
    This class provides efficient attribute access to 2DA row data
    with automatic column name mapping for mod compatibility.
    """
    __slots__ = ('_resource_manager', '_Description', '_Resource', '_Stinger1', '_Stinger2', '_Stinger3', '_Label')
    _column_mapping = {'Description': 'Description', 'Resource': 'Resource', 'Stinger1': 'Stinger1', 'Stinger2': 'Stinger2', 'Stinger3': 'Stinger3', 'Label': 'Label'}
    _table_name = 'ambientmusic'
    _safe_columns = ['Description', 'Resource', 'Stinger1', 'Stinger2', 'Stinger3', 'Label']
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<AmbientmusicData {pk_column}={pk_value!r}>>"
        else:
            return f"<AmbientmusicData>"
