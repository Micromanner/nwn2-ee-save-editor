...
class Race_feat_dragonData:
    """
    Auto-generated data class for race_feat_dragon.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Race_feat_dragonData {pk_column}={pk_value!r}>>"
        else:
            return f"<Race_feat_dragonData>"
