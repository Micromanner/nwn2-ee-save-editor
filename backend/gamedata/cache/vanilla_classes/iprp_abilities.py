...
class Iprp_abilitiesData:
    """
    Auto-generated data class for iprp_abilities.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Iprp_abilitiesData {pk_column}={pk_value!r}>>"
        else:
            return f"<Iprp_abilitiesData>"
