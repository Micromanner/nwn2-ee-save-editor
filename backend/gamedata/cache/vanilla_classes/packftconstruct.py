...
class PackftconstructData:
    """
    Auto-generated data class for packftconstruct.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<PackftconstructData {pk_column}={pk_value!r}>>"
        else:
            return f"<PackftconstructData>"
