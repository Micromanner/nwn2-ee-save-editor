...
class Packftfavsoul1Data:
    """
    Auto-generated data class for packftfavsoul1.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Packftfavsoul1Data {pk_column}={pk_value!r}>>"
        else:
            return f"<Packftfavsoul1Data>"
