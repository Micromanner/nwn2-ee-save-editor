...
class Iprp_acmodtypeData:
    """
    Auto-generated data class for iprp_acmodtype.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Iprp_acmodtypeData {pk_column}={pk_value!r}>>"
        else:
            return f"<Iprp_acmodtypeData>"
