...
class EnvironmentData:
    """
    Auto-generated data class for environment.2da
    
    This class provides efficient attribute access to 2DA row data
    with automatic column name mapping for mod compatibility.
    """
    __slots__ = ('_resource_manager', '_LABEL', '_STRREF', '_DAYNIGHT', '_LIGHT_AMB_RED', '_LIGHT_AMB_GREEN', '_LIGHT_AMB_BLUE', '_LIGHT_DIFF_RED', '_LIGHT_DIFF_GREEN', '_LIGHT_DIFF_BLUE', '_LIGHT_SHADOWS', '_DARK_AMB_RED', '_DARK_AMB_GREEN', '_DARK_AMB_BLUE', '_DARK_DIFF_RED', '_DARK_DIFF_GREEN', '_DARK_DIFF_BLUE', '_DARK_SHADOWS', '_LIGHT_FOG_RED', '_LIGHT_FOG_GREEN', '_LIGHT_FOG_BLUE', '_DARK_FOG_RED', '_DARK_FOG_GREEN', '_DARK_FOG_BLUE', '_LIGHT_FOG', '_DARK_FOG', '_MAIN1_COLOR1', '_MAIN1_COLOR2', '_MAIN1_COLOR3', '_MAIN1_COLOR4', '_MAIN2_COLOR1', '_MAIN2_COLOR2', '_MAIN2_COLOR3', '_MAIN2_COLOR4', '_SECONDARY_COLOR1', '_SECONDARY_COLOR2', '_SECONDARY_COLOR3', '_SECONDARY_COLOR4', '_WIND', '_SNOW', '_RAIN', '_LIGHTNING', '_SHADOW_ALPHA', '_SKYBOX')
    _column_mapping = {'LABEL': 'LABEL', 'STRREF': 'STRREF', 'DAYNIGHT': 'DAYNIGHT', 'LIGHT_AMB_RED': 'LIGHT_AMB_RED', 'LIGHT_AMB_GREEN': 'LIGHT_AMB_GREEN', 'LIGHT_AMB_BLUE': 'LIGHT_AMB_BLUE', 'LIGHT_DIFF_RED': 'LIGHT_DIFF_RED', 'LIGHT_DIFF_GREEN': 'LIGHT_DIFF_GREEN', 'LIGHT_DIFF_BLUE': 'LIGHT_DIFF_BLUE', 'LIGHT_SHADOWS': 'LIGHT_SHADOWS', 'DARK_AMB_RED': 'DARK_AMB_RED', 'DARK_AMB_GREEN': 'DARK_AMB_GREEN', 'DARK_AMB_BLUE': 'DARK_AMB_BLUE', 'DARK_DIFF_RED': 'DARK_DIFF_RED', 'DARK_DIFF_GREEN': 'DARK_DIFF_GREEN', 'DARK_DIFF_BLUE': 'DARK_DIFF_BLUE', 'DARK_SHADOWS': 'DARK_SHADOWS', 'LIGHT_FOG_RED': 'LIGHT_FOG_RED', 'LIGHT_FOG_GREEN': 'LIGHT_FOG_GREEN', 'LIGHT_FOG_BLUE': 'LIGHT_FOG_BLUE', 'DARK_FOG_RED': 'DARK_FOG_RED', 'DARK_FOG_GREEN': 'DARK_FOG_GREEN', 'DARK_FOG_BLUE': 'DARK_FOG_BLUE', 'LIGHT_FOG': 'LIGHT_FOG', 'DARK_FOG': 'DARK_FOG', 'MAIN1_COLOR1': 'MAIN1_COLOR1', 'MAIN1_COLOR2': 'MAIN1_COLOR2', 'MAIN1_COLOR3': 'MAIN1_COLOR3', 'MAIN1_COLOR4': 'MAIN1_COLOR4', 'MAIN2_COLOR1': 'MAIN2_COLOR1', 'MAIN2_COLOR2': 'MAIN2_COLOR2', 'MAIN2_COLOR3': 'MAIN2_COLOR3', 'MAIN2_COLOR4': 'MAIN2_COLOR4', 'SECONDARY_COLOR1': 'SECONDARY_COLOR1', 'SECONDARY_COLOR2': 'SECONDARY_COLOR2', 'SECONDARY_COLOR3': 'SECONDARY_COLOR3', 'SECONDARY_COLOR4': 'SECONDARY_COLOR4', 'WIND': 'WIND', 'SNOW': 'SNOW', 'RAIN': 'RAIN', 'LIGHTNING': 'LIGHTNING', 'SHADOW_ALPHA': 'SHADOW_ALPHA', 'SKYBOX': 'SKYBOX'}
    _table_name = 'environment'
    _safe_columns = ['LABEL', 'STRREF', 'DAYNIGHT', 'LIGHT_AMB_RED', 'LIGHT_AMB_GREEN', 'LIGHT_AMB_BLUE', 'LIGHT_DIFF_RED', 'LIGHT_DIFF_GREEN', 'LIGHT_DIFF_BLUE', 'LIGHT_SHADOWS', 'DARK_AMB_RED', 'DARK_AMB_GREEN', 'DARK_AMB_BLUE', 'DARK_DIFF_RED', 'DARK_DIFF_GREEN', 'DARK_DIFF_BLUE', 'DARK_SHADOWS', 'LIGHT_FOG_RED', 'LIGHT_FOG_GREEN', 'LIGHT_FOG_BLUE', 'DARK_FOG_RED', 'DARK_FOG_GREEN', 'DARK_FOG_BLUE', 'LIGHT_FOG', 'DARK_FOG', 'MAIN1_COLOR1', 'MAIN1_COLOR2', 'MAIN1_COLOR3', 'MAIN1_COLOR4', 'MAIN2_COLOR1', 'MAIN2_COLOR2', 'MAIN2_COLOR3', 'MAIN2_COLOR4', 'SECONDARY_COLOR1', 'SECONDARY_COLOR2', 'SECONDARY_COLOR3', 'SECONDARY_COLOR4', 'WIND', 'SNOW', 'RAIN', 'LIGHTNING', 'SHADOW_ALPHA', 'SKYBOX']
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<EnvironmentData {pk_column}={pk_value!r}>>"
        else:
