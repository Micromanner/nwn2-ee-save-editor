...
class Iprp_monsterdamData:
    """
    Auto-generated data class for iprp_monsterdam.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Iprp_monsterdamData {pk_column}={pk_value!r}>>"
        else:
            return f"<Iprp_monsterdamData>"
