...
class PackftquarrelData:
    """
    Auto-generated data class for packftquarrel.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<PackftquarrelData {pk_column}={pk_value!r}>>"
        else:
            return f"<PackftquarrelData>"
