...
class SkillsData:
    """
    Auto-generated data class for skills.2da
    
    This class provides efficient attribute access to 2DA row data
    with automatic column name mapping for mod compatibility.
    """
    __slots__ = ('_resource_manager', '_Label', '_Name', '_Description', '_Icon', '_Untrained', '_KeyAbility', '_ArmorCheckPenalty', '_AllClassesCanUse', '_Category', '_MaxCR', '_Constant', '_HostileSkill', '_CosmopolitanFeat', '_IsAnActiveSkill', '_ToggleMode', '_PlayerOnly', '_REMOVED')
    _column_mapping = {'Label': 'Label', 'Name': 'Name', 'Description': 'Description', 'Icon': 'Icon', 'Untrained': 'Untrained', 'KeyAbility': 'KeyAbility', 'ArmorCheckPenalty': 'ArmorCheckPenalty', 'AllClassesCanUse': 'AllClassesCanUse', 'Category': 'Category', 'MaxCR': 'MaxCR', 'Constant': 'Constant', 'HostileSkill': 'HostileSkill', 'CosmopolitanFeat': 'CosmopolitanFeat', 'IsAnActiveSkill': 'IsAnActiveSkill', 'ToggleMode': 'ToggleMode', 'PlayerOnly': 'PlayerOnly', 'REMOVED': 'REMOVED'}
    _table_name = 'skills'
    _safe_columns = ['Label', 'Name', 'Description', 'Icon', 'Untrained', 'KeyAbility', 'ArmorCheckPenalty', 'AllClassesCanUse', 'Category', 'MaxCR', 'Constant', 'HostileSkill', 'CosmopolitanFeat', 'IsAnActiveSkill', 'ToggleMode', 'PlayerOnly', 'REMOVED']
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<SkillsData {pk_column}={pk_value!r}>>"
        else:
            return f"<SkillsData>"
