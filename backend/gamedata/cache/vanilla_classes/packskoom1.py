...
class Packskoom1Data:
    """
    Auto-generated data class for packskoom1.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Packskoom1Data {pk_column}={pk_value!r}>>"
        else:
            return f"<Packskoom1Data>"
