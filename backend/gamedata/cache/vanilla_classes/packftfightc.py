...
class PackftfightcData:
    """
    Auto-generated data class for packftfightc.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<PackftfightcData {pk_column}={pk_value!r}>>"
        else:
            return f"<PackftfightcData>"
