...
class ItmwizrangedData:
    """
    Auto-generated data class for itmwizranged.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<ItmwizrangedData {pk_column}={pk_value!r}>>"
        else:
            return f"<ItmwizrangedData>"
