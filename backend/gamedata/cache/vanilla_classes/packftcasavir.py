...
class PackftcasavirData:
    """
    Auto-generated data class for packftcasavir.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<PackftcasavirData {pk_column}={pk_value!r}>>"
        else:
            return f"<PackftcasavirData>"
