...
class Cls_savthr_wildData:
    """
    Auto-generated data class for cls_savthr_wild.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Cls_savthr_wildData {pk_column}={pk_value!r}>>"
        else:
            return f"<Cls_savthr_wildData>"
