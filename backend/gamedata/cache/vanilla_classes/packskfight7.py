...
class Packskfight7Data:
    """
    Auto-generated data class for packskfight7.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Packskfight7Data {pk_column}={pk_value!r}>>"
        else:
            return f"<Packskfight7Data>"
