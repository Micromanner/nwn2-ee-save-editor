...
class Packskmonk6Data:
    """
    Auto-generated data class for packskmonk6.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Packskmonk6Data {pk_column}={pk_value!r}>>"
        else:
            return f"<Packskmonk6Data>"
