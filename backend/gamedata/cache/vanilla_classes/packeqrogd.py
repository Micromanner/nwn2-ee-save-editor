...
class PackeqrogdData:
    """
    Auto-generated data class for packeqrogd.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<PackeqrogdData {pk_column}={pk_value!r}>>"
        else:
            return f"<PackeqrogdData>"
