...
class Iprp_alignmentData:
    """
    Auto-generated data class for iprp_alignment.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Iprp_alignmentData {pk_column}={pk_value!r}>>"
        else:
            return f"<Iprp_alignmentData>"
