...
class ItmwiztrapData:
    """
    Auto-generated data class for itmwiztrap.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<ItmwiztrapData {pk_column}={pk_value!r}>>"
        else:
            return f"<ItmwiztrapData>"
