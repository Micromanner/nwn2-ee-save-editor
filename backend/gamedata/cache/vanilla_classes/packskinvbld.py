...
class PackskinvbldData:
    """
    Auto-generated data class for packskinvbld.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<PackskinvbldData {pk_column}={pk_value!r}>>"
        else:
            return f"<PackskinvbldData>"
