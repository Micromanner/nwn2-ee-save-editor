...
class Nwn2_animstanData:
    """
    Auto-generated data class for nwn2_animstan.2da
    
    This class provides efficient attribute access to 2DA row data
    with automatic column name mapping for mod compatibility.
    """
    __slots__ = ('_resource_manager', '_ANIMTYPE', '_UNIVERSAL', '_ANIMATION', '_ALTERNATE', '_BLENDIN', '_BLENDOUT')
    _column_mapping = {'ANIMTYPE': 'ANIMTYPE', 'UNIVERSAL': 'UNIVERSAL', 'ANIMATION': 'ANIMATION', 'ALTERNATE': 'ALTERNATE', 'BLENDIN': 'BLENDIN', 'BLENDOUT': 'BLENDOUT'}
    _table_name = 'nwn2_animstan'
    _safe_columns = ['ANIMTYPE', 'UNIVERSAL', 'ANIMATION', 'ALTERNATE', 'BLENDIN', 'BLENDOUT']
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Nwn2_animstanData {pk_column}={pk_value!r}>>"
        else:
            return f"<Nwn2_animstanData>"
