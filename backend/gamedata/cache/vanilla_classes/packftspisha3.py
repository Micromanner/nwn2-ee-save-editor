...
class Packftspisha3Data:
    """
    Auto-generated data class for packftspisha3.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Packftspisha3Data {pk_column}={pk_value!r}>>"
        else:
            return f"<Packftspisha3Data>"
