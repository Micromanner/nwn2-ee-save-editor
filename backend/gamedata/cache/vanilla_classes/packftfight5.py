...
class Packftfight5Data:
    """
    Auto-generated data class for packftfight5.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Packftfight5Data {pk_column}={pk_value!r}>>"
        else:
            return f"<Packftfight5Data>"
