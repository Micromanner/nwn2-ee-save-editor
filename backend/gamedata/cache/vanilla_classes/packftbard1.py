...
class Packftbard1Data:
    """
    Auto-generated data class for packftbard1.2da
    
    This class provides efficient attribute access to 2DA row data
    with automatic column name mapping for mod compatibility.
    """
    __slots__ = ('_resource_manager', '_FeatIndex', '_Label', '_col_empty_2')
    _column_mapping = {'FeatIndex': 'FeatIndex', 'Label': 'Label', '': 'col_empty_2'}
    _table_name = 'packftbard1'
    _safe_columns = ['FeatIndex', 'Label', 'col_empty_2']
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Packftbard1Data {pk_column}={pk_value!r}>>"
        else:
            return f"<Packftbard1Data>"
