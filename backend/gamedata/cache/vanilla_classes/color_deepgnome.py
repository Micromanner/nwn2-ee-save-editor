...
class Color_deepgnomeData:
    """
    Auto-generated data class for color_deepgnome.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Color_deepgnomeData {pk_column}={pk_value!r}>>"
        else:
            return f"<Color_deepgnomeData>"
