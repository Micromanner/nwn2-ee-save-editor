...
class Packftwiz7Data:
    """
    Auto-generated data class for packftwiz7.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Packftwiz7Data {pk_column}={pk_value!r}>>"
        else:
            return f"<Packftwiz7Data>"
