...
class Packeqfight6Data:
    """
    Auto-generated data class for packeqfight6.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Packeqfight6Data {pk_column}={pk_value!r}>>"
        else:
            return f"<Packeqfight6Data>"
