...
class Race_feat_yuantiData:
    """
    Auto-generated data class for race_feat_yuanti.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Race_feat_yuantiData {pk_column}={pk_value!r}>>"
        else:
            return f"<Race_feat_yuantiData>"
