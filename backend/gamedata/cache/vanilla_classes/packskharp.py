...
class PackskharpData:
    """
    Auto-generated data class for packskharp.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<PackskharpData {pk_column}={pk_value!r}>>"
        else:
            return f"<PackskharpData>"
