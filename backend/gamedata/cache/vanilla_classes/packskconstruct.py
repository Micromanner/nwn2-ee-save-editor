...
class PackskconstructData:
    """
    Auto-generated data class for packskconstruct.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<PackskconstructData {pk_column}={pk_value!r}>>"
        else:
            return f"<PackskconstructData>"
