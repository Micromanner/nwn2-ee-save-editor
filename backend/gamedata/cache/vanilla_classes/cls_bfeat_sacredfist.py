...
class Cls_bfeat_sacredfistData:
    """
    Auto-generated data class for cls_bfeat_sacredfist.2da
    ...
    _table_name = 'cls_bfeat_sacredfist'
    _safe_columns = ['Bonus']
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Cls_bfeat_sacredfistData {pk_column}={pk_value!r}>>"
        else:
            return f"<Cls_bfeat_sacredfistData>"
