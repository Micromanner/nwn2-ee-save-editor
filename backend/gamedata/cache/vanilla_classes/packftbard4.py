...
class Packftbard4Data:
    """
    Auto-generated data class for packftbard4.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Packftbard4Data {pk_column}={pk_value!r}>>"
        else:
            return f"<Packftbard4Data>"
