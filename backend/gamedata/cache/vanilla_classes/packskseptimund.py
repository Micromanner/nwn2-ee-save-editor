...
class PackskseptimundData:
    """
    Auto-generated data class for packskseptimund.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<PackskseptimundData {pk_column}={pk_value!r}>>"
        else:
            return f"<PackskseptimundData>"
