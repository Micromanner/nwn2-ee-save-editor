...
class Packftwlck3Data:
    """
    Auto-generated data class for packftwlck3.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Packftwlck3Data {pk_column}={pk_value!r}>>"
        else:
            return f"<Packftwlck3Data>"
