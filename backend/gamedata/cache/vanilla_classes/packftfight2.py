...
class Packftfight2Data:
    """
    Auto-generated data class for packftfight2.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Packftfight2Data {pk_column}={pk_value!r}>>"
        else:
            return f"<Packftfight2Data>"
