...
class Cls_skill_dwdefData:
    """
    Auto-generated data class for cls_skill_dwdef.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Cls_skill_dwdefData {pk_column}={pk_value!r}>>"
        else:
            return f"<Cls_skill_dwdefData>"
