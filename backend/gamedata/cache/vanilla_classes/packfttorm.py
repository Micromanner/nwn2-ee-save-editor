...
class PackfttormData:
    """
    Auto-generated data class for packfttorm.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<PackfttormData {pk_column}={pk_value!r}>>"
        else:
            return f"<PackfttormData>"
