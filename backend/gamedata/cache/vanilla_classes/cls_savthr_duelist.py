...
class Cls_savthr_duelistData:
    """
    Auto-generated data class for cls_savthr_duelist.2da
    
    This class provides efficient attribute access to 2DA row data
    with automatic column name mapping for mod compatibility.
    """
    __slots__ = ('_resource_manager', '_Level', '_FortSave', '_RefSave', '_WillSave')
    _column_mapping = {'Level': 'Level', 'FortSave': 'FortSave', 'RefSave': 'RefSave', 'WillSave': 'WillSave'}
    _table_name = 'cls_savthr_duelist'
    _safe_columns = ['Level', 'FortSave', 'RefSave', 'WillSave']
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Cls_savthr_duelistData {pk_column}={pk_value!r}>>"
        else:
            return f"<Cls_savthr_duelistData>"
