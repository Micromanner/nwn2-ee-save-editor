...
class PlaceablesData:
    """
    Auto-generated data class for placeables.2da
    
    This class provides efficient attribute access to 2DA row data
    with automatic column name mapping for mod compatibility.
    """
    __slots__ = ('_resource_manager', '_Label', '_StrRef', '_PlaceableModelType', '_Fade', '_NWN2_ModelName', '_NWN2_LowGore', '_NWN2_PartsCount', '_NWN2_Skeleton', '_AttachedModelName', '_DefaultDoor', '_DefaultAccessory', '_IsAccessory', '_ModelName', '_LightColor', '_LightOffsetX', '_LightOffsetY', '_LightOffsetZ', '_SoundAppType', '_ShadowSize', '_BodyBag', '_LowGore', '_Reflection', '_InterfacePT', '_BlockLOS', '_SELECTION_SIZE')
    _column_mapping = {'Label': 'Label', 'StrRef': 'StrRef', 'PlaceableModelType': 'PlaceableModelType', 'Fade': 'Fade', 'NWN2_ModelName': 'NWN2_ModelName', 'NWN2_LowGore': 'NWN2_LowGore', 'NWN2_PartsCount': 'NWN2_PartsCount', 'NWN2_Skeleton': 'NWN2_Skeleton', 'AttachedModelName': 'AttachedModelName', 'DefaultDoor': 'DefaultDoor', 'DefaultAccessory': 'DefaultAccessory', 'IsAccessory': 'IsAccessory', 'ModelName': 'ModelName', 'LightColor': 'LightColor', 'LightOffsetX': 'LightOffsetX', 'LightOffsetY': 'LightOffsetY', 'LightOffsetZ': 'LightOffsetZ', 'SoundAppType': 'SoundAppType', 'ShadowSize': 'ShadowSize', 'BodyBag': 'BodyBag', 'LowGore': 'LowGore', 'Reflection': 'Reflection', 'InterfacePT': 'InterfacePT', 'BlockLOS': 'BlockLOS', 'SELECTION_SIZE': 'SELECTION_SIZE'}
    _table_name = 'placeables'
    _safe_columns = ['Label', 'StrRef', 'PlaceableModelType', 'Fade', 'NWN2_ModelName', 'NWN2_LowGore', 'NWN2_PartsCount', 'NWN2_Skeleton', 'AttachedModelName', 'DefaultDoor', 'DefaultAccessory', 'IsAccessory', 'ModelName', 'LightColor', 'LightOffsetX', 'LightOffsetY', 'LightOffsetZ', 'SoundAppType', 'ShadowSize', 'BodyBag', 'LowGore', 'Reflection', 'InterfacePT', 'BlockLOS', 'SELECTION_SIZE']
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<PlaceablesData {pk_column}={pk_value!r}>>"
        else:
            return f"<PlaceablesData>"
