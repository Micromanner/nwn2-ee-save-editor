...
class Cls_feat_wizData:
    """
    Auto-generated data class for cls_feat_wiz.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Cls_feat_wizData {pk_column}={pk_value!r}>>"
        else:
            return f"<Cls_feat_wizData>"
