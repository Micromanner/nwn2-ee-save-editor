...
class Race_feat_fire_genasiData:
    """
    Auto-generated data class for race_feat_fire_genasi.2da
    ...
    _table_name = 'race_feat_fire_genasi'
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Race_feat_fire_genasiData {pk_column}={pk_value!r}>>"
        else:
            return f"<Race_feat_fire_genasiData>"
