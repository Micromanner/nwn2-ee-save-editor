...
class Cls_spkn_bardData:
    """
    Auto-generated data class for cls_spkn_bard.2da
    
    This class provides efficient attribute access to 2DA row data
    with automatic column name mapping for mod compatibility.
    """
    __slots__ = ('_resource_manager', '_Level', '_SpellLevel0', '_SpellLevel1', '_SpellLevel2', '_SpellLevel3', '_SpellLevel4', '_SpellLevel5', '_SpellLevel6')
    _column_mapping = {'Level': 'Level', 'SpellLevel0': 'SpellLevel0', 'SpellLevel1': 'SpellLevel1', 'SpellLevel2': 'SpellLevel2', 'SpellLevel3': 'SpellLevel3', 'SpellLevel4': 'SpellLevel4', 'SpellLevel5': 'SpellLevel5', 'SpellLevel6': 'SpellLevel6'}
    _table_name = 'cls_spkn_bard'
    _safe_columns = ['Level', 'SpellLevel0', 'SpellLevel1', 'SpellLevel2', 'SpellLevel3', 'SpellLevel4', 'SpellLevel5', 'SpellLevel6']
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Cls_spkn_bardData {pk_column}={pk_value!r}>>"
        else:
            return f"<Cls_spkn_bardData>"
