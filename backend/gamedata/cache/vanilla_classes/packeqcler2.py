...
class Packeqcler2Data:
    """
    Auto-generated data class for packeqcler2.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Packeqcler2Data {pk_column}={pk_value!r}>>"
        else:
            return f"<Packeqcler2Data>"
