...
class PacksktormData:
    """
    Auto-generated data class for packsktorm.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<PacksktormData {pk_column}={pk_value!r}>>"
        else:
            return f"<PacksktormData>"
