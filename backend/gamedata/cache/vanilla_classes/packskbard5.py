...
class Packskbard5Data:
    """
    Auto-generated data class for packskbard5.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Packskbard5Data {pk_column}={pk_value!r}>>"
        else:
            return f"<Packskbard5Data>"
