...
class Cls_bfeat_cavalData:
    """
    Auto-generated data class for cls_bfeat_caval.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Cls_bfeat_cavalData {pk_column}={pk_value!r}>>"
        else:
            return f"<Cls_bfeat_cavalData>"
