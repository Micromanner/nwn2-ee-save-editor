...
class Iprp_bonuscostData:
    """
    Auto-generated data class for iprp_bonuscost.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Iprp_bonuscostData {pk_column}={pk_value!r}>>"
        else:
            return f"<Iprp_bonuscostData>"
