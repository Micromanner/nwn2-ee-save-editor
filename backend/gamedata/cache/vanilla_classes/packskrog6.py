...
class Packskrog6Data:
    """
    Auto-generated data class for packskrog6.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Packskrog6Data {pk_column}={pk_value!r}>>"
        else:
            return f"<Packskrog6Data>"
