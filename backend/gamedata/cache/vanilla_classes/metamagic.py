...
class MetamagicData:
    """
    Auto-generated data class for metamagic.2da
    
    This class provides efficient attribute access to 2DA row data
    with automatic column name mapping for mod compatibility.
    """
    __slots__ = ('_resource_manager', '_Name', '_Label', '_LevelAdjustment', '_FeatRequired', '_SpellRequired', '_Bits', '_MetaExcludes', '_IconPrefixResRef', '_IconSuffixResRef', '_AssociatedSpell', '_ImprovedFeat', '_ImprovedLevelAdjustment')
    _column_mapping = {'Name': 'Name', 'Label': 'Label', 'LevelAdjustment': 'LevelAdjustment', 'FeatRequired': 'FeatRequired', 'SpellRequired': 'SpellRequired', 'Bits': 'Bits', 'MetaExcludes': 'MetaExcludes', 'IconPrefixResRef': 'IconPrefixResRef', 'IconSuffixResRef': 'IconSuffixResRef', 'AssociatedSpell': 'AssociatedSpell', 'ImprovedFeat': 'ImprovedFeat', 'ImprovedLevelAdjustment': 'ImprovedLevelAdjustment'}
    _table_name = 'metamagic'
    _safe_columns = ['Name', 'Label', 'LevelAdjustment', 'FeatRequired', 'SpellRequired', 'Bits', 'MetaExcludes', 'IconPrefixResRef', 'IconSuffixResRef', 'AssociatedSpell', 'ImprovedFeat', 'ImprovedLevelAdjustment']
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<MetamagicData {pk_column}={pk_value!r}>>"
        else:
            return f"<MetamagicData>"
