...
class Packskbard6Data:
    """
    Auto-generated data class for packskbard6.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Packskbard6Data {pk_column}={pk_value!r}>>"
        else:
            return f"<Packskbard6Data>"
