...
class Parts_pelvisData:
    """
    Auto-generated data class for parts_pelvis.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Parts_pelvisData {pk_column}={pk_value!r}>>"
        else:
            return f"<Parts_pelvisData>"
