...
class SounddefaultsposData:
    """
    Auto-generated data class for sounddefaultspos.2da
    
    This class provides efficient attribute access to 2DA row data
    with automatic column name mapping for mod compatibility.
    """
    __slots__ = ('_resource_manager', '_Label', '_RadiusInner', '_RadiusOuter', '_RandomRngX', '_RandomRngY', '_Height')
    _column_mapping = {'Label': 'Label', 'RadiusInner': 'RadiusInner', 'RadiusOuter': 'RadiusOuter', 'RandomRngX': 'RandomRngX', 'RandomRngY': 'RandomRngY', 'Height': 'Height'}
    _table_name = 'sounddefaultspos'
    _safe_columns = ['Label', 'RadiusInner', 'RadiusOuter', 'RandomRngX', 'RandomRngY', 'Height']
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<SounddefaultsposData {pk_column}={pk_value!r}>>"
        else:
            return f"<SounddefaultsposData>"
