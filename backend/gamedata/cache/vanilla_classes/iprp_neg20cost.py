...
class Iprp_neg20costData:
    """
    Auto-generated data class for iprp_neg20cost.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Iprp_neg20costData {pk_column}={pk_value!r}>>"
        else:
            return f"<Iprp_neg20costData>"
