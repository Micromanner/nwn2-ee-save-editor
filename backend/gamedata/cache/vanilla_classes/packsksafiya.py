...
class PacksksafiyaData:
    """
    Auto-generated data class for packsksafiya.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<PacksksafiyaData {pk_column}={pk_value!r}>>"
        else:
            return f"<PacksksafiyaData>"
