...
class ItmwizhelmetData:
    """
    Auto-generated data class for itmwizhelmet.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<ItmwizhelmetData {pk_column}={pk_value!r}>>"
        else:
            return f"<ItmwizhelmetData>"
