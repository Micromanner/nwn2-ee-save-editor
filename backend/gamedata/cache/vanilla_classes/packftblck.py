...
class PackftblckData:
    """
    Auto-generated data class for packftblck.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<PackftblckData {pk_column}={pk_value!r}>>"
        else:
            return f"<PackftblckData>"
