...
class Packskwlck5Data:
    """
    Auto-generated data class for packskwlck5.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Packskwlck5Data {pk_column}={pk_value!r}>>"
        else:
            return f"<Packskwlck5Data>"
