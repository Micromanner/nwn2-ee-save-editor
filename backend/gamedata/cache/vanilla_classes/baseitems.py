...
class BaseitemsData:
    """
    Auto-generated data class for baseitems.2da
    
    This class provides efficient attribute access to 2DA row data
    with automatic column name mapping for mod compatibility.
    """
    __slots__ = ('_resource_manager', '_Name', '_label', '_InvSlotWidth', '_InvSlotHeight', '_EquipableSlots', '_CanRotateIcon', '_ModelType', '_NWN2_Anim', '_ItemClass', '_GenderSpecific', '_Part1EnvMap', '_Part2EnvMap', '_Part3EnvMap', '_DefaultModel', '_NWN2_DefaultIcon', '_DefaultIcon', '_Container', '_WeaponWield', '_WeaponType', '_WeaponSize', '_RangedWeapon', '_PrefAttackDist', '_MinRange', '_MaxRange', '_NumDice', '_DieToRoll', '_CritThreat', '_CritHitMult', '_Category', '_BaseCost', '_Stacking', '_ItemMultiplier', '_Description', '_InvSoundType', '_MaxProps', '_MinProps', '_PropColumn', '_StorePanel', '_ReqFeat0', '_ReqFeat1', '_ReqFeat2', '_ReqFeat3', '_ReqFeat4', '_ReqFeat5', '_AC_Enchant', '_BaseAC', '_ArmorCheckPen', '_BaseItemStatRef', '_ChargesStarting', '_RotateOnGround', '_TenthLBS', '_WeaponMatType', '_AmmunitionType', '_QBBehaviour', '_ArcaneSpellFailure', '_pctAnimSlashL', '_pctAnimSlashR', '_pctAnimSlashS', '_StorePanelSort', '_ILRStackSize', '_FEATImprCrit', '_FEATWpnFocus', '_FEATWpnSpec', '_FEATEpicDevCrit', '_FEATEpicWpnFocus', '_FEATEpicWpnSpec', '_FEATOverWhCrit', '_FEATWpnOfChoice', '_FEATGrtrWpnFocus', '_FEATGrtrWpnSpec', '_FEATPowerCrit', '_GMaterialType', '_BaseItemSortOrder')
    _column_mapping = {'Name': 'Name', 'label': 'label', 'InvSlotWidth': 'InvSlotWidth', 'InvSlotHeight': 'InvSlotHeight', 'EquipableSlots': 'EquipableSlots', 'CanRotateIcon': 'CanRotateIcon', 'ModelType': 'ModelType', 'NWN2_Anim': 'NWN2_Anim', 'ItemClass': 'ItemClass', 'GenderSpecific': 'GenderSpecific', 'Part1EnvMap': 'Part1EnvMap', 'Part2EnvMap': 'Part2EnvMap', 'Part3EnvMap': 'Part3EnvMap', 'DefaultModel': 'DefaultModel', 'NWN2_DefaultIcon': 'NWN2_DefaultIcon', 'DefaultIcon': 'DefaultIcon', 'Container': 'Container', 'WeaponWield': 'WeaponWield', 'WeaponType': 'WeaponType', 'WeaponSize': 'WeaponSize', 'RangedWeapon': 'RangedWeapon', 'PrefAttackDist': 'PrefAttackDist', 'MinRange': 'MinRange', 'MaxRange': 'MaxRange', 'NumDice': 'NumDice', 'DieToRoll': 'DieToRoll', 'CritThreat': 'CritThreat', 'CritHitMult': 'CritHitMult', 'Category': 'Category', 'BaseCost': 'BaseCost', 'Stacking': 'Stacking', 'ItemMultiplier': 'ItemMultiplier', 'Description': 'Description', 'InvSoundType': 'InvSoundType', 'MaxProps': 'MaxProps', 'MinProps': 'MinProps', 'PropColumn': 'PropColumn', 'StorePanel': 'StorePanel', 'ReqFeat0': 'ReqFeat0', 'ReqFeat1': 'ReqFeat1', 'ReqFeat2': 'ReqFeat2', 'ReqFeat3': 'ReqFeat3', 'ReqFeat4': 'ReqFeat4', 'ReqFeat5': 'ReqFeat5', 'AC_Enchant': 'AC_Enchant', 'BaseAC': 'BaseAC', 'ArmorCheckPen': 'ArmorCheckPen', 'BaseItemStatRef': 'BaseItemStatRef', 'ChargesStarting': 'ChargesStarting', 'RotateOnGround': 'RotateOnGround', 'TenthLBS': 'TenthLBS', 'WeaponMatType': 'WeaponMatType', 'AmmunitionType': 'AmmunitionType', 'QBBehaviour': 'QBBehaviour', 'ArcaneSpellFailure': 'ArcaneSpellFailure', '%AnimSlashL': 'pctAnimSlashL', '%AnimSlashR': 'pctAnimSlashR', '%AnimSlashS': 'pctAnimSlashS', 'StorePanelSort': 'StorePanelSort', 'ILRStackSize': 'ILRStackSize', 'FEATImprCrit': 'FEATImprCrit', 'FEATWpnFocus': 'FEATWpnFocus', 'FEATWpnSpec': 'FEATWpnSpec', 'FEATEpicDevCrit': 'FEATEpicDevCrit', 'FEATEpicWpnFocus': 'FEATEpicWpnFocus', 'FEATEpicWpnSpec': 'FEATEpicWpnSpec', 'FEATOverWhCrit': 'FEATOverWhCrit', 'FEATWpnOfChoice': 'FEATWpnOfChoice', 'FEATGrtrWpnFocus': 'FEATGrtrWpnFocus', 'FEATGrtrWpnSpec': 'FEATGrtrWpnSpec', 'FEATPowerCrit': 'FEATPowerCrit', 'GMaterialType': 'GMaterialType', 'BaseItemSortOrder': 'BaseItemSortOrder'}
    _table_name = 'baseitems'
    _safe_columns = ['Name', 'label', 'InvSlotWidth', 'InvSlotHeight', 'EquipableSlots', 'CanRotateIcon', 'ModelType', 'NWN2_Anim', 'ItemClass', 'GenderSpecific', 'Part1EnvMap', 'Part2EnvMap', 'Part3EnvMap', 'DefaultModel', 'NWN2_DefaultIcon', 'DefaultIcon', 'Container', 'WeaponWield', 'WeaponType', 'WeaponSize', 'RangedWeapon', 'PrefAttackDist', 'MinRange', 'MaxRange', 'NumDice', 'DieToRoll', 'CritThreat', 'CritHitMult', 'Category', 'BaseCost', 'Stacking', 'ItemMultiplier', 'Description', 'InvSoundType', 'MaxProps', 'MinProps', 'PropColumn', 'StorePanel', 'ReqFeat0', 'ReqFeat1', 'ReqFeat2', 'ReqFeat3', 'ReqFeat4', 'ReqFeat5', 'AC_Enchant', 'BaseAC', 'ArmorCheckPen', 'BaseItemStatRef', 'ChargesStarting', 'RotateOnGround', 'TenthLBS', 'WeaponMatType', 'AmmunitionType', 'QBBehaviour', 'ArcaneSpellFailure', 'pctAnimSlashL', 'pctAnimSlashR', 'pctAnimSlashS', 'StorePanelSort', 'ILRStackSize', 'FEATImprCrit', 'FEATWpnFocus', 'FEATWpnSpec', 'FEATEpicDevCrit', 'FEATEpicWpnFocus', 'FEATEpicWpnSpec', 'FEATOverWhCrit', 'FEATWpnOfChoice', 'FEATGrtrWpnFocus', 'FEATGrtrWpnSpec', 'FEATPowerCrit', 'GMaterialType', 'BaseItemSortOrder']
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<BaseitemsData {pk_column}={pk_value!r}>>"
        else:
            return f"<BaseitemsData>"
