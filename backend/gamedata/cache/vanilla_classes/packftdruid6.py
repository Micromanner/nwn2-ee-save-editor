...
class Packftdruid6Data:
    """
    Auto-generated data class for packftdruid6.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Packftdruid6Data {pk_column}={pk_value!r}>>"
        else:
            return f"<Packftdruid6Data>"
