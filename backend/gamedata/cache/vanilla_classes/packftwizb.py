...
class PackftwizbData:
    """
    Auto-generated data class for packftwizb.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<PackftwizbData {pk_column}={pk_value!r}>>"
        else:
            return f"<PackftwizbData>"
