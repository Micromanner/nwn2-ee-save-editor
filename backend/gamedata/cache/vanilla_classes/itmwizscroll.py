...
class ItmwizscrollData:
    """
    Auto-generated data class for itmwizscroll.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<ItmwizscrollData {pk_column}={pk_value!r}>>"
        else:
            return f"<ItmwizscrollData>"
