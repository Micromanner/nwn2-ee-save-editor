...
class Des_restsystemData:
    """
    Auto-generated data class for des_restsystem.2da
    
    This class provides efficient attribute access to 2DA row data
    with automatic column name mapping for mod compatibility.
    """
    __slots__ = ('_resource_manager', '_TableName', '_Comment', '_ListenCheckDC', '_FeedBackStrRefSuccess', '_FeedBackStrRefFail', '_DayBaseProbability', '_NightBaseProbability', '_DAY_ResRef1', '_DAY_Prob1', '_DAY_ResRef2', '_DAY_Prob2', '_DAY_ResRef3', '_NIGHT_ResRef1', '_NIGHT_Prob1', '_NIGHT_ResRef2', '_NIGHT_Prob2', '_NIGHT_ResRef3')
    _column_mapping = {'TableName': 'TableName', 'Comment': 'Comment', 'ListenCheckDC': 'ListenCheckDC', 'FeedBackStrRefSuccess': 'FeedBackStrRefSuccess', 'FeedBackStrRefFail': 'FeedBackStrRefFail', 'DayBaseProbability': 'DayBaseProbability', 'NightBaseProbability': 'NightBaseProbability', 'DAY_ResRef1': 'DAY_ResRef1', 'DAY_Prob1': 'DAY_Prob1', 'DAY_ResRef2': 'DAY_ResRef2', 'DAY_Prob2': 'DAY_Prob2', 'DAY_ResRef3': 'DAY_ResRef3', 'NIGHT_ResRef1': 'NIGHT_ResRef1', 'NIGHT_Prob1': 'NIGHT_Prob1', 'NIGHT_ResRef2': 'NIGHT_ResRef2', 'NIGHT_Prob2': 'NIGHT_Prob2', 'NIGHT_ResRef3': 'NIGHT_ResRef3'}
    _table_name = 'des_restsystem'
    _safe_columns = ['TableName', 'Comment', 'ListenCheckDC', 'FeedBackStrRefSuccess', 'FeedBackStrRefFail', 'DayBaseProbability', 'NightBaseProbability', 'DAY_ResRef1', 'DAY_Prob1', 'DAY_ResRef2', 'DAY_Prob2', 'DAY_ResRef3', 'NIGHT_ResRef1', 'NIGHT_Prob1', 'NIGHT_ResRef2', 'NIGHT_Prob2', 'NIGHT_ResRef3']
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Des_restsystemData {pk_column}={pk_value!r}>>"
        else:
            return f"<Des_restsystemData>"
