...
class Race_feat_shield_dwarfData:
    """
    Auto-generated data class for race_feat_shield_dwarf.2da
    ...
    _table_name = 'race_feat_shield_dwarf'
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Race_feat_shield_dwarfData {pk_column}={pk_value!r}>>"
        else:
            return f"<Race_feat_shield_dwarfData>"
