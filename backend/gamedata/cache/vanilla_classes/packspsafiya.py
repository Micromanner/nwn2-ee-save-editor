...
class PackspsafiyaData:
    """
    Auto-generated data class for packspsafiya.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<PackspsafiyaData {pk_column}={pk_value!r}>>"
        else:
            return f"<PackspsafiyaData>"
