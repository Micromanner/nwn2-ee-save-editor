...
class Packeqcler1Data:
    """
    Auto-generated data class for packeqcler1.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Packeqcler1Data {pk_column}={pk_value!r}>>"
        else:
            return f"<Packeqcler1Data>"
