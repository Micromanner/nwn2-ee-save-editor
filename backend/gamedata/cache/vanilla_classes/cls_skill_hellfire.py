...
class Cls_skill_hellfireData:
    """
    Auto-generated data class for cls_skill_hellfire.2da
    ...
    _table_name = 'cls_skill_hellfire'
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Cls_skill_hellfireData {pk_column}={pk_value!r}>>"
        else:
            return f"<Cls_skill_hellfireData>"
