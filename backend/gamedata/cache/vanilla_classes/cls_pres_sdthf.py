...
class Cls_pres_sdthfData:
    """
    Auto-generated data class for cls_pres_sdthf.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Cls_pres_sdthfData {pk_column}={pk_value!r}>>"
        else:
            return f"<Cls_pres_sdthfData>"
