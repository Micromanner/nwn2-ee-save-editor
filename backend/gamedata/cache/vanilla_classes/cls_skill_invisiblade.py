...
class Cls_skill_invisibladeData:
    """
    Auto-generated data class for cls_skill_invisiblade.2da
    ...
    _table_name = 'cls_skill_invisiblade'
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Cls_skill_invisibladeData {pk_column}={pk_value!r}>>"
        else:
            return f"<Cls_skill_invisibladeData>"
