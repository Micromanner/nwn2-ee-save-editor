...
class Crft_alch_potnsData:
    """
    Auto-generated data class for crft_alch_potns.2da
    
    This class provides efficient attribute access to 2DA row data
    with automatic column name mapping for mod compatibility.
    """
    __slots__ = ('_resource_manager', '_Label', '_Name', '_Description', '_NormalItem', '_MaximizedItem', '_SkillRank', '_Cost', '_CanBeFound', '_Ingredient0', '_Count0', '_Ingredient1', '_Count1', '_SpellcraftIDRnk')
    _column_mapping = {'Label': 'Label', 'Name': 'Name', 'Description': 'Description', 'NormalItem': 'NormalItem', 'MaximizedItem': 'MaximizedItem', 'SkillRank': 'SkillRank', 'Cost': 'Cost', 'CanBeFound': 'CanBeFound', 'Ingredient0': 'Ingredient0', 'Count0': 'Count0', 'Ingredient1': 'Ingredient1', 'Count1': 'Count1', 'SpellcraftIDRnk': 'SpellcraftIDRnk'}
    _table_name = 'crft_alch_potns'
    _safe_columns = ['Label', 'Name', 'Description', 'NormalItem', 'MaximizedItem', 'SkillRank', 'Cost', 'CanBeFound', 'Ingredient0', 'Count0', 'Ingredient1', 'Count1', 'SpellcraftIDRnk']
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Crft_alch_potnsData {pk_column}={pk_value!r}>>"
        else:
            return f"<Crft_alch_potnsData>"
