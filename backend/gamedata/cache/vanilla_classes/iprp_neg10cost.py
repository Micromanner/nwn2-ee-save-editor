...
class Iprp_neg10costData:
    """
    Auto-generated data class for iprp_neg10cost.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Iprp_neg10costData {pk_column}={pk_value!r}>>"
        else:
            return f"<Iprp_neg10costData>"
