...
class Iprp_base1Data:
    """
    Auto-generated data class for iprp_base1.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Iprp_base1Data {pk_column}={pk_value!r}>>"
        else:
            return f"<Iprp_base1Data>"
