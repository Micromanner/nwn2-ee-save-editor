...
class Tic01_edgeData:
    """
    Auto-generated data class for tic01_edge.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Tic01_edgeData {pk_column}={pk_value!r}>>"
        else:
            return f"<Tic01_edgeData>"
