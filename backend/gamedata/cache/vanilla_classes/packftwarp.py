...
class PackftwarpData:
    """
    Auto-generated data class for packftwarp.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<PackftwarpData {pk_column}={pk_value!r}>>"
        else:
            return f"<PackftwarpData>"
