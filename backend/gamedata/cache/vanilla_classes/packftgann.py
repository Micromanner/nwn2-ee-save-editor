...
class PackftgannData:
    """
    Auto-generated data class for packftgann.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<PackftgannData {pk_column}={pk_value!r}>>"
        else:
            return f"<PackftgannData>"
