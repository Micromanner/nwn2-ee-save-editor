...
class TrapsData:
    """
    Auto-generated data class for traps.2da
    
    This class provides efficient attribute access to 2DA row data
    with automatic column name mapping for mod compatibility.
    """
    __slots__ = ('_resource_manager', '_Label', '_TrapScript', '_SetDC', '_DetectDCMod', '_DisarmDCMod', '_TrapName', '_ResRef', '_IconResRef')
    _column_mapping = {'Label': 'Label', 'TrapScript': 'TrapScript', 'SetDC': 'SetDC', 'DetectDCMod': 'DetectDCMod', 'DisarmDCMod': 'DisarmDCMod', 'TrapName': 'TrapName', 'ResRef': 'ResRef', 'IconResRef': 'IconResRef'}
    _table_name = 'traps'
    _safe_columns = ['Label', 'TrapScript', 'SetDC', 'DetectDCMod', 'DisarmDCMod', 'TrapName', 'ResRef', 'IconResRef']
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<TrapsData {pk_column}={pk_value!r}>>"
        else:
            return f"<TrapsData>"
