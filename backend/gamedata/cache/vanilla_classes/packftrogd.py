...
class PackftrogdData:
    """
    Auto-generated data class for packftrogd.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<PackftrogdData {pk_column}={pk_value!r}>>"
        else:
            return f"<PackftrogdData>"
