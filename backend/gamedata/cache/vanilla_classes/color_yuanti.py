...
class Color_yuantiData:
    """
    Auto-generated data class for color_yuanti.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Color_yuantiData {pk_column}={pk_value!r}>>"
        else:
            return f"<Color_yuantiData>"
