...
class Packftrog1Data:
    """
    Auto-generated data class for packftrog1.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Packftrog1Data {pk_column}={pk_value!r}>>"
        else:
            return f"<Packftrog1Data>"
