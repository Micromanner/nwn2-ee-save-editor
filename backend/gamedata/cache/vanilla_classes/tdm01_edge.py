...
class Tdm01_edgeData:
    """
    Auto-generated data class for tdm01_edge.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Tdm01_edgeData {pk_column}={pk_value!r}>>"
        else:
            return f"<Tdm01_edgeData>"
