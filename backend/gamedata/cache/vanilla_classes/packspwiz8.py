...
class Packspwiz8Data:
    """
    Auto-generated data class for packspwiz8.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Packspwiz8Data {pk_column}={pk_value!r}>>"
        else:
            return f"<Packspwiz8Data>"
