...
class PackspgannData:
    """
    Auto-generated data class for packspgann.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<PackspgannData {pk_column}={pk_value!r}>>"
        else:
            return f"<PackspgannData>"
