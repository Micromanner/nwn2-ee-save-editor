...
class Parts_shinData:
    """
    Auto-generated data class for parts_shin.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Parts_shinData {pk_column}={pk_value!r}>>"
        else:
            return f"<Parts_shinData>"
