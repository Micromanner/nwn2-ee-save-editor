...
class PackftdwdefData:
    """
    Auto-generated data class for packftdwdef.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<PackftdwdefData {pk_column}={pk_value!r}>>"
        else:
            return f"<PackftdwdefData>"
