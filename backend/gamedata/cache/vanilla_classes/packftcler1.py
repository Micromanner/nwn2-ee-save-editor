...
class Packftcler1Data:
    """
    Auto-generated data class for packftcler1.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Packftcler1Data {pk_column}={pk_value!r}>>"
        else:
            return f"<Packftcler1Data>"
