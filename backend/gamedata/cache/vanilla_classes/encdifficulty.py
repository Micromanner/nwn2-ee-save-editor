...
class EncdifficultyData:
    """
    Auto-generated data class for encdifficulty.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<EncdifficultyData {pk_column}={pk_value!r}>>"
        else:
            return f"<EncdifficultyData>"
