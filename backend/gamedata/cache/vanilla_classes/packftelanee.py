...
class PackftelaneeData:
    """
    Auto-generated data class for packftelanee.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<PackftelaneeData {pk_column}={pk_value!r}>>"
        else:
            return f"<PackftelaneeData>"
