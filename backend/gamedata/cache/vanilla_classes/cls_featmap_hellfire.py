...
class Cls_featmap_hellfireData:
    """
    Auto-generated data class for cls_featmap_hellfire.2da
    ...
    _table_name = 'cls_featmap_hellfire'
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Cls_featmap_hellfireData {pk_column}={pk_value!r}>>"
        else:
            return f"<Cls_featmap_hellfireData>"
