...
class Tin01doorsData:
    """
    Auto-generated data class for tin01doors.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Tin01doorsData {pk_column}={pk_value!r}>>"
        else:
            return f"<Tin01doorsData>"
