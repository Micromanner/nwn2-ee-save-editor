...
class Des_crft_matData:
    """
    Auto-generated data class for des_crft_mat.2da
    
    This class provides efficient attribute access to 2DA row data
    with automatic column name mapping for mod compatibility.
    """
    __slots__ = ('_resource_manager', '_Comment', '_x2_it_cmat_leath', '_x2_it_cmat_elmw', '_x2_it_cmat_oakw', '_x2_it_cmat_ironw', '_x2_it_cmat_bone', '_x2_it_cmat_iron', '_x2_it_cmat_steel', '_x2_it_cmat_adam', '_x2_it_cmat_mith', '_x2_it_cmat_cloth')
    _column_mapping = {'Comment': 'Comment', 'x2_it_cmat_leath': 'x2_it_cmat_leath', 'x2_it_cmat_elmw': 'x2_it_cmat_elmw', 'x2_it_cmat_oakw': 'x2_it_cmat_oakw', 'x2_it_cmat_ironw': 'x2_it_cmat_ironw', 'x2_it_cmat_bone': 'x2_it_cmat_bone', 'x2_it_cmat_iron': 'x2_it_cmat_iron', 'x2_it_cmat_steel': 'x2_it_cmat_steel', 'x2_it_cmat_adam': 'x2_it_cmat_adam', 'x2_it_cmat_mith': 'x2_it_cmat_mith', 'x2_it_cmat_cloth': 'x2_it_cmat_cloth'}
    _table_name = 'des_crft_mat'
    _safe_columns = ['Comment', 'x2_it_cmat_leath', 'x2_it_cmat_elmw', 'x2_it_cmat_oakw', 'x2_it_cmat_ironw', 'x2_it_cmat_bone', 'x2_it_cmat_iron', 'x2_it_cmat_steel', 'x2_it_cmat_adam', 'x2_it_cmat_mith', 'x2_it_cmat_cloth']
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Des_crft_matData {pk_column}={pk_value!r}>>"
        else:
            return f"<Des_crft_matData>"
