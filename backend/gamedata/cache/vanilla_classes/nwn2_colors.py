...
class Nwn2_colorsData:
    """
    Auto-generated data class for nwn2_colors.2da
    
    This class provides efficient attribute access to 2DA row data
    with automatic column name mapping for mod compatibility.
    """
    __slots__ = ('_resource_manager', '_ColorName', '_ColorHEX')
    _column_mapping = {'ColorName': 'ColorName', 'ColorHEX': 'ColorHEX'}
    _table_name = 'nwn2_colors'
    _safe_columns = ['ColorName', 'ColorHEX']
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Nwn2_colorsData {pk_column}={pk_value!r}>>"
        else:
            return f"<Nwn2_colorsData>"
