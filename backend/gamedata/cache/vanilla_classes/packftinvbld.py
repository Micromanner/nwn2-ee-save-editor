...
class PackftinvbldData:
    """
    Auto-generated data class for packftinvbld.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<PackftinvbldData {pk_column}={pk_value!r}>>"
        else:
            return f"<PackftinvbldData>"
