...
class DiseaseData:
    """
    Auto-generated data class for disease.2da
    
    This class provides efficient attribute access to 2DA row data
    with automatic column name mapping for mod compatibility.
    """
    __slots__ = ('_resource_manager', '_Label', '_Name', '_First_Save', '_Subs_Save', '_Incu_Hours', '_Dice_1', '_Dam_1', '_Type_1', '_Dice_2', '_Dam_2', '_Type_2', '_Dice_3', '_Dam_3', '_Type_3', '_Type_', '_End_Incu_Script', '_col_24_Hour_Script')
    _column_mapping = {'Label': 'Label', 'Name': 'Name', 'First_Save': 'First_Save', 'Subs_Save': 'Subs_Save', 'Incu_Hours': 'Incu_Hours', 'Dice_1': 'Dice_1', 'Dam_1': 'Dam_1', 'Type_1': 'Type_1', 'Dice_2': 'Dice_2', 'Dam_2': 'Dam_2', 'Type_2': 'Type_2', 'Dice_3': 'Dice_3', 'Dam_3': 'Dam_3', 'Type_3': 'Type_3', 'Type': 'Type_', 'End_Incu_Script': 'End_Incu_Script', '24_Hour_Script': 'col_24_Hour_Script'}
    _table_name = 'disease'
    _safe_columns = ['Label', 'Name', 'First_Save', 'Subs_Save', 'Incu_Hours', 'Dice_1', 'Dam_1', 'Type_1', 'Dice_2', 'Dam_2', 'Type_2', 'Dice_3', 'Dam_3', 'Type_3', 'Type_', 'End_Incu_Script', 'col_24_Hour_Script']
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<DiseaseData {pk_column}={pk_value!r}>>"
        else:
            return f"<DiseaseData>"
