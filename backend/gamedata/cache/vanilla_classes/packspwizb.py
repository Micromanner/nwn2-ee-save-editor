...
class PackspwizbData:
    """
    Auto-generated data class for packspwizb.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<PackspwizbData {pk_column}={pk_value!r}>>"
        else:
            return f"<PackspwizbData>"
