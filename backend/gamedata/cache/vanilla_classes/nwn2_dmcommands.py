...
class Nwn2_dmcommandsData:
    """
    Auto-generated data class for nwn2_dmcommands.2da
    
    This class provides efficient attribute access to 2DA row data
    with automatic column name mapping for mod compatibility.
    """
    __slots__ = ('_resource_manager', '_LABEL', '_NAME_REF', '_ICON_RESREF', '_CMD_ID', '_AUTOHOTBAR')
    _column_mapping = {'LABEL': 'LABEL', 'NAME_REF': 'NAME_REF', 'ICON_RESREF': 'ICON_RESREF', 'CMD_ID': 'CMD_ID', 'AUTOHOTBAR': 'AUTOHOTBAR'}
    _table_name = 'nwn2_dmcommands'
    _safe_columns = ['LABEL', 'NAME_REF', 'ICON_RESREF', 'CMD_ID', 'AUTOHOTBAR']
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Nwn2_dmcommandsData {pk_column}={pk_value!r}>>"
        else:
            return f"<Nwn2_dmcommandsData>"
