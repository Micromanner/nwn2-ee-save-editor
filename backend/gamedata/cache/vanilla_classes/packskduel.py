...
class PackskduelData:
    """
    Auto-generated data class for packskduel.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<PackskduelData {pk_column}={pk_value!r}>>"
        else:
            return f"<PackskduelData>"
