...
class Nwn2_deitiesData:
    """
    Auto-generated data class for nwn2_deities.2da
    
    This class provides efficient attribute access to 2DA row data
    with automatic column name mapping for mod compatibility.
    """
    __slots__ = ('_resource_manager', '_FirstName', '_LastName', '_Removed', '_NameStringref', '_DescID', '_IconID', '_AllRaces', '_SubraceID1', '_SubraceID2', '_SubraceID3', '_SubraceID4', '_SubraceID5', '_SubraceID6', '_SubraceID7', '_SubraceID8', '_SubraceID9', '_LG', '_NG', '_CG', '_LN', '_TN', '_CN', '_LE', '_NE', '_CE', '_Male', '_Female', '_Paladin', '_Cleric', '_Druid', '_Doomguide', '_Ranger', '_DomainID1', '_DomainID2', '_DomainID3', '_DomainID4', '_DomainID5', '_DomainID6', '_DomainID7', '_DomainID8', '_DomainID9', '_FavoredWeaponProficiency', '_FavoredWeaponFocus', '_FavoredWeaponSpecialization')
    _column_mapping = {'FirstName': 'FirstName', 'LastName': 'LastName', 'Removed': 'Removed', 'NameStringref': 'NameStringref', 'DescID': 'DescID', 'IconID': 'IconID', 'AllRaces': 'AllRaces', 'SubraceID1': 'SubraceID1', 'SubraceID2': 'SubraceID2', 'SubraceID3': 'SubraceID3', 'SubraceID4': 'SubraceID4', 'SubraceID5': 'SubraceID5', 'SubraceID6': 'SubraceID6', 'SubraceID7': 'SubraceID7', 'SubraceID8': 'SubraceID8', 'SubraceID9': 'SubraceID9', 'LG': 'LG', 'NG': 'NG', 'CG': 'CG', 'LN': 'LN', 'TN': 'TN', 'CN': 'CN', 'LE': 'LE', 'NE': 'NE', 'CE': 'CE', 'Male': 'Male', 'Female': 'Female', 'Paladin': 'Paladin', 'Cleric': 'Cleric', 'Druid': 'Druid', 'Doomguide': 'Doomguide', 'Ranger': 'Ranger', 'DomainID1': 'DomainID1', 'DomainID2': 'DomainID2', 'DomainID3': 'DomainID3', 'DomainID4': 'DomainID4', 'DomainID5': 'DomainID5', 'DomainID6': 'DomainID6', 'DomainID7': 'DomainID7', 'DomainID8': 'DomainID8', 'DomainID9': 'DomainID9', 'FavoredWeaponProficiency': 'FavoredWeaponProficiency', 'FavoredWeaponFocus': 'FavoredWeaponFocus', 'FavoredWeaponSpecialization': 'FavoredWeaponSpecialization'}
    _table_name = 'nwn2_deities'
    _safe_columns = ['FirstName', 'LastName', 'Removed', 'NameStringref', 'DescID', 'IconID', 'AllRaces', 'SubraceID1', 'SubraceID2', 'SubraceID3', 'SubraceID4', 'SubraceID5', 'SubraceID6', 'SubraceID7', 'SubraceID8', 'SubraceID9', 'LG', 'NG', 'CG', 'LN', 'TN', 'CN', 'LE', 'NE', 'CE', 'Male', 'Female', 'Paladin', 'Cleric', 'Druid', 'Doomguide', 'Ranger', 'DomainID1', 'DomainID2', 'DomainID3', 'DomainID4', 'DomainID5', 'DomainID6', 'DomainID7', 'DomainID8', 'DomainID9', 'FavoredWeaponProficiency', 'FavoredWeaponFocus', 'FavoredWeaponSpecialization']
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Nwn2_deitiesData {pk_column}={pk_value!r}>>"
        else:
            return f"<Nwn2_deitiesData>"
