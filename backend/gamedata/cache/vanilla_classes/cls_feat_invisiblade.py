...
class Cls_feat_invisibladeData:
    """
    Auto-generated data class for cls_feat_invisiblade.2da
    ...
    _table_name = 'cls_feat_invisiblade'
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Cls_feat_invisibladeData {pk_column}={pk_value!r}>>"
        else:
            return f"<Cls_feat_invisibladeData>"
