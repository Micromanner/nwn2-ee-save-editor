...
class PackftbevilData:
    """
    Auto-generated data class for packftbevil.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<PackftbevilData {pk_column}={pk_value!r}>>"
        else:
            return f"<PackftbevilData>"
