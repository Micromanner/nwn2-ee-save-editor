...
class PackftbishopData:
    """
    Auto-generated data class for packftbishop.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<PackftbishopData {pk_column}={pk_value!r}>>"
        else:
            return f"<PackftbishopData>"
