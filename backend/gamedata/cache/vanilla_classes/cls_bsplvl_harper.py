...
class Cls_bsplvl_harperData:
    """
    Auto-generated data class for cls_bsplvl_harper.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Cls_bsplvl_harperData {pk_column}={pk_value!r}>>"
        else:
            return f"<Cls_bsplvl_harperData>"
