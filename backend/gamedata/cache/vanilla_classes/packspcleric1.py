...
class Packspcleric1Data:
    """
    Auto-generated data class for packspcleric1.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Packspcleric1Data {pk_column}={pk_value!r}>>"
        else:
            return f"<Packspcleric1Data>"
