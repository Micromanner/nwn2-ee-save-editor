...
class Packftmonk2Data:
    """
    Auto-generated data class for packftmonk2.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Packftmonk2Data {pk_column}={pk_value!r}>>"
        else:
            return f"<Packftmonk2Data>"
