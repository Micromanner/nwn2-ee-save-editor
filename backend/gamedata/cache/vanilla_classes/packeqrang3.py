...
class Packeqrang3Data:
    """
    Auto-generated data class for packeqrang3.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Packeqrang3Data {pk_column}={pk_value!r}>>"
        else:
            return f"<Packeqrang3Data>"
