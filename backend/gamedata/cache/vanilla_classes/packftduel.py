...
class PackftduelData:
    """
    Auto-generated data class for packftduel.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<PackftduelData {pk_column}={pk_value!r}>>"
        else:
            return f"<PackftduelData>"
