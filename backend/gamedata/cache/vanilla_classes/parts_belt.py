...
class Parts_beltData:
    """
    Auto-generated data class for parts_belt.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Parts_beltData {pk_column}={pk_value!r}>>"
        else:
            return f"<Parts_beltData>"
