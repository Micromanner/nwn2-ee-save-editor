...
class Nwn2_behaviorparamsData:
    """
    Auto-generated data class for nwn2_behaviorparams.2da
    
    This class provides efficient attribute access to 2DA row data
    with automatic column name mapping for mod compatibility.
    """
    __slots__ = ('_resource_manager', '_LABEL_NameStrRef_DescStrRef', '_Selectable_Script', '_col_empty_2')
    _column_mapping = {'LABEL               NameStrRef DescStrRef': 'LABEL_NameStrRef_DescStrRef', 'Selectable    Script': 'Selectable_Script', '': 'col_empty_2'}
    _table_name = 'nwn2_behaviorparams'
    _safe_columns = ['LABEL_NameStrRef_DescStrRef', 'Selectable_Script', 'col_empty_2']
    ...
    def __repr__(self):
        ...
        pk_column = 'LABEL_NameStrRef_DescStrRef'
        if pk_column and hasattr(self, '_' + pk_column):
            pk_value = getattr(self, '_' + pk_column)
            return f"<Nwn2_behaviorparamsData {pk_column}={pk_value!r}>>"
        else:
            return f"<Nwn2_behaviorparamsData>"
