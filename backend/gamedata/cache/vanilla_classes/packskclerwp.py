...
class PackskclerwpData:
    """
    Auto-generated data class for packskclerwp.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<PackskclerwpData {pk_column}={pk_value!r}>>"
        else:
            return f"<PackskclerwpData>"
