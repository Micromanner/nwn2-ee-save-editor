...
class PackspqaraData:
    """
    Auto-generated data class for packspqara.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<PackspqaraData {pk_column}={pk_value!r}>>"
        else:
            return f"<PackspqaraData>"
