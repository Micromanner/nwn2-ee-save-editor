...
class Nwn2_aligniconsData:
    """
    Auto-generated data class for nwn2_alignicons.2da
    
    This class provides efficient attribute access to 2DA row data
    with automatic column name mapping for mod compatibility.
    """
    __slots__ = ('_resource_manager', '_Alignment', '_AlignmentIcon')
    _column_mapping = {'Alignment': 'Alignment', 'AlignmentIcon': 'AlignmentIcon'}
    _table_name = 'nwn2_alignicons'
    _safe_columns = ['Alignment', 'AlignmentIcon']
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Nwn2_aligniconsData {pk_column}={pk_value!r}>>"
        else:
            return f"<Nwn2_aligniconsData>"
