...
class Packeqmonk2Data:
    """
    Auto-generated data class for packeqmonk2.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Packeqmonk2Data {pk_column}={pk_value!r}>>"
        else:
            return f"<Packeqmonk2Data>"
