...
class Nwn2_bloodtypesData:
    """
    Auto-generated data class for nwn2_bloodtypes.2da
    
    This class provides efficient attribute access to 2DA row data
    with automatic column name mapping for mod compatibility.
    """
    __slots__ = ('_resource_manager', '_Label', '_col_empty_3', '_LowViolence0', '_CriticalHit0', '_StandardHit0', '_StandardHit1')
    _column_mapping = {'Label': 'Label', '': 'col_empty_3', 'LowViolence0': 'LowViolence0', 'CriticalHit0': 'CriticalHit0', 'StandardHit0': 'StandardHit0', 'StandardHit1': 'StandardHit1'}
    _table_name = 'nwn2_bloodtypes'
    _safe_columns = ['Label', 'col_empty_3', 'LowViolence0', 'CriticalHit0', 'StandardHit0', 'StandardHit1']
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Nwn2_bloodtypesData {pk_column}={pk_value!r}>>"
        else:
            return f"<Nwn2_bloodtypesData>"
