...
class PackspdoveData:
    """
    Auto-generated data class for packspdove.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<PackspdoveData {pk_column}={pk_value!r}>>"
        else:
            return f"<PackspdoveData>"
