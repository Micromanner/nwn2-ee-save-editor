...
class Itm_rand_frData:
    """
    Auto-generated data class for itm_rand_fr.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Itm_rand_frData {pk_column}={pk_value!r}>>"
        else:
            return f"<Itm_rand_frData>"
