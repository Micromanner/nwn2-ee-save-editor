...
class Color_woodelfData:
    """
    Auto-generated data class for color_woodelf.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Color_woodelfData {pk_column}={pk_value!r}>>"
        else:
            return f"<Color_woodelfData>"
