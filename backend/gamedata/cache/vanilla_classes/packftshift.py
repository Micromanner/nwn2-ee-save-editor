...
class PackftshiftData:
    """
    Auto-generated data class for packftshift.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<PackftshiftData {pk_column}={pk_value!r}>>"
        else:
            return f"<PackftshiftData>"
