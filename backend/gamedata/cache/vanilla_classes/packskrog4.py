...
class Packskrog4Data:
    """
    Auto-generated data class for packskrog4.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Packskrog4Data {pk_column}={pk_value!r}>>"
        else:
            return f"<Packskrog4Data>"
