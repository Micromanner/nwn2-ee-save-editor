...
class RacialsubtypesData:
    """
    Auto-generated data class for racialsubtypes.2da
    
    This class provides efficient attribute access to 2DA row data
    with automatic column name mapping for mod compatibility.
    """
    __slots__ = ('_resource_manager', '_Label', '_BaseRace', '_ECL', '_Abrev', '_Name', '_NamePlural', '_NameLower', '_NameLowerPlural', '_ConverName', '_ConverNameLower', '_Description', '_Appearance', '_StrAdjust', '_DexAdjust', '_IntAdjust', '_ChaAdjust', '_WisAdjust', '_ConAdjust', '_Endurance', '_Favored', '_HasFavoredClass', '_FeatsTable', '_Biography', '_PlayerRace', '_Constant', '_AGE', '_CRModifier', '_Color2DA', '_AppearanceIndex', '_female_race_icon', '_male_race_icon', '_racial_banner')
    _column_mapping = {'Label': 'Label', 'BaseRace': 'BaseRace', 'ECL': 'ECL', 'Abrev': 'Abrev', 'Name': 'Name', 'NamePlural': 'NamePlural', 'NameLower': 'NameLower', 'NameLowerPlural': 'NameLowerPlural', 'ConverName': 'ConverName', 'ConverNameLower': 'ConverNameLower', 'Description': 'Description', 'Appearance': 'Appearance', 'StrAdjust': 'StrAdjust', 'DexAdjust': 'DexAdjust', 'IntAdjust': 'IntAdjust', 'ChaAdjust': 'ChaAdjust', 'WisAdjust': 'WisAdjust', 'ConAdjust': 'ConAdjust', 'Endurance': 'Endurance', 'Favored': 'Favored', 'HasFavoredClass': 'HasFavoredClass', 'FeatsTable': 'FeatsTable', 'Biography': 'Biography', 'PlayerRace': 'PlayerRace', 'Constant': 'Constant', 'AGE': 'AGE', 'CRModifier': 'CRModifier', 'Color2DA': 'Color2DA', 'AppearanceIndex': 'AppearanceIndex', 'female_race_icon': 'female_race_icon', 'male_race_icon': 'male_race_icon', 'racial_banner': 'racial_banner'}
    _table_name = 'racialsubtypes'
    _safe_columns = ['Label', 'BaseRace', 'ECL', 'Abrev', 'Name', 'NamePlural', 'NameLower', 'NameLowerPlural', 'ConverName', 'ConverNameLower', 'Description', 'Appearance', 'StrAdjust', 'DexAdjust', 'IntAdjust', 'ChaAdjust', 'WisAdjust', 'ConAdjust', 'Endurance', 'Favored', 'HasFavoredClass', 'FeatsTable', 'Biography', 'PlayerRace', 'Constant', 'AGE', 'CRModifier', 'Color2DA', 'AppearanceIndex', 'female_race_icon', 'male_race_icon', 'racial_banner']
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<RacialsubtypesData {pk_column}={pk_value!r}>>"
        else:
            return f"<RacialsubtypesData>"
