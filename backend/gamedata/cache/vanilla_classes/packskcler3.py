...
class Packskcler3Data:
    """
    Auto-generated data class for packskcler3.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Packskcler3Data {pk_column}={pk_value!r}>>"
        else:
            return f"<Packskcler3Data>"
