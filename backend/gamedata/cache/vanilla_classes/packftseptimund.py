...
class PackftseptimundData:
    """
    Auto-generated data class for packftseptimund.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<PackftseptimundData {pk_column}={pk_value!r}>>"
        else:
            return f"<PackftseptimundData>"
