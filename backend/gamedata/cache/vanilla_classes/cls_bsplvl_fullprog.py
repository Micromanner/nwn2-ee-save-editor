...
class Cls_bsplvl_fullprogData:
    """
    Auto-generated data class for cls_bsplvl_fullprog.2da
    ...
    _table_name = 'cls_bsplvl_fullprog'
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Cls_bsplvl_fullprogData {pk_column}={pk_value!r}>>"
        else:
            return f"<Cls_bsplvl_fullprogData>"
