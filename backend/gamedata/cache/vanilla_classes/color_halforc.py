...
class Color_halforcData:
    """
    Auto-generated data class for color_halforc.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Color_halforcData {pk_column}={pk_value!r}>>"
        else:
            return f"<Color_halforcData>"
