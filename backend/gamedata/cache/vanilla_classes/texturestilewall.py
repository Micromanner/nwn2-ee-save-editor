...
class TexturestilewallData:
    """
    Auto-generated data class for texturestilewall.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<TexturestilewallData {pk_column}={pk_value!r}>>"
        else:
            return f"<TexturestilewallData>"
