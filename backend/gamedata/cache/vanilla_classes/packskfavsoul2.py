...
class Packskfavsoul2Data:
    """
    Auto-generated data class for packskfavsoul2.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Packskfavsoul2Data {pk_column}={pk_value!r}>>"
        else:
            return f"<Packskfavsoul2Data>"
