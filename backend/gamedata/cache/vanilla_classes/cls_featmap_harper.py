...
class Cls_featmap_harperData:
    """
    Auto-generated data class for cls_featmap_harper.2da
    ...
    _table_name = 'cls_featmap_harper'
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Cls_featmap_harperData {pk_column}={pk_value!r}>>"
        else:
            return f"<Cls_featmap_harperData>"
