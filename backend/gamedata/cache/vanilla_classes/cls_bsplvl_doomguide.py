...
class Cls_bsplvl_doomguideData:
    """
    Auto-generated data class for cls_bsplvl_doomguide.2da
    ...
    _table_name = 'cls_bsplvl_doomguide'
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Cls_bsplvl_doomguideData {pk_column}={pk_value!r}>>"
        else:
            return f"<Cls_bsplvl_doomguideData>"
