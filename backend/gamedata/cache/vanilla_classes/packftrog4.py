...
class Packftrog4Data:
    """
    Auto-generated data class for packftrog4.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Packftrog4Data {pk_column}={pk_value!r}>>"
        else:
            return f"<Packftrog4Data>"
