...
class Race_feat_githData:
    """
    Auto-generated data class for race_feat_gith.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Race_feat_githData {pk_column}={pk_value!r}>>"
        else:
            return f"<Race_feat_githData>"
