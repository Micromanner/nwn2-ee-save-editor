...
class PackftsandData:
    """
    Auto-generated data class for packftsand.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<PackftsandData {pk_column}={pk_value!r}>>"
        else:
            return f"<PackftsandData>"
