...
class Cls_skill_nw9wdData:
    """
    Auto-generated data class for cls_skill_nw9wd.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Cls_skill_nw9wdData {pk_column}={pk_value!r}>>"
        else:
            return f"<Cls_skill_nw9wdData>"
