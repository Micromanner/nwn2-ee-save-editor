...
class RestdurationData:
    """
    Auto-generated data class for restduration.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<RestdurationData {pk_column}={pk_value!r}>>"
        else:
            return f"<RestdurationData>"
