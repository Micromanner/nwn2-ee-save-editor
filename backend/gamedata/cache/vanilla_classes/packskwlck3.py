...
class Packskwlck3Data:
    """
    Auto-generated data class for packskwlck3.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Packskwlck3Data {pk_column}={pk_value!r}>>"
        else:
            return f"<Packskwlck3Data>"
