...
class WeaponsoundsData:
    """
    Auto-generated data class for weaponsounds.2da
    
    This class provides efficient attribute access to 2DA row data
    with automatic column name mapping for mod compatibility.
    """
    __slots__ = ('_resource_manager', '_Label', '_Leather0', '_Leather1', '_Chain0', '_Chain1', '_Plate0', '_Plate1', '_Stone0', '_Stone1', '_Wood0', '_Wood1', '_Chitin0', '_Chitin1', '_Scale0', '_Scale1', '_Ethereal0', '_Ethereal1', '_Miss0', '_Miss1', '_Parry0', '_Critical0')
    _column_mapping = {'Label': 'Label', 'Leather0': 'Leather0', 'Leather1': 'Leather1', 'Chain0': 'Chain0', 'Chain1': 'Chain1', 'Plate0': 'Plate0', 'Plate1': 'Plate1', 'Stone0': 'Stone0', 'Stone1': 'Stone1', 'Wood0': 'Wood0', 'Wood1': 'Wood1', 'Chitin0': 'Chitin0', 'Chitin1': 'Chitin1', 'Scale0': 'Scale0', 'Scale1': 'Scale1', 'Ethereal0': 'Ethereal0', 'Ethereal1': 'Ethereal1', 'Miss0': 'Miss0', 'Miss1': 'Miss1', 'Parry0': 'Parry0', 'Critical0': 'Critical0'}
    _table_name = 'weaponsounds'
    _safe_columns = ['Label', 'Leather0', 'Leather1', 'Chain0', 'Chain1', 'Plate0', 'Plate1', 'Stone0', 'Stone1', 'Wood0', 'Wood1', 'Chitin0', 'Chitin1', 'Scale0', 'Scale1', 'Ethereal0', 'Ethereal1', 'Miss0', 'Miss1', 'Parry0', 'Critical0']
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<WeaponsoundsData {pk_column}={pk_value!r}>>"
        else:
            return f"<WeaponsoundsData>"
