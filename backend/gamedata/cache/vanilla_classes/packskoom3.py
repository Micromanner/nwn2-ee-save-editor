...
class Packskoom3Data:
    """
    Auto-generated data class for packskoom3.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Packskoom3Data {pk_column}={pk_value!r}>>"
        else:
            return f"<Packskoom3Data>"
