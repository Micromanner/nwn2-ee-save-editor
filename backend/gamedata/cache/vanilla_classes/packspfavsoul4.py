...
class Packspfavsoul4Data:
    """
    Auto-generated data class for packspfavsoul4.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Packspfavsoul4Data {pk_column}={pk_value!r}>>"
        else:
            return f"<Packspfavsoul4Data>"
