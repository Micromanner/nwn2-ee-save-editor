...
class Tts01_edgeData:
    """
    Auto-generated data class for tts01_edge.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Tts01_edgeData {pk_column}={pk_value!r}>>"
        else:
            return f"<Tts01_edgeData>"
