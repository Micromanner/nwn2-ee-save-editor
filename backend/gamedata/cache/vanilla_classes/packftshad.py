...
class PackftshadData:
    """
    Auto-generated data class for packftshad.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<PackftshadData {pk_column}={pk_value!r}>>"
        else:
            return f"<PackftshadData>"
