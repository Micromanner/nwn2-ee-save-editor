...
class Cls_skill_swashbucklerData:
    """
    Auto-generated data class for cls_skill_swashbuckler.2da
    ...
    _table_name = 'cls_skill_swashbuckler'
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Cls_skill_swashbucklerData {pk_column}={pk_value!r}>>"
        else:
            return f"<Cls_skill_swashbucklerData>"
