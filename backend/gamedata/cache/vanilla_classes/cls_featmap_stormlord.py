...
class Cls_featmap_stormlordData:
    """
    Auto-generated data class for cls_featmap_stormlord.2da
    ...
    _table_name = 'cls_featmap_stormlord'
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Cls_featmap_stormlordData {pk_column}={pk_value!r}>>"
        else:
            return f"<Cls_featmap_stormlordData>"
