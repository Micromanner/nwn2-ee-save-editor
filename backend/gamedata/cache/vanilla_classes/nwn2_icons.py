...
class Nwn2_iconsData:
    """
    Auto-generated data class for nwn2_icons.2da
    
    This class provides efficient attribute access to 2DA row data
    with automatic column name mapping for mod compatibility.
    """
    __slots__ = ('_resource_manager', '_ICON')
    _column_mapping = {'ICON': 'ICON'}
    _table_name = 'nwn2_icons'
    _safe_columns = ['ICON']
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Nwn2_iconsData {pk_column}={pk_value!r}>>"
        else:
            return f"<Nwn2_iconsData>"
