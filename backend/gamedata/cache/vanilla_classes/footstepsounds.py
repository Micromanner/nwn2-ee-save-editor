...
class FootstepsoundsData:
    """
    Auto-generated data class for footstepsounds.2da
    
    This class provides efficient attribute access to 2DA row data
    with automatic column name mapping for mod compatibility.
    """
    __slots__ = ('_resource_manager', '_Label', '_Dirt0', '_Dirt1', '_Dirt2', '_Grass0', '_Grass1', '_Grass2', '_Stone0', '_Stone1', '_Stone2', '_Wood0', '_Wood1', '_Wood2', '_Water0', '_Water1', '_Water2', '_Carpet0', '_Carpet1', '_Carpet2', '_Metal0', '_Metal1', '_Metal2', '_Puddles0', '_Puddles1', '_Puddles2', '_Leaves0', '_Leaves1', '_Leaves2', '_Sand0', '_Sand1', '_Sand2', '_Snow0', '_Snow1', '_Snow2')
    _column_mapping = {'Label': 'Label', 'Dirt0': 'Dirt0', 'Dirt1': 'Dirt1', 'Dirt2': 'Dirt2', 'Grass0': 'Grass0', 'Grass1': 'Grass1', 'Grass2': 'Grass2', 'Stone0': 'Stone0', 'Stone1': 'Stone1', 'Stone2': 'Stone2', 'Wood0': 'Wood0', 'Wood1': 'Wood1', 'Wood2': 'Wood2', 'Water0': 'Water0', 'Water1': 'Water1', 'Water2': 'Water2', 'Carpet0': 'Carpet0', 'Carpet1': 'Carpet1', 'Carpet2': 'Carpet2', 'Metal0': 'Metal0', 'Metal1': 'Metal1', 'Metal2': 'Metal2', 'Puddles0': 'Puddles0', 'Puddles1': 'Puddles1', 'Puddles2': 'Puddles2', 'Leaves0': 'Leaves0', 'Leaves1': 'Leaves1', 'Leaves2': 'Leaves2', 'Sand0': 'Sand0', 'Sand1': 'Sand1', 'Sand2': 'Sand2', 'Snow0': 'Snow0', 'Snow1': 'Snow1', 'Snow2': 'Snow2'}
    _table_name = 'footstepsounds'
    _safe_columns = ['Label', 'Dirt0', 'Dirt1', 'Dirt2', 'Grass0', 'Grass1', 'Grass2', 'Stone0', 'Stone1', 'Stone2', 'Wood0', 'Wood1', 'Wood2', 'Water0', 'Water1', 'Water2', 'Carpet0', 'Carpet1', 'Carpet2', 'Metal0', 'Metal1', 'Metal2', 'Puddles0', 'Puddles1', 'Puddles2', 'Leaves0', 'Leaves1', 'Leaves2', 'Sand0', 'Sand1', 'Sand2', 'Snow0', 'Snow1', 'Snow2']
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<FootstepsoundsData {pk_column}={pk_value!r}>>"
        else:
            return f"<FootstepsoundsData>"
