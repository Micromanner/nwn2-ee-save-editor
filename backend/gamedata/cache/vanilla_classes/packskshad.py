...
class PackskshadData:
    """
    Auto-generated data class for packskshad.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<PackskshadData {pk_column}={pk_value!r}>>"
        else:
            return f"<PackskshadData>"
