...
class PackskpalahData:
    """
    Auto-generated data class for packskpalah.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<PackskpalahData {pk_column}={pk_value!r}>>"
        else:
            return f"<PackskpalahData>"
