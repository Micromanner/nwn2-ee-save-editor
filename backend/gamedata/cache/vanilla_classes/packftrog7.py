...
class Packftrog7Data:
    """
    Auto-generated data class for packftrog7.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Packftrog7Data {pk_column}={pk_value!r}>>"
        else:
            return f"<Packftrog7Data>"
