...
class ItempropsData:
    """
    Auto-generated data class for itemprops.2da
    
    This class provides efficient attribute access to 2DA row data
    with automatic column name mapping for mod compatibility.
    """
    __slots__ = ('_resource_manager', '_col_0_Melee', '_col_1_Ranged', '_col_2_Thrown', '_col_3_Staves', '_col_4_Rods', '_col_5_Ammo', '_col_6_Arm_Shld', '_col_7_Helm', '_col_8_Potions', '_col_9_Scrolls', '_col_10_Wands', '_col_11_Thieves', '_col_12_TrapKits', '_col_13_Hide', '_col_14_Claw', '_col_15_Misc_Uneq', '_col_16_Misc', '_col_17_No_Props', '_col_18_Containers', '_col_19_HealerKit', '_col_20_Torch', '_col_21_Glove', '_StringRef', '_Label')
    _column_mapping = {'0_Melee': 'col_0_Melee', '1_Ranged': 'col_1_Ranged', '2_Thrown': 'col_2_Thrown', '3_Staves': 'col_3_Staves', '4_Rods': 'col_4_Rods', '5_Ammo': 'col_5_Ammo', '6_Arm_Shld': 'col_6_Arm_Shld', '7_Helm': 'col_7_Helm', '8_Potions': 'col_8_Potions', '9_Scrolls': 'col_9_Scrolls', '10_Wands': 'col_10_Wands', '11_Thieves': 'col_11_Thieves', '12_TrapKits': 'col_12_TrapKits', '13_Hide': 'col_13_Hide', '14_Claw': 'col_14_Claw', '15_Misc_Uneq': 'col_15_Misc_Uneq', '16_Misc': 'col_16_Misc', '17_No_Props': 'col_17_No_Props', '18_Containers': 'col_18_Containers', '19_HealerKit': 'col_19_HealerKit', '20_Torch': 'col_20_Torch', '21_Glove': 'col_21_Glove', 'StringRef': 'StringRef', 'Label': 'Label'}
    _table_name = 'itemprops'
    _safe_columns = ['col_0_Melee', 'col_1_Ranged', 'col_2_Thrown', 'col_3_Staves', 'col_4_Rods', 'col_5_Ammo', 'col_6_Arm_Shld', 'col_7_Helm', 'col_8_Potions', 'col_9_Scrolls', 'col_10_Wands', 'col_11_Thieves', 'col_12_TrapKits', 'col_13_Hide', 'col_14_Claw', 'col_15_Misc_Uneq', 'col_16_Misc', 'col_17_No_Props', 'col_18_Containers', 'col_19_HealerKit', 'col_20_Torch', 'col_21_Glove', 'StringRef', 'Label']
    ...
    def __repr__(self):
        ...
        pk_column = 'col_0_Melee'
        if pk_column and hasattr(self, '_' + pk_column):
            pk_value = getattr(self, '_' + pk_column)
            return f"<ItempropsData {pk_column}={pk_value!r}>>"
        else:
            return f"<ItempropsData>"
