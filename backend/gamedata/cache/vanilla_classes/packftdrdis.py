...
class PackftdrdisData:
    """
    Auto-generated data class for packftdrdis.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<PackftdrdisData {pk_column}={pk_value!r}>>"
        else:
            return f"<PackftdrdisData>"
