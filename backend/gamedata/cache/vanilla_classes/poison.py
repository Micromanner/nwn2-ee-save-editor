...
class PoisonData:
    """
    Auto-generated data class for poison.2da
    
    This class provides efficient attribute access to 2DA row data
    with automatic column name mapping for mod compatibility.
    """
    __slots__ = ('_resource_manager', '_Label', '_Name', '_Save_DC', '_Handle_DC', '_Dice_1', '_Dam_1', '_Default_1', '_Script_1', '_Dice_2', '_Dam_2', '_Default_2', '_Script_2', '_Cost', '_OnHitApplied', '_VFX_Impact')
    _column_mapping = {'Label': 'Label', 'Name': 'Name', 'Save_DC': 'Save_DC', 'Handle_DC': 'Handle_DC', 'Dice_1': 'Dice_1', 'Dam_1': 'Dam_1', 'Default_1': 'Default_1', 'Script_1': 'Script_1', 'Dice_2': 'Dice_2', 'Dam_2': 'Dam_2', 'Default_2': 'Default_2', 'Script_2': 'Script_2', 'Cost': 'Cost', 'OnHitApplied': 'OnHitApplied', 'VFX_Impact': 'VFX_Impact'}
    _table_name = 'poison'
    _safe_columns = ['Label', 'Name', 'Save_DC', 'Handle_DC', 'Dice_1', 'Dam_1', 'Default_1', 'Script_1', 'Dice_2', 'Dam_2', 'Default_2', 'Script_2', 'Cost', 'OnHitApplied', 'VFX_Impact']
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<PoisonData {pk_column}={pk_value!r}>>"
        else:
            return f"<PoisonData>"
