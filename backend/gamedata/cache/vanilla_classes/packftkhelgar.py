...
class PackftkhelgarData:
    """
    Auto-generated data class for packftkhelgar.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<PackftkhelgarData {pk_column}={pk_value!r}>>"
        else:
            return f"<PackftkhelgarData>"
