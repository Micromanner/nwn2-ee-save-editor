...
class PackskquarrelData:
    """
    Auto-generated data class for packskquarrel.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<PackskquarrelData {pk_column}={pk_value!r}>>"
        else:
            return f"<PackskquarrelData>"
