...
class PackagesData:
    """
    Auto-generated data class for packages.2da
    
    This class provides efficient attribute access to 2DA row data
    with automatic column name mapping for mod compatibility.
    """
    __slots__ = ('_resource_manager', '_Label', '_Name', '_Description', '_ClassID', '_Attribute', '_Gold', '_School', '_Domain1', '_Domain2', '_Associate', '_SpellPref2DA', '_FeatPref2DA', '_SkillPref2DA', '_Equip2DA', '_Soundset', '_PlayerClass')
    _column_mapping = {'Label': 'Label', 'Name': 'Name', 'Description': 'Description', 'ClassID': 'ClassID', 'Attribute': 'Attribute', 'Gold': 'Gold', 'School': 'School', 'Domain1': 'Domain1', 'Domain2': 'Domain2', 'Associate': 'Associate', 'SpellPref2DA': 'SpellPref2DA', 'FeatPref2DA': 'FeatPref2DA', 'SkillPref2DA': 'SkillPref2DA', 'Equip2DA': 'Equip2DA', 'Soundset': 'Soundset', 'PlayerClass': 'PlayerClass'}
    _table_name = 'packages'
    _safe_columns = ['Label', 'Name', 'Description', 'ClassID', 'Attribute', 'Gold', 'School', 'Domain1', 'Domain2', 'Associate', 'SpellPref2DA', 'FeatPref2DA', 'SkillPref2DA', 'Equip2DA', 'Soundset', 'PlayerClass']
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<PackagesData {pk_column}={pk_value!r}>>"
        else:
            return f"<PackagesData>"
