...
class PackftharpData:
    """
    Auto-generated data class for packftharp.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<PackftharpData {pk_column}={pk_value!r}>>"
        else:
            return f"<PackftharpData>"
