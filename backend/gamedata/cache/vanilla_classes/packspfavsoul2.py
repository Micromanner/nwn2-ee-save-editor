...
class Packspfavsoul2Data:
    """
    Auto-generated data class for packspfavsoul2.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Packspfavsoul2Data {pk_column}={pk_value!r}>>"
        else:
            return f"<Packspfavsoul2Data>"
