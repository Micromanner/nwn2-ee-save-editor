...
class Cls_bfeat_spiritshamanData:
    """
    Auto-generated data class for cls_bfeat_spiritshaman.2da
    ...
    _table_name = 'cls_bfeat_spiritshaman'
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Cls_bfeat_spiritshamanData {pk_column}={pk_value!r}>>"
        else:
            return f"<Cls_bfeat_spiritshamanData>"
