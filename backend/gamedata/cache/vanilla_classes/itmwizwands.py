...
class ItmwizwandsData:
    """
    Auto-generated data class for itmwizwands.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<ItmwizwandsData {pk_column}={pk_value!r}>>"
        else:
            return f"<ItmwizwandsData>"
