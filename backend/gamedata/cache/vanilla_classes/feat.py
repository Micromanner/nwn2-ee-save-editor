...
class FeatData:
    """
    Auto-generated data class for feat.2da
    
    This class provides efficient attribute access to 2DA row data
    with automatic column name mapping for mod compatibility.
    """
    __slots__ = ('_resource_manager', '_LABEL', '_FEAT', '_DESCRIPTION', '_ICON', '_MINATTACKBONUS', '_MINSTR', '_MINDEX', '_MININT', '_MINWIS', '_MINCON', '_MINCHA', '_MAXSTR', '_MAXDEX', '_MAXINT', '_MAXWIS', '_MAXCON', '_MAXCHA', '_MINSPELLLVL', '_MINCASTERLVL', '_PREREQFEAT1', '_PREREQFEAT2', '_GAINMULTIPLE', '_EFFECTSSTACK', '_ALLCLASSESCANUSE', '_CATEGORY', '_MAXCR', '_SPELLID', '_SUCCESSOR', '_CRValue', '_USESPERDAY', '_USESMAPFEAT', '_MASTERFEAT', '_TARGETSELF', '_OrReqFeat0', '_OrReqFeat1', '_OrReqFeat2', '_OrReqFeat3', '_OrReqFeat4', '_OrReqFeat5', '_REQSKILL', '_ReqSkillMaxRanks', '_ReqSkillMinRanks', '_REQSKILL2', '_ReqSkillMaxRanks2', '_ReqSkillMinRanks2', '_Constant', '_TOOLSCATEGORIES', '_HostileFeat', '_MinLevel', '_MinLevelClass', '_MaxLevel', '_MinFortSave', '_PreReqEpic', '_FeatCategory', '_IsActive', '_IsPersistent', '_ToggleMode', '_Cooldown', '_DMFeat', '_REMOVED', '_AlignRestrict', '_ImmunityType', '_Instant')
    _column_mapping = {'LABEL': 'LABEL', 'FEAT': 'FEAT', 'DESCRIPTION': 'DESCRIPTION', 'ICON': 'ICON', 'MINATTACKBONUS': 'MINATTACKBONUS', 'MINSTR': 'MINSTR', 'MINDEX': 'MINDEX', 'MININT': 'MININT', 'MINWIS': 'MINWIS', 'MINCON': 'MINCON', 'MINCHA': 'MINCHA', 'MAXSTR': 'MAXSTR', 'MAXDEX': 'MAXDEX', 'MAXINT': 'MAXINT', 'MAXWIS': 'MAXWIS', 'MAXCON': 'MAXCON', 'MAXCHA': 'MAXCHA', 'MINSPELLLVL': 'MINSPELLLVL', 'MINCASTERLVL': 'MINCASTERLVL', 'PREREQFEAT1': 'PREREQFEAT1', 'PREREQFEAT2': 'PREREQFEAT2', 'GAINMULTIPLE': 'GAINMULTIPLE', 'EFFECTSSTACK': 'EFFECTSSTACK', 'ALLCLASSESCANUSE': 'ALLCLASSESCANUSE', 'CATEGORY': 'CATEGORY', 'MAXCR': 'MAXCR', 'SPELLID': 'SPELLID', 'SUCCESSOR': 'SUCCESSOR', 'CRValue': 'CRValue', 'USESPERDAY': 'USESPERDAY', 'USESMAPFEAT': 'USESMAPFEAT', 'MASTERFEAT': 'MASTERFEAT', 'TARGETSELF': 'TARGETSELF', 'OrReqFeat0': 'OrReqFeat0', 'OrReqFeat1': 'OrReqFeat1', 'OrReqFeat2': 'OrReqFeat2', 'OrReqFeat3': 'OrReqFeat3', 'OrReqFeat4': 'OrReqFeat4', 'OrReqFeat5': 'OrReqFeat5', 'REQSKILL': 'REQSKILL', 'ReqSkillMaxRanks': 'ReqSkillMaxRanks', 'ReqSkillMinRanks': 'ReqSkillMinRanks', 'REQSKILL2': 'REQSKILL2', 'ReqSkillMaxRanks2': 'ReqSkillMaxRanks2', 'ReqSkillMinRanks2': 'ReqSkillMinRanks2', 'Constant': 'Constant', 'TOOLSCATEGORIES': 'TOOLSCATEGORIES', 'HostileFeat': 'HostileFeat', 'MinLevel': 'MinLevel', 'MinLevelClass': 'MinLevelClass', 'MaxLevel': 'MaxLevel', 'MinFortSave': 'MinFortSave', 'PreReqEpic': 'PreReqEpic', 'FeatCategory': 'FeatCategory', 'IsActive': 'IsActive', 'IsPersistent': 'IsPersistent', 'ToggleMode': 'ToggleMode', 'Cooldown': 'Cooldown', 'DMFeat': 'DMFeat', 'REMOVED': 'REMOVED', 'AlignRestrict': 'AlignRestrict', 'ImmunityType': 'ImmunityType', 'Instant': 'Instant'}
    _table_name = 'feat'
    _safe_columns = ['LABEL', 'FEAT', 'DESCRIPTION', 'ICON', 'MINATTACKBONUS', 'MINSTR', 'MINDEX', 'MININT', 'MINWIS', 'MINCON', 'MINCHA', 'MAXSTR', 'MAXDEX', 'MAXINT', 'MAXWIS', 'MAXCON', 'MAXCHA', 'MINSPELLLVL', 'MINCASTERLVL', 'PREREQFEAT1', 'PREREQFEAT2', 'GAINMULTIPLE', 'EFFECTSSTACK', 'ALLCLASSESCANUSE', 'CATEGORY', 'MAXCR', 'SPELLID', 'SUCCESSOR', 'CRValue', 'USESPERDAY', 'USESMAPFEAT', 'MASTERFEAT', 'TARGETSELF', 'OrReqFeat0', 'OrReqFeat1', 'OrReqFeat2', 'OrReqFeat3', 'OrReqFeat4', 'OrReqFeat5', 'REQSKILL', 'ReqSkillMaxRanks', 'ReqSkillMinRanks', 'REQSKILL2', 'ReqSkillMaxRanks2', 'ReqSkillMinRanks2', 'Constant', 'TOOLSCATEGORIES', 'HostileFeat', 'MinLevel', 'MinLevelClass', 'MaxLevel', 'MinFortSave', 'PreReqEpic', 'FeatCategory', 'IsActive', 'IsPersistent', 'ToggleMode', 'Cooldown', 'DMFeat', 'REMOVED', 'AlignRestrict', 'ImmunityType', 'Instant']
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<FeatData {pk_column}={pk_value!r}>>"
        else:
            return f"<FeatData>"
