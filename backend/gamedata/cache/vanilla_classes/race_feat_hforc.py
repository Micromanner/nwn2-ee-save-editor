...
class Race_feat_hforcData:
    """
    Auto-generated data class for race_feat_hforc.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Race_feat_hforcData {pk_column}={pk_value!r}>>"
        else:
            return f"<Race_feat_hforcData>"
