...
class Iprp_materialsData:
    """
    Auto-generated data class for iprp_materials.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Iprp_materialsData {pk_column}={pk_value!r}>>"
        else:
            return f"<Iprp_materialsData>"
