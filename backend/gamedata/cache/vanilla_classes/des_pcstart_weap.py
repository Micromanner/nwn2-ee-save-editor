...
class Des_pcstart_weapData:
    """
    Auto-generated data class for des_pcstart_weap.2da
    
    This class provides efficient attribute access to 2DA row data
    with automatic column name mapping for mod compatibility.
    """
    __slots__ = ('_resource_manager', '_Comment', '_cls_0', '_cls_1', '_cls_2', '_cls_3', '_cls_4', '_cls_5', '_cls_6', '_cls_7', '_cls_8', '_cls_9', '_cls_10')
    _column_mapping = {'Comment': 'Comment', 'cls_0': 'cls_0', 'cls_1': 'cls_1', 'cls_2': 'cls_2', 'cls_3': 'cls_3', 'cls_4': 'cls_4', 'cls_5': 'cls_5', 'cls_6': 'cls_6', 'cls_7': 'cls_7', 'cls_8': 'cls_8', 'cls_9': 'cls_9', 'cls_10': 'cls_10'}
    _table_name = 'des_pcstart_weap'
    _safe_columns = ['Comment', 'cls_0', 'cls_1', 'cls_2', 'cls_3', 'cls_4', 'cls_5', 'cls_6', 'cls_7', 'cls_8', 'cls_9', 'cls_10']
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Des_pcstart_weapData {pk_column}={pk_value!r}>>"
        else:
            return f"<Des_pcstart_weapData>"
