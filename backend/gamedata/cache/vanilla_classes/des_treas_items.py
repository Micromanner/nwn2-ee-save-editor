...
class Des_treas_itemsData:
    """
    Auto-generated data class for des_treas_items.2da
    
    This class provides efficient attribute access to 2DA row data
    with automatic column name mapping for mod compatibility.
    """
    __slots__ = ('_resource_manager', '_greatsword', '_shortsword', '_longsword', '_battleaxe', '_smallshield', '_club', '_dagger', '_dart', '_heavycrossbow', '_lightcrossbow', '_lightmace', '_morningstar', '_quarterstaff', '_spear', '_sickle', '_sling', '_gloves', '_longbow', '_shortbow', '_handaxe', '_rapier', '_scimitar', '_throwaxe', '_greataxe', '_halberd', '_lighthammer', '_lightflail', '_warhammer', '_heavyflail', '_kama', '_kukri', '_shuriken', '_scythe', '_katana', '_bastardsword', '_diremace', '_direaxe', '_twobladesw', '_dwarvenwaraxe', '_class_rogue', '_class_druid', '_class_monk', '_class_wizard', '_class_cleric', '_class_paladin', '_class_sdancer', '_class_harper', '_class_bard', '_class_fighter', '_class_pmaster', '_class_assassin', '_class_archer', '_class_wm', '_class_bguard', '_class_dwdef', '_class_divcha', '_class_barbarian', '_class_any', '_whip')
    _column_mapping = {'greatsword': 'greatsword', 'shortsword': 'shortsword', 'longsword': 'longsword', 'battleaxe': 'battleaxe', 'smallshield': 'smallshield', 'club': 'club', 'dagger': 'dagger', 'dart': 'dart', 'heavycrossbow': 'heavycrossbow', 'lightcrossbow': 'lightcrossbow', 'lightmace': 'lightmace', 'morningstar': 'morningstar', 'quarterstaff': 'quarterstaff', 'spear': 'spear', 'sickle': 'sickle', 'sling': 'sling', 'gloves': 'gloves', 'longbow': 'longbow', 'shortbow': 'shortbow', 'handaxe': 'handaxe', 'rapier': 'rapier', 'scimitar': 'scimitar', 'throwaxe': 'throwaxe', 'greataxe': 'greataxe', 'halberd': 'halberd', 'lighthammer': 'lighthammer', 'lightflail': 'lightflail', 'warhammer': 'warhammer', 'heavyflail': 'heavyflail', 'kama': 'kama', 'kukri': 'kukri', 'shuriken': 'shuriken', 'scythe': 'scythe', 'katana': 'katana', 'bastardsword': 'bastardsword', 'diremace': 'diremace', 'direaxe': 'direaxe', 'twobladesw': 'twobladesw', 'dwarvenwaraxe': 'dwarvenwaraxe', 'class_rogue': 'class_rogue', 'class_druid': 'class_druid', 'class_monk': 'class_monk', 'class_wizard': 'class_wizard', 'class_cleric': 'class_cleric', 'class_paladin': 'class_paladin', 'class_sdancer': 'class_sdancer', 'class_harper': 'class_harper', 'class_bard': 'class_bard', 'class_fighter': 'class_fighter', 'class_pmaster': 'class_pmaster', 'class_assassin': 'class_assassin', 'class_archer': 'class_archer', 'class_wm': 'class_wm', 'class_bguard': 'class_bguard', 'class_dwdef': 'class_dwdef', 'class_divcha': 'class_divcha', 'class_barbarian': 'class_barbarian', 'class_any': 'class_any', 'whip': 'whip'}
    _table_name = 'des_treas_items'
    _safe_columns = ['greatsword', 'shortsword', 'longsword', 'battleaxe', 'smallshield', 'club', 'dagger', 'dart', 'heavycrossbow', 'lightcrossbow', 'lightmace', 'morningstar', 'quarterstaff', 'spear', 'sickle', 'sling', 'gloves', 'longbow', 'shortbow', 'handaxe', 'rapier', 'scimitar', 'throwaxe', 'greataxe', 'halberd', 'lighthammer', 'lightflail', 'warhammer', 'heavyflail', 'kama', 'kukri', 'shuriken', 'scythe', 'katana', 'bastardsword', 'diremace', 'direaxe', 'twobladesw', 'dwarvenwaraxe', 'class_rogue', 'class_druid', 'class_monk', 'class_wizard', 'class_cleric', 'class_paladin', 'class_sdancer', 'class_harper', 'class_bard', 'class_fighter', 'class_pmaster', 'class_assassin', 'class_archer', 'class_wm', 'class_bguard', 'class_dwdef', 'class_divcha', 'class_barbarian', 'class_any', 'whip']
    ...
    def __repr__(self):
        ...
        pk_column = 'greatsword'
        if pk_column and hasattr(self, '_' + pk_column):
            pk_value = getattr(self, '_' + pk_column)
            return f"<Des_treas_itemsData {pk_column}={pk_value!r}>>"
        else:
            return f"<Des_treas_itemsData>"
