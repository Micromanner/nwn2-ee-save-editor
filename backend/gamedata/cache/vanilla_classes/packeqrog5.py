...
class Packeqrog5Data:
    """
    Auto-generated data class for packeqrog5.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Packeqrog5Data {pk_column}={pk_value!r}>>"
        else:
            return f"<Packeqrog5Data>"
