...
class Race_feat_water_genasiData:
    """
    Auto-generated data class for race_feat_water_genasi.2da
    ...
    _table_name = 'race_feat_water_genasi'
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Race_feat_water_genasiData {pk_column}={pk_value!r}>>"
        else:
            return f"<Race_feat_water_genasiData>"
