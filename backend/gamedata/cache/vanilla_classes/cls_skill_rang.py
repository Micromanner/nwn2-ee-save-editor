...
class Cls_skill_rangData:
    """
    Auto-generated data class for cls_skill_rang.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Cls_skill_rangData {pk_column}={pk_value!r}>>"
        else:
            return f"<Cls_skill_rangData>"
