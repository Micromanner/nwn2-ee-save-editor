...
class PackftgrobnarData:
    """
    Auto-generated data class for packftgrobnar.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<PackftgrobnarData {pk_column}={pk_value!r}>>"
        else:
            return f"<PackftgrobnarData>"
