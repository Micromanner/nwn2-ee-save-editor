...
class Cls_skill_favored_soulData:
    """
    Auto-generated data class for cls_skill_favored_soul.2da
    ...
    _table_name = 'cls_skill_favored_soul'
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Cls_skill_favored_soulData {pk_column}={pk_value!r}>>"
        else:
            return f"<Cls_skill_favored_soulData>"
