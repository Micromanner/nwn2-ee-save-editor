...
class Packftpala5Data:
    """
    Auto-generated data class for packftpala5.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Packftpala5Data {pk_column}={pk_value!r}>>"
        else:
            return f"<Packftpala5Data>"
