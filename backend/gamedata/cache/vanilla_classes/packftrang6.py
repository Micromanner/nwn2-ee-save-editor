...
class Packftrang6Data:
    """
    Auto-generated data class for packftrang6.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Packftrang6Data {pk_column}={pk_value!r}>>"
        else:
            return f"<Packftrang6Data>"
