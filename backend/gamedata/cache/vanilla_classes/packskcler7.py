...
class Packskcler7Data:
    """
    Auto-generated data class for packskcler7.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Packskcler7Data {pk_column}={pk_value!r}>>"
        else:
            return f"<Packskcler7Data>"
