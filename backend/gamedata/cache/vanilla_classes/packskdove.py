...
class PackskdoveData:
    """
    Auto-generated data class for packskdove.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<PackskdoveData {pk_column}={pk_value!r}>>"
        else:
            return f"<PackskdoveData>"
