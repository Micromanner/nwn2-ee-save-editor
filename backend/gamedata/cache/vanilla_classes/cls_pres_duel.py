...
class Cls_pres_duelData:
    """
    Auto-generated data class for cls_pres_duel.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Cls_pres_duelData {pk_column}={pk_value!r}>>"
        else:
            return f"<Cls_pres_duelData>"
