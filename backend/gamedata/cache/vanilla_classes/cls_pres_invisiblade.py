...
class Cls_pres_invisibladeData:
    """
    Auto-generated data class for cls_pres_invisiblade.2da
    
    This class provides efficient attribute access to 2DA row data
    with automatic column name mapping for mod compatibility.
    """
    __slots__ = ('_resource_manager', '_LABEL', '_ReqType', '_ReqParam1', '_ReqParam2')
    _column_mapping = {'LABEL': 'LABEL', 'ReqType': 'ReqType', 'ReqParam1': 'ReqParam1', 'ReqParam2': 'ReqParam2'}
    _table_name = 'cls_pres_invisiblade'
    _safe_columns = ['LABEL', 'ReqType', 'ReqParam1', 'ReqParam2']
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Cls_pres_invisibladeData {pk_column}={pk_value!r}>>"
        else:
            return f"<Cls_pres_invisibladeData>"
