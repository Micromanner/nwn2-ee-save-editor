...
class PackftdoveData:
    """
    Auto-generated data class for packftdove.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<PackftdoveData {pk_column}={pk_value!r}>>"
        else:
            return f"<PackftdoveData>"
