...
class Tib01_edgeData:
    """
    Auto-generated data class for tib01_edge.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Tib01_edgeData {pk_column}={pk_value!r}>>"
        else:
            return f"<Tib01_edgeData>"
