...
class PackftcommData:
    """
    Auto-generated data class for packftcomm.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<PackftcommData {pk_column}={pk_value!r}>>"
        else:
            return f"<PackftcommData>"
