...
class Des_treas_dispData:
    """
    Auto-generated data class for des_treas_disp.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Des_treas_dispData {pk_column}={pk_value!r}>>"
        else:
            return f"<Des_treas_dispData>"
