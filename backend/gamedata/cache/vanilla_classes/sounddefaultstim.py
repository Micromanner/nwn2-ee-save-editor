...
class SounddefaultstimData:
    """
    Auto-generated data class for sounddefaultstim.2da
    
    This class provides efficient attribute access to 2DA row data
    with automatic column name mapping for mod compatibility.
    """
    __slots__ = ('_resource_manager', '_Label', '_Looping', '_Continuous', '_Random', '_Interval', '_IntervalVar', '_PitchVar', '_VolumeVar')
    _column_mapping = {'Label': 'Label', 'Looping': 'Looping', 'Continuous': 'Continuous', 'Random': 'Random', 'Interval': 'Interval', 'IntervalVar': 'IntervalVar', 'PitchVar': 'PitchVar', 'VolumeVar': 'VolumeVar'}
    _table_name = 'sounddefaultstim'
    _safe_columns = ['Label', 'Looping', 'Continuous', 'Random', 'Interval', 'IntervalVar', 'PitchVar', 'VolumeVar']
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<SounddefaultstimData {pk_column}={pk_value!r}>>"
        else:
            return f"<SounddefaultstimData>"
