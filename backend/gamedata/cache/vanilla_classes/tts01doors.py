...
class Tts01doorsData:
    """
    Auto-generated data class for tts01doors.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Tts01doorsData {pk_column}={pk_value!r}>>"
        else:
            return f"<Tts01doorsData>"
