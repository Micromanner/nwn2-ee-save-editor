...
class HenchspellsData:
    """
    Auto-generated data class for henchspells.2da
    
    This class provides efficient attribute access to 2DA row data
    with automatic column name mapping for mod compatibility.
    """
    __slots__ = ('_resource_manager', '_SpellInfo', '_TargetInfo', '_EffectWeight', '_EffectTypes', '_DamageInfo', '_SaveType', '_SaveDCType')
    _column_mapping = {'SpellInfo': 'SpellInfo', 'TargetInfo': 'TargetInfo', 'EffectWeight': 'EffectWeight', 'EffectTypes': 'EffectTypes', 'DamageInfo': 'DamageInfo', 'SaveType': 'SaveType', 'SaveDCType': 'SaveDCType'}
    _table_name = 'henchspells'
    _safe_columns = ['SpellInfo', 'TargetInfo', 'EffectWeight', 'EffectTypes', 'DamageInfo', 'SaveType', 'SaveDCType']
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<HenchspellsData {pk_column}={pk_value!r}>>"
        else:
            return f"<HenchspellsData>"
