...
class PackftsafiyaData:
    """
    Auto-generated data class for packftsafiya.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<PackftsafiyaData {pk_column}={pk_value!r}>>"
        else:
            return f"<PackftsafiyaData>"
