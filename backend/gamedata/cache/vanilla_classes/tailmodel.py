...
class TailmodelData:
    """
    Auto-generated data class for tailmodel.2da
    
    This class provides efficient attribute access to 2DA row data
    with automatic column name mapping for mod compatibility.
    """
    __slots__ = ('_resource_manager', '_LABEL', '_StringRef', '_NWN2_ModelName', '_NWN2_Skeleton_File', '_NWN2_BaseAnims', '_MODEL')
    _column_mapping = {'LABEL': 'LABEL', 'StringRef': 'StringRef', 'NWN2_ModelName': 'NWN2_ModelName', 'NWN2_Skeleton_File': 'NWN2_Skeleton_File', 'NWN2_BaseAnims': 'NWN2_BaseAnims', 'MODEL': 'MODEL'}
    _table_name = 'tailmodel'
    _safe_columns = ['LABEL', 'StringRef', 'NWN2_ModelName', 'NWN2_Skeleton_File', 'NWN2_BaseAnims', 'MODEL']
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<TailmodelData {pk_column}={pk_value!r}>>"
        else:
            return f"<TailmodelData>"
