...
class Des_prayerData:
    """
    Auto-generated data class for des_prayer.2da
    
    This class provides efficient attribute access to 2DA row data
    with automatic column name mapping for mod compatibility.
    """
    __slots__ = ('_resource_manager', '_Label', '_Reagent1', '_Reagent2', '_TemplateCreated')
    _column_mapping = {'Label': 'Label', 'Reagent1': 'Reagent1', 'Reagent2': 'Reagent2', 'TemplateCreated': 'TemplateCreated'}
    _table_name = 'des_prayer'
    _safe_columns = ['Label', 'Reagent1', 'Reagent2', 'TemplateCreated']
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Des_prayerData {pk_column}={pk_value!r}>>"
        else:
            return f"<Des_prayerData>"
