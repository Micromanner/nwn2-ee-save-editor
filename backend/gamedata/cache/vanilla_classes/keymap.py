...
class KeymapData:
    """
    Auto-generated data class for keymap.2da
    
    This class provides efficient attribute access to 2DA row data
    with automatic column name mapping for mod compatibility.
    """
    __slots__ = ('_resource_manager', '_ActionStrRef', '_InputMode1', '_InputMode2', '_InputMode3', '_Page', '_Name')
    _column_mapping = {'ActionStrRef': 'ActionStrRef', 'InputMode1': 'InputMode1', 'InputMode2': 'InputMode2', 'InputMode3': 'InputMode3', 'Page': 'Page', 'Name': 'Name'}
    _table_name = 'keymap'
    _safe_columns = ['ActionStrRef', 'InputMode1', 'InputMode2', 'InputMode3', 'Page', 'Name']
