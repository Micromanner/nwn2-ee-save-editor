...
class Itm_rand_mitemData:
    """
    Auto-generated data class for itm_rand_mitem.2da
    
    This class provides efficient attribute access to 2DA row data
    with automatic column name mapping for mod compatibility.
    """
    __slots__ = ('_resource_manager', '_LTE', '_col_empty_2', '_BASE_ITEM_TABLE')
    _column_mapping = {'LTE': 'LTE', '': 'col_empty_2', 'BASE_ITEM_TABLE': 'BASE_ITEM_TABLE'}
    _table_name = 'itm_rand_mitem'
    _safe_columns = ['LTE', 'col_empty_2', 'BASE_ITEM_TABLE']
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Itm_rand_mitemData {pk_column}={pk_value!r}>>"
        else:
            return f"<Itm_rand_mitemData>"
