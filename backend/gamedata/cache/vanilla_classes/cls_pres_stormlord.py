...
class Cls_pres_stormlordData:
    """
    Auto-generated data class for cls_pres_stormlord.2da
    ...
    _table_name = 'cls_pres_stormlord'
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Cls_pres_stormlordData {pk_column}={pk_value!r}>>"
        else:
            return f"<Cls_pres_stormlordData>"
