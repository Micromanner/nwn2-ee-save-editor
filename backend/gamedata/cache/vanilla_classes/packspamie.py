...
class PackspamieData:
    """
    Auto-generated data class for packspamie.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<PackspamieData {pk_column}={pk_value!r}>>"
        else:
            return f"<PackspamieData>"
