...
class Packspspisha1Data:
    """
    Auto-generated data class for packspspisha1.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Packspspisha1Data {pk_column}={pk_value!r}>>"
        else:
            return f"<Packspspisha1Data>"
