...
class Itm_rand_baseData:
    """
    Auto-generated data class for itm_rand_base.2da
    
    This class provides efficient attribute access to 2DA row data
    with automatic column name mapping for mod compatibility.
    """
    __slots__ = ('_resource_manager', '_LTE_MINOR', '_LTE_MEDIUM', '_LTE_MAJOR', '_ITEM', '_col_empty_2', '_SUBTABLE')
    _column_mapping = {'LTE_MINOR': 'LTE_MINOR', 'LTE_MEDIUM': 'LTE_MEDIUM', 'LTE_MAJOR': 'LTE_MAJOR', 'ITEM': 'ITEM', '': 'col_empty_2', 'SUBTABLE': 'SUBTABLE'}
    _table_name = 'itm_rand_base'
    _safe_columns = ['LTE_MINOR', 'LTE_MEDIUM', 'LTE_MAJOR', 'ITEM', 'col_empty_2', 'SUBTABLE']
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Itm_rand_baseData {pk_column}={pk_value!r}>>"
        else:
            return f"<Itm_rand_baseData>"
