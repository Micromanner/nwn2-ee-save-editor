...
class Packftmonk6Data:
    """
    Auto-generated data class for packftmonk6.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Packftmonk6Data {pk_column}={pk_value!r}>>"
        else:
            return f"<Packftmonk6Data>"
