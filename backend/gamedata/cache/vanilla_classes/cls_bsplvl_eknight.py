...
class Cls_bsplvl_eknightData:
    """
    Auto-generated data class for cls_bsplvl_eknight.2da
    ...
    _table_name = 'cls_bsplvl_eknight'
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Cls_bsplvl_eknightData {pk_column}={pk_value!r}>>"
        else:
            return f"<Cls_bsplvl_eknightData>"
