...
class Packftcler4Data:
    """
    Auto-generated data class for packftcler4.2da
    
    This class provides efficient attribute access to 2DA row data
    with automatic column name mapping for mod compatibility.
    """
    __slots__ = ('_resource_manager', '_col_empty', '_FeatIndex_Label')
    _column_mapping = {'': 'col_empty', 'FeatIndex   Label': 'FeatIndex_Label'}
    _table_name = 'packftcler4'
    _safe_columns = ['col_empty', 'FeatIndex_Label']
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Packftcler4Data {pk_column}={pk_value!r}>>"
        else:
            return f"<Packftcler4Data>"
