...
class Packsksor10Data:
    """
    Auto-generated data class for packsksor10.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Packsksor10Data {pk_column}={pk_value!r}>>"
        else:
            return f"<Packsksor10Data>"
