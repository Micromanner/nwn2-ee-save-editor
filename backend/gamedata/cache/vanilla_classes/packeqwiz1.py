...
class Packeqwiz1Data:
    """
    Auto-generated data class for packeqwiz1.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Packeqwiz1Data {pk_column}={pk_value!r}>>"
        else:
            return f"<Packeqwiz1Data>"
