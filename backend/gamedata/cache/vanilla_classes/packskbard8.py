...
class Packskbard8Data:
    """
    Auto-generated data class for packskbard8.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Packskbard8Data {pk_column}={pk_value!r}>>"
        else:
            return f"<Packskbard8Data>"
