...
class PackskgannData:
    """
    Auto-generated data class for packskgann.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<PackskgannData {pk_column}={pk_value!r}>>"
        else:
            return f"<PackskgannData>"
