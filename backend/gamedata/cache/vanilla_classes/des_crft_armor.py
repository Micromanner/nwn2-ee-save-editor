...
class Des_crft_armorData:
    """
    Auto-generated data class for des_crft_armor.2da
    
    This class provides efficient attribute access to 2DA row data
    with automatic column name mapping for mod compatibility.
    """
    __slots__ = ('_resource_manager', '_COMMENT', '_Label0', '_ResRef0', '_DC0', '_CostGP0', '_Label1', '_ResRef1', '_DC1', '_CostGP1', '_Label2', '_ResRef2', '_DC2', '_CostGP2', '_Label3', '_ResRef3', '_DC3', '_CostGP3', '_Label4', '_ResRef4', '_DC4', '_CostGP4')
    _column_mapping = {'COMMENT': 'COMMENT', 'Label0': 'Label0', 'ResRef0': 'ResRef0', 'DC0': 'DC0', 'CostGP0': 'CostGP0', 'Label1': 'Label1', 'ResRef1': 'ResRef1', 'DC1': 'DC1', 'CostGP1': 'CostGP1', 'Label2': 'Label2', 'ResRef2': 'ResRef2', 'DC2': 'DC2', 'CostGP2': 'CostGP2', 'Label3': 'Label3', 'ResRef3': 'ResRef3', 'DC3': 'DC3', 'CostGP3': 'CostGP3', 'Label4': 'Label4', 'ResRef4': 'ResRef4', 'DC4': 'DC4', 'CostGP4': 'CostGP4'}
    _table_name = 'des_crft_armor'
    _safe_columns = ['COMMENT', 'Label0', 'ResRef0', 'DC0', 'CostGP0', 'Label1', 'ResRef1', 'DC1', 'CostGP1', 'Label2', 'ResRef2', 'DC2', 'CostGP2', 'Label3', 'ResRef3', 'DC3', 'CostGP3', 'Label4', 'ResRef4', 'DC4', 'CostGP4']
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Des_crft_armorData {pk_column}={pk_value!r}>>"
        else:
            return f"<Des_crft_armorData>"
