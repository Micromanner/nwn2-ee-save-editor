...
class Race_feat_constData:
    """
    Auto-generated data class for race_feat_const.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Race_feat_constData {pk_column}={pk_value!r}>>"
        else:
            return f"<Race_feat_constData>"
