...
class Iprp_combatdamData:
    """
    Auto-generated data class for iprp_combatdam.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Iprp_combatdamData {pk_column}={pk_value!r}>>"
        else:
            return f"<Iprp_combatdamData>"
