...
class Restsys_wm_tablesData:
    """
    Auto-generated data class for restsys_wm_tables.2da
    
    This class provides efficient attribute access to 2DA row data
    with automatic column name mapping for mod compatibility.
    """
    __slots__ = ('_resource_manager', '_TableName', '_Comment', '_FeedBackStrRefSuccess', '_FeedBackStrRefFail', '_Enc1_ResRefs', '_Enc1_Prob', '_Enc2_ResRefs', '_Enc2_Prob', '_Enc3_ResRefs')
    _column_mapping = {'TableName': 'TableName', 'Comment': 'Comment', 'FeedBackStrRefSuccess': 'FeedBackStrRefSuccess', 'FeedBackStrRefFail': 'FeedBackStrRefFail', 'Enc1_ResRefs': 'Enc1_ResRefs', 'Enc1_Prob': 'Enc1_Prob', 'Enc2_ResRefs': 'Enc2_ResRefs', 'Enc2_Prob': 'Enc2_Prob', 'Enc3_ResRefs': 'Enc3_ResRefs'}
    _table_name = 'restsys_wm_tables'
    _safe_columns = ['TableName', 'Comment', 'FeedBackStrRefSuccess', 'FeedBackStrRefFail', 'Enc1_ResRefs', 'Enc1_Prob', 'Enc2_ResRefs', 'Enc2_Prob', 'Enc3_ResRefs']
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Restsys_wm_tablesData {pk_column}={pk_value!r}>>"
        else:
            return f"<Restsys_wm_tablesData>"
