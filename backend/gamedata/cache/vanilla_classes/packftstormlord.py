...
class PackftstormlordData:
    """
    Auto-generated data class for packftstormlord.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<PackftstormlordData {pk_column}={pk_value!r}>>"
        else:
            return f"<PackftstormlordData>"
