...
class DoortypesData:
    """
    Auto-generated data class for doortypes.2da
    
    This class provides efficient attribute access to 2DA row data
    with automatic column name mapping for mod compatibility.
    """
    __slots__ = ('_resource_manager', '_Label', '_PlaceableModelType', '_NWN2_ModelName', '_AttachedModelName', '_NWN2_PartsCount', '_NWN2_Skeleton', '_Model', '_TileSet', '_TemplateResRef', '_StringRefGame', '_BlockSight', '_VisibleModel', '_SoundAppType', '_SELECTION_SIZE', '_OpenTime')
    _column_mapping = {'Label': 'Label', 'PlaceableModelType': 'PlaceableModelType', 'NWN2_ModelName': 'NWN2_ModelName', 'AttachedModelName': 'AttachedModelName', 'NWN2_PartsCount': 'NWN2_PartsCount', 'NWN2_Skeleton': 'NWN2_Skeleton', 'Model': 'Model', 'TileSet': 'TileSet', 'TemplateResRef': 'TemplateResRef', 'StringRefGame': 'StringRefGame', 'BlockSight': 'BlockSight', 'VisibleModel': 'VisibleModel', 'SoundAppType': 'SoundAppType', 'SELECTION_SIZE': 'SELECTION_SIZE', 'OpenTime': 'OpenTime'}
    _table_name = 'doortypes'
    _safe_columns = ['Label', 'PlaceableModelType', 'NWN2_ModelName', 'AttachedModelName', 'NWN2_PartsCount', 'NWN2_Skeleton', 'Model', 'TileSet', 'TemplateResRef', 'StringRefGame', 'BlockSight', 'VisibleModel', 'SoundAppType', 'SELECTION_SIZE', 'OpenTime']
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<DoortypesData {pk_column}={pk_value!r}>>"
        else:
            return f"<DoortypesData>"
