...
class Packskbarb3Data:
    """
    Auto-generated data class for packskbarb3.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Packskbarb3Data {pk_column}={pk_value!r}>>"
        else:
            return f"<Packskbarb3Data>"
