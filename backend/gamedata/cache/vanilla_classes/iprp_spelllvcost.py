...
class Iprp_spelllvcostData:
    """
    Auto-generated data class for iprp_spelllvcost.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Iprp_spelllvcostData {pk_column}={pk_value!r}>>"
        else:
            return f"<Iprp_spelllvcostData>"
