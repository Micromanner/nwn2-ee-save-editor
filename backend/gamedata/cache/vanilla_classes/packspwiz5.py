...
class Packspwiz5Data:
    """
    Auto-generated data class for packspwiz5.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Packspwiz5Data {pk_column}={pk_value!r}>>"
        else:
            return f"<Packspwiz5Data>"
