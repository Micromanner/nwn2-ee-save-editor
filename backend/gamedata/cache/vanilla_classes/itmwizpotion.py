...
class ItmwizpotionData:
    """
    Auto-generated data class for itmwizpotion.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<ItmwizpotionData {pk_column}={pk_value!r}>>"
        else:
            return f"<ItmwizpotionData>"
