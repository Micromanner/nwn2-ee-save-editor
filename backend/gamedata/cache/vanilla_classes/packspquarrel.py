...
class PackspquarrelData:
    """
    Auto-generated data class for packspquarrel.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<PackspquarrelData {pk_column}={pk_value!r}>>"
        else:
            return f"<PackspquarrelData>"
