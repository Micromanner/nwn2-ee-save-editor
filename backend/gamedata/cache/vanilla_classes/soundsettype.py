...
class SoundsettypeData:
    """
    Auto-generated data class for soundsettype.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<SoundsettypeData {pk_column}={pk_value!r}>>"
        else:
            return f"<SoundsettypeData>"
