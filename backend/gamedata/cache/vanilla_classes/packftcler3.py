...
class Packftcler3Data:
    """
    Auto-generated data class for packftcler3.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Packftcler3Data {pk_column}={pk_value!r}>>"
        else:
            return f"<Packftcler3Data>"
