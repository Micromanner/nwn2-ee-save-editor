...
class PackskwizbData:
    """
    Auto-generated data class for packskwizb.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<PackskwizbData {pk_column}={pk_value!r}>>"
        else:
            return f"<PackskwizbData>"
