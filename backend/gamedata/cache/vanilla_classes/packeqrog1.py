...
class Packeqrog1Data:
    """
    Auto-generated data class for packeqrog1.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Packeqrog1Data {pk_column}={pk_value!r}>>"
        else:
            return f"<Packeqrog1Data>"
