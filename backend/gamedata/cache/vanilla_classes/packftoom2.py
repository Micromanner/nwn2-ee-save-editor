...
class Packftoom2Data:
    """
    Auto-generated data class for packftoom2.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Packftoom2Data {pk_column}={pk_value!r}>>"
        else:
            return f"<Packftoom2Data>"
