...
class PackftbardgData:
    """
    Auto-generated data class for packftbardg.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<PackftbardgData {pk_column}={pk_value!r}>>"
        else:
            return f"<PackftbardgData>"
