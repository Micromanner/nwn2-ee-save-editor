...
class Packskbard3Data:
    """
    Auto-generated data class for packskbard3.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Packskbard3Data {pk_column}={pk_value!r}>>"
        else:
            return f"<Packskbard3Data>"
