...
class PackftwizaData:
    """
    Auto-generated data class for packftwiza.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<PackftwizaData {pk_column}={pk_value!r}>>"
        else:
            return f"<PackftwizaData>"
