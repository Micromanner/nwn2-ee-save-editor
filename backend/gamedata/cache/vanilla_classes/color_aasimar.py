...
class Color_aasimarData:
    """
    Auto-generated data class for color_aasimar.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Color_aasimarData {pk_column}={pk_value!r}>>"
        else:
            return f"<Color_aasimarData>"
