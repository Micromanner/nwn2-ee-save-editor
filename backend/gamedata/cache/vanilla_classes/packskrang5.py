...
class Packskrang5Data:
    """
    Auto-generated data class for packskrang5.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Packskrang5Data {pk_column}={pk_value!r}>>"
        else:
            return f"<Packskrang5Data>"
