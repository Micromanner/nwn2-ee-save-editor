...
class Parts_handData:
    """
    Auto-generated data class for parts_hand.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Parts_handData {pk_column}={pk_value!r}>>"
        else:
            return f"<Parts_handData>"
