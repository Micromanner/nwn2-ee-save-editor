...
class Packeqdruid1Data:
    """
    Auto-generated data class for packeqdruid1.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Packeqdruid1Data {pk_column}={pk_value!r}>>"
        else:
            return f"<Packeqdruid1Data>"
