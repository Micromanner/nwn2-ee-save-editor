...
class Cls_savthr_palData:
    """
    Auto-generated data class for cls_savthr_pal.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Cls_savthr_palData {pk_column}={pk_value!r}>>"
        else:
            return f"<Cls_savthr_palData>"
