...
class Parts_chestData:
    """
    Auto-generated data class for parts_chest.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Parts_chestData {pk_column}={pk_value!r}>>"
        else:
            return f"<Parts_chestData>"
