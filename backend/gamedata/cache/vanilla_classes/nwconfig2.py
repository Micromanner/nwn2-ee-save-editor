...
class Nwconfig2Data:
    """
    Auto-generated data class for nwconfig2.2da
    
    This class provides efficient attribute access to 2DA row data
    with automatic column name mapping for mod compatibility.
    """
    __slots__ = ('_resource_manager', '_PROGRAM', '_LOCATION', '_TYPE_', '_BLOCK')
    _column_mapping = {'PROGRAM': 'PROGRAM', 'LOCATION': 'LOCATION', 'TYPE': 'TYPE_', 'BLOCK': 'BLOCK'}
    _table_name = 'nwconfig2'
    _safe_columns = ['PROGRAM', 'LOCATION', 'TYPE_', 'BLOCK']
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Nwconfig2Data {pk_column}={pk_value!r}>>"
        else:
            return f"<Nwconfig2Data>"
