...
class Des_conf_treasData:
    """
    Auto-generated data class for des_conf_treas.2da
    
    This class provides efficient attribute access to 2DA row data
    with automatic column name mapping for mod compatibility.
    """
    __slots__ = ('_resource_manager', '_Module', '_BaseTreasureChance', '_StackVariation', '_MaxItems', '_Disp2DA', '_Ammo2DA', '_Gold2DA', '_Item2DA')
    _column_mapping = {'Module': 'Module', 'BaseTreasureChance': 'BaseTreasureChance', 'StackVariation': 'StackVariation', 'MaxItems': 'MaxItems', 'Disp2DA': 'Disp2DA', 'Ammo2DA': 'Ammo2DA', 'Gold2DA': 'Gold2DA', 'Item2DA': 'Item2DA'}
    _table_name = 'des_conf_treas'
    _safe_columns = ['Module', 'BaseTreasureChance', 'StackVariation', 'MaxItems', 'Disp2DA', 'Ammo2DA', 'Gold2DA', 'Item2DA']
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Des_conf_treasData {pk_column}={pk_value!r}>>"
        else:
            return f"<Des_conf_treasData>"
