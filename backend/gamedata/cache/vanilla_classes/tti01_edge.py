...
class Tti01_edgeData:
    """
    Auto-generated data class for tti01_edge.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Tti01_edgeData {pk_column}={pk_value!r}>>"
        else:
            return f"<Tti01_edgeData>"
