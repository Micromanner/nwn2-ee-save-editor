...
class Cls_bfeat_sdthfData:
    """
    Auto-generated data class for cls_bfeat_sdthf.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Cls_bfeat_sdthfData {pk_column}={pk_value!r}>>"
        else:
            return f"<Cls_bfeat_sdthfData>"
