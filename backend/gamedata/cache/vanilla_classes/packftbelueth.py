...
class PackftbeluethData:
    """
    Auto-generated data class for packftbelueth.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<PackftbeluethData {pk_column}={pk_value!r}>>"
        else:
            return f"<PackftbeluethData>"
