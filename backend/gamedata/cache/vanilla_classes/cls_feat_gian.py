...
class Cls_feat_gianData:
    """
    Auto-generated data class for cls_feat_gian.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Cls_feat_gianData {pk_column}={pk_value!r}>>"
        else:
            return f"<Cls_feat_gianData>"
