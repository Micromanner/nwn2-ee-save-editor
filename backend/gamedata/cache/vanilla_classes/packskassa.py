...
class PackskassaData:
    """
    Auto-generated data class for packskassa.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<PackskassaData {pk_column}={pk_value!r}>>"
        else:
            return f"<PackskassaData>"
