...
class Des_crft_amatData:
    """
    Auto-generated data class for des_crft_amat.2da
    
    This class provides efficient attribute access to 2DA row data
    with automatic column name mapping for mod compatibility.
    """
    __slots__ = ('_resource_manager', '_Comment', '_x2_it_amt_lpatch', '_x2_it_amt_lstrng', '_x2_it_amt_spikes', '_x2_it_amt_chain', '_x2_it_amt_rings', '_x2_it_amt_blades', '_x2_it_amt_lblade', '_x2_it_amt_cpadd', '_x2_it_amt_feath', '_x2_it_amt_morb', '_x2_it_amt_hhead', '_x2_it_amt_ahead', '_x2_it_amt_iband')
    _column_mapping = {'Comment': 'Comment', 'x2_it_amt_lpatch': 'x2_it_amt_lpatch', 'x2_it_amt_lstrng': 'x2_it_amt_lstrng', 'x2_it_amt_spikes': 'x2_it_amt_spikes', 'x2_it_amt_chain': 'x2_it_amt_chain', 'x2_it_amt_rings': 'x2_it_amt_rings', 'x2_it_amt_blades': 'x2_it_amt_blades', 'x2_it_amt_lblade': 'x2_it_amt_lblade', 'x2_it_amt_cpadd': 'x2_it_amt_cpadd', 'x2_it_amt_feath': 'x2_it_amt_feath', 'x2_it_amt_morb': 'x2_it_amt_morb', 'x2_it_amt_hhead': 'x2_it_amt_hhead', 'x2_it_amt_ahead': 'x2_it_amt_ahead', 'x2_it_amt_iband': 'x2_it_amt_iband'}
    _table_name = 'des_crft_amat'
    _safe_columns = ['Comment', 'x2_it_amt_lpatch', 'x2_it_amt_lstrng', 'x2_it_amt_spikes', 'x2_it_amt_chain', 'x2_it_amt_rings', 'x2_it_amt_blades', 'x2_it_amt_lblade', 'x2_it_amt_cpadd', 'x2_it_amt_feath', 'x2_it_amt_morb', 'x2_it_amt_hhead', 'x2_it_amt_ahead', 'x2_it_amt_iband']
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Des_crft_amatData {pk_column}={pk_value!r}>>"
        else:
            return f"<Des_crft_amatData>"
