...
class SoundproviderData:
    """
    Auto-generated data class for soundprovider.2da
    
    This class provides efficient attribute access to 2DA row data
    with automatic column name mapping for mod compatibility.
    """
    __slots__ = ('_resource_manager', '_Provider', '_PreferredEAX', '_PreferredHardware', '_PreferredSoftware', '_col_2D3DBias')
    _column_mapping = {'Provider': 'Provider', 'PreferredEAX': 'PreferredEAX', 'PreferredHardware': 'PreferredHardware', 'PreferredSoftware': 'PreferredSoftware', '2D3DBias': 'col_2D3DBias'}
    _table_name = 'soundprovider'
    _safe_columns = ['Provider', 'PreferredEAX', 'PreferredHardware', 'PreferredSoftware', 'col_2D3DBias']
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<SoundproviderData {pk_column}={pk_value!r}>>"
        else:
            return f"<SoundproviderData>"
