...
class Cls_featmap_redwizData:
    """
    Auto-generated data class for cls_featmap_redwiz.2da
    ...
    _table_name = 'cls_featmap_redwiz'
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Cls_featmap_redwizData {pk_column}={pk_value!r}>>"
        else:
            return f"<Cls_featmap_redwizData>"
