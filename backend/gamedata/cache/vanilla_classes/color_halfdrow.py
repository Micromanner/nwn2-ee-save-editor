...
class Color_halfdrowData:
    """
    Auto-generated data class for color_halfdrow.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Color_halfdrowData {pk_column}={pk_value!r}>>"
        else:
            return f"<Color_halfdrowData>"
