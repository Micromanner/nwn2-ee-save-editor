...
class Parts_forearmData:
    """
    Auto-generated data class for parts_forearm.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Parts_forearmData {pk_column}={pk_value!r}>>"
        else:
            return f"<Parts_forearmData>"
