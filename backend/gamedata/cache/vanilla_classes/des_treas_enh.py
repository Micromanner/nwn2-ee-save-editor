...
class Des_treas_enhData:
    """
    Auto-generated data class for des_treas_enh.2da
    
    This class provides efficient attribute access to 2DA row data
    with automatic column name mapping for mod compatibility.
    """
    __slots__ = ('_resource_manager', '_Melee', '_Ranged')
    _column_mapping = {'Melee': 'Melee', 'Ranged': 'Ranged'}
    _table_name = 'des_treas_enh'
    _safe_columns = ['Melee', 'Ranged']
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Des_treas_enhData {pk_column}={pk_value!r}>>"
        else:
            return f"<Des_treas_enhData>"
