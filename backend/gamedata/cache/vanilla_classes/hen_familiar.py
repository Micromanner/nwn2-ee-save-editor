...
class Hen_familiarData:
    """
    Auto-generated data class for hen_familiar.2da
    
    This class provides efficient attribute access to 2DA row data
    with automatic column name mapping for mod compatibility.
    """
    __slots__ = ('_resource_manager', '_NAME', '_BASERESREF_PREFIX', '_STRREF', '_DESCRIPTION', '_FeatGained', '_Range1', '_Range2', '_Range3', '_Range4', '_Range5', '_Range6', '_Range7', '_Range8', '_Range9', '_Range10', '_Range11', '_Range12', '_Range13', '_Range14', '_Range15', '_AvailableToPlayer', '_FeatID')
    _column_mapping = {'NAME': 'NAME', 'BASERESREF_PREFIX': 'BASERESREF_PREFIX', 'STRREF': 'STRREF', 'DESCRIPTION': 'DESCRIPTION', 'FeatGained': 'FeatGained', 'Range1': 'Range1', 'Range2': 'Range2', 'Range3': 'Range3', 'Range4': 'Range4', 'Range5': 'Range5', 'Range6': 'Range6', 'Range7': 'Range7', 'Range8': 'Range8', 'Range9': 'Range9', 'Range10': 'Range10', 'Range11': 'Range11', 'Range12': 'Range12', 'Range13': 'Range13', 'Range14': 'Range14', 'Range15': 'Range15', 'AvailableToPlayer': 'AvailableToPlayer', 'FeatID': 'FeatID'}
    _table_name = 'hen_familiar'
    _safe_columns = ['NAME', 'BASERESREF_PREFIX', 'STRREF', 'DESCRIPTION', 'FeatGained', 'Range1', 'Range2', 'Range3', 'Range4', 'Range5', 'Range6', 'Range7', 'Range8', 'Range9', 'Range10', 'Range11', 'Range12', 'Range13', 'Range14', 'Range15', 'AvailableToPlayer', 'FeatID']
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Hen_familiarData {pk_column}={pk_value!r}>>"
        else:
            return f"<Hen_familiarData>"
