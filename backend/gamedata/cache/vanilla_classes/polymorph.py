...
class PolymorphData:
    """
    Auto-generated data class for polymorph.2da
    
    This class provides efficient attribute access to 2DA row data
    with automatic column name mapping for mod compatibility.
    """
    __slots__ = ('_resource_manager', '_Name', '_AppearanceResRef', '_RacialType', '_PortraitId', '_Portrait', '_CreatureWeapon1', '_CreatureWeapon2', '_CreatureWeapon3', '_HideItem', '_EQUIPPED', '_STR', '_CON', '_DEX', '_NATURALACBONUS', '_HPBONUS', '_SoundSet', '_SPELL1', '_SPELL2', '_SPELL3', '_MergeW', '_MergeI', '_MergeA')
    _column_mapping = {'Name': 'Name', 'AppearanceResRef': 'AppearanceResRef', 'RacialType': 'RacialType', 'PortraitId': 'PortraitId', 'Portrait': 'Portrait', 'CreatureWeapon1': 'CreatureWeapon1', 'CreatureWeapon2': 'CreatureWeapon2', 'CreatureWeapon3': 'CreatureWeapon3', 'HideItem': 'HideItem', 'EQUIPPED': 'EQUIPPED', 'STR': 'STR', 'CON': 'CON', 'DEX': 'DEX', 'NATURALACBONUS': 'NATURALACBONUS', 'HPBONUS': 'HPBONUS', 'SoundSet': 'SoundSet', 'SPELL1': 'SPELL1', 'SPELL2': 'SPELL2', 'SPELL3': 'SPELL3', 'MergeW': 'MergeW', 'MergeI': 'MergeI', 'MergeA': 'MergeA'}
    _table_name = 'polymorph'
    _safe_columns = ['Name', 'AppearanceResRef', 'RacialType', 'PortraitId', 'Portrait', 'CreatureWeapon1', 'CreatureWeapon2', 'CreatureWeapon3', 'HideItem', 'EQUIPPED', 'STR', 'CON', 'DEX', 'NATURALACBONUS', 'HPBONUS', 'SoundSet', 'SPELL1', 'SPELL2', 'SPELL3', 'MergeW', 'MergeI', 'MergeA']
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<PolymorphData {pk_column}={pk_value!r}>>"
        else:
            return f"<PolymorphData>"
