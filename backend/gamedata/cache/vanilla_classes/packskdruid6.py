...
class Packskdruid6Data:
    """
    Auto-generated data class for packskdruid6.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Packskdruid6Data {pk_column}={pk_value!r}>>"
        else:
            return f"<Packskdruid6Data>"
