...
class TilecolorData:
    """
    Auto-generated data class for tilecolor.2da
    
    This class provides efficient attribute access to 2DA row data
    with automatic column name mapping for mod compatibility.
    """
    __slots__ = ('_resource_manager', '_TILESET', '_Wall_A_RED', '_Wall_A_GREEN', '_Wall_A_BLUE', '_Floor_A_RED', '_Floor_A_GREEN', '_Floor_A_BLUE', '_Wall_B_RED', '_Wall_B_GREEN', '_Wall_B_BLUE', '_Floor_B_RED', '_Floor_B_GREEN', '_Floor_B_BLUE', '_Wall_C_RED', '_Wall_C_GREEN', '_Wall_C_BLUE', '_Floor_C_RED', '_Floor_C_GREEN', '_Floor_C_BLUE')
    _column_mapping = {'TILESET': 'TILESET', 'Wall_A_RED': 'Wall_A_RED', 'Wall_A_GREEN': 'Wall_A_GREEN', 'Wall_A_BLUE': 'Wall_A_BLUE', 'Floor_A_RED': 'Floor_A_RED', 'Floor_A_GREEN': 'Floor_A_GREEN', 'Floor_A_BLUE': 'Floor_A_BLUE', 'Wall_B_RED': 'Wall_B_RED', 'Wall_B_GREEN': 'Wall_B_GREEN', 'Wall_B_BLUE': 'Wall_B_BLUE', 'Floor_B_RED': 'Floor_B_RED', 'Floor_B_GREEN': 'Floor_B_GREEN', 'Floor_B_BLUE': 'Floor_B_BLUE', 'Wall_C_RED': 'Wall_C_RED', 'Wall_C_GREEN': 'Wall_C_GREEN', 'Wall_C_BLUE': 'Wall_C_BLUE', 'Floor_C_RED': 'Floor_C_RED', 'Floor_C_GREEN': 'Floor_C_GREEN', 'Floor_C_BLUE': 'Floor_C_BLUE'}
    _table_name = 'tilecolor'
    _safe_columns = ['TILESET', 'Wall_A_RED', 'Wall_A_GREEN', 'Wall_A_BLUE', 'Floor_A_RED', 'Floor_A_GREEN', 'Floor_A_BLUE', 'Wall_B_RED', 'Wall_B_GREEN', 'Wall_B_BLUE', 'Floor_B_RED', 'Floor_B_GREEN', 'Floor_B_BLUE', 'Wall_C_RED', 'Wall_C_GREEN', 'Wall_C_BLUE', 'Floor_C_RED', 'Floor_C_GREEN', 'Floor_C_BLUE']
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<TilecolorData {pk_column}={pk_value!r}>>"
        else:
            return f"<TilecolorData>"
