...
class Packftbard2Data:
    """
    Auto-generated data class for packftbard2.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Packftbard2Data {pk_column}={pk_value!r}>>"
        else:
            return f"<Packftbard2Data>"
