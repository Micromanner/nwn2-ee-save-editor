...
class Des_treas_uniqData:
    """
    Auto-generated data class for des_treas_uniq.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Des_treas_uniqData {pk_column}={pk_value!r}>>"
        else:
            return f"<Des_treas_uniqData>"
