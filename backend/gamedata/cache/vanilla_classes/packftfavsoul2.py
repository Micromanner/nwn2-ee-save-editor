...
class Packftfavsoul2Data:
    """
    Auto-generated data class for packftfavsoul2.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Packftfavsoul2Data {pk_column}={pk_value!r}>>"
        else:
            return f"<Packftfavsoul2Data>"
