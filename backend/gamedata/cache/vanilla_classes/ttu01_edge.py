...
class Ttu01_edgeData:
    """
    Auto-generated data class for ttu01_edge.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Ttu01_edgeData {pk_column}={pk_value!r}>>"
        else:
            return f"<Ttu01_edgeData>"
