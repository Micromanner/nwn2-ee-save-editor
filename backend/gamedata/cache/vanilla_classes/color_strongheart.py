...
class Color_strongheartData:
    """
    Auto-generated data class for color_strongheart.2da
    
    This class provides efficient attribute access to 2DA row data
    with automatic column name mapping for mod compatibility.
    """
    __slots__ = ('_resource_manager', '_hair_1', '_hair_2', '_hair_acc', '_skin', '_eyes', '_body_hair')
    _column_mapping = {'hair_1': 'hair_1', 'hair_2': 'hair_2', 'hair_acc': 'hair_acc', 'skin': 'skin', 'eyes': 'eyes', 'body_hair': 'body_hair'}
    _table_name = 'color_strongheart'
    _safe_columns = ['hair_1', 'hair_2', 'hair_acc', 'skin', 'eyes', 'body_hair']
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<Color_strongheartData {pk_column}={pk_value!r}>>"
        else:
            return f"<Color_strongheartData>"
