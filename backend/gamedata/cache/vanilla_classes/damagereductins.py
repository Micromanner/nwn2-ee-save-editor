...
class DamagereductinsData:
    """
    Auto-generated data class for damagereductins.2da
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<DamagereductinsData {pk_column}={pk_value!r}>>"
        else:
            return f"<DamagereductinsData>"
