...
class AppearancesndsetData:
    """
    Auto-generated data class for appearancesndset.2da
    
    This class provides efficient attribute access to 2DA row data
    with automatic column name mapping for mod compatibility.
    """
    __slots__ = ('_resource_manager', '_Label', '_ArmorType', '_WeapTypeL', '_WeapTypeR', '_WeapTypeS', '_WeapTypeClsLw', '_WeapTypeClsH', '_WeapTypeRch', '_MissIndex', '_Looping', '_FallFwd', '_FallBck')
    _column_mapping = {'Label': 'Label', 'ArmorType': 'ArmorType', 'WeapTypeL': 'WeapTypeL', 'WeapTypeR': 'WeapTypeR', 'WeapTypeS': 'WeapTypeS', 'WeapTypeClsLw': 'WeapTypeClsLw', 'WeapTypeClsH': 'WeapTypeClsH', 'WeapTypeRch': 'WeapTypeRch', 'MissIndex': 'MissIndex', 'Looping': 'Looping', 'FallFwd': 'FallFwd', 'FallBck': 'FallBck'}
    _table_name = 'appearancesndset'
    _safe_columns = ['Label', 'ArmorType', 'WeapTypeL', 'WeapTypeR', 'WeapTypeS', 'WeapTypeClsLw', 'WeapTypeClsH', 'WeapTypeRch', 'MissIndex', 'Looping', 'FallFwd', 'FallBck']
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<AppearancesndsetData {pk_column}={pk_value!r}>>"
        else:
            return f"<AppearancesndsetData>"
