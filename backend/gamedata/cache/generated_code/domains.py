...
class DomainsData:
    """
    Auto-generated data class for domains.2da
    
    This class provides efficient attribute access to 2DA row data
    with automatic column name mapping for mod compatibility.
    """
    __slots__ = ('_resource_manager', '_Label', '_Name', '_Description', '_Icon', '_Level_1', '_Level_2', '_Level_3', '_Level_4', '_Level_5', '_Level_6', '_Level_7', '_Level_8', '_Level_9', '_GrantedFeat', '_CastableFeat', '_EpithetFeat')
    _column_mapping = {'Label': 'Label', 'Name': 'Name', 'Description': 'Description', 'Icon': 'Icon', 'Level_1': 'Level_1', 'Level_2': 'Level_2', 'Level_3': 'Level_3', 'Level_4': 'Level_4', 'Level_5': 'Level_5', 'Level_6': 'Level_6', 'Level_7': 'Level_7', 'Level_8': 'Level_8', 'Level_9': 'Level_9', 'GrantedFeat': 'GrantedFeat', 'CastableFeat': 'CastableFeat', 'EpithetFeat': 'EpithetFeat'}
    _table_name = 'domains'
    _safe_columns = ['Label', 'Name', 'Description', 'Icon', 'Level_1', 'Level_2', 'Level_3', 'Level_4', 'Level_5', 'Level_6', 'Level_7', 'Level_8', 'Level_9', 'GrantedFeat', 'CastableFeat', 'EpithetFeat']
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<DomainsData {pk_column}={pk_value!r}>>"
        else:
            return f"<DomainsData>"
