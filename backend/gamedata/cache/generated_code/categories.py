...
class CategoriesData:
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<CategoriesData {pk_column}={pk_value!r}>>"
        else:
            return f"<CategoriesData>"
