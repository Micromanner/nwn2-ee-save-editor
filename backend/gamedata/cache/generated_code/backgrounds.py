...
class BackgroundsData:
    """
    Auto-generated data class for backgrounds.2da
    
    This class provides efficient attribute access to 2DA row data
    with automatic column name mapping for mod compatibility.
    """
    __slots__ = ('_resource_manager', '_Label', '_Name', '_Description', '_Icon', '_MINATTACKBONUS', '_MINSTR', '_MINDEX', '_MININT', '_MINWIS', '_MINCON', '_MINCHA', '_MAXSTR', '_MAXDEX', '_MAXINT', '_MAXWIS', '_MAXCON', '_MAXCHA', '_Gender', '_OrReqClass0', '_OrReqClass1', '_OrReqClass2', '_FeatGainedName', '_FeatGained', '_MasterFeatGainedName', '_MasterFeatGained', '_DisplayFeat', '_REMOVED')
    _column_mapping = {'Label': 'Label', 'Name': 'Name', 'Description': 'Description', 'Icon': 'Icon', 'MINATTACKBONUS': 'MINATTACKBONUS', 'MINSTR': 'MINSTR', 'MINDEX': 'MINDEX', 'MININT': 'MININT', 'MINWIS': 'MINWIS', 'MINCON': 'MINCON', 'MINCHA': 'MINCHA', 'MAXSTR': 'MAXSTR', 'MAXDEX': 'MAXDEX', 'MAXINT': 'MAXINT', 'MAXWIS': 'MAXWIS', 'MAXCON': 'MAXCON', 'MAXCHA': 'MAXCHA', 'Gender': 'Gender', 'OrReqClass0': 'OrReqClass0', 'OrReqClass1': 'OrReqClass1', 'OrReqClass2': 'OrReqClass2', 'FeatGainedName': 'FeatGainedName', 'FeatGained': 'FeatGained', 'MasterFeatGainedName': 'MasterFeatGainedName', 'MasterFeatGained': 'MasterFeatGained', 'DisplayFeat': 'DisplayFeat', 'REMOVED': 'REMOVED'}
    _table_name = 'backgrounds'
    _safe_columns = ['Label', 'Name', 'Description', 'Icon', 'MINATTACKBONUS', 'MINSTR', 'MINDEX', 'MININT', 'MINWIS', 'MINCON', 'MINCHA', 'MAXSTR', 'MAXDEX', 'MAXINT', 'MAXWIS', 'MAXCON', 'MAXCHA', 'Gender', 'OrReqClass0', 'OrReqClass1', 'OrReqClass2', 'FeatGainedName', 'FeatGained', 'MasterFeatGainedName', 'MasterFeatGained', 'DisplayFeat', 'REMOVED']
    ...
    def __repr__(self):
        ...
        if pk_column and hasattr(self, '_' + pk_column):
            ...
            return f"<BackgroundsData {pk_column}={pk_value!r}>>"
        else:
            return f"<BackgroundsData>"
